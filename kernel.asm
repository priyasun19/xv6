...
80100049:	e8 a0 4a 00 00       	call   80104aee <initlock>
...
801000bd:	e8 4d 4a 00 00       	call   80104b0f <acquire>
...
80100104:	e8 68 4a 00 00       	call   80104b71 <release>
        return b;
...
8010011f:	e8 05 47 00 00       	call   80104829 <sleep>
      goto loop;
...
8010017c:	e8 f0 49 00 00       	call   80104b71 <release>
      return b;
...
80100198:	c7 04 24 4f 82 10 80 	movl   $0x8010824f,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 60 82 10 80 	movl   $0x80108260,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 67 82 10 80 	movl   $0x80108267,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
8010023c:	e8 ce 48 00 00       	call   80104b0f <acquire>
...
8010029d:	e8 63 46 00 00       	call   80104905 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 60 c6 10 80 	movl   $0x8010c660,(%esp)
801002a9:	e8 c3 48 00 00       	call   80104b71 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 4e 47 00 00       	call   80104b0f <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 6e 82 10 80 	movl   $0x8010826e,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 77 82 10 80 	movl   $0x80108277,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 36 46 00 00       	call   80104b71 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 7e 82 10 80 	movl   $0x8010827e,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 8d 82 10 80 	movl   $0x8010828d,(%esp)
...
80100592:	e8 29 46 00 00       	call   80104bc0 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 8f 82 10 80 	movl   $0x8010828f,(%esp)
...
801006b2:	e8 7a 47 00 00       	call   80104e31 <memmove>
    pos -= 80;
...
801006e1:	e8 78 46 00 00       	call   80104d5e <memset>
  }
...
80100776:	e8 1e 61 00 00       	call   80106899 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 12 61 00 00       	call   80106899 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 06 61 00 00       	call   80106899 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 f9 60 00 00       	call   80106899 <uartputc>
  cgaputc(c);
...
801007ba:	e8 50 43 00 00       	call   80104b0f <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 bc 41 00 00       	call   801049ab <procdump>
      break;
...
801008f7:	e8 09 40 00 00       	call   80104905 <wakeup>
        }
      }
      break;
...
8010091e:	e8 4e 42 00 00       	call   80104b71 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 c7 41 00 00       	call   80104b0f <acquire>
  while(n > 0){
...
80100961:	e8 0b 42 00 00       	call   80104b71 <release>
        ilock(ip);
...
8010098a:	e8 9a 3e 00 00       	call   80104829 <sleep>
...
80100a08:	e8 64 41 00 00       	call   80104b71 <release>
  ilock(ip);
...
80100a3e:	e8 cc 40 00 00       	call   80104b0f <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 f4 40 00 00       	call   80104b71 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 93 82 10 	movl   $0x80108293,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100aa2:	e8 47 40 00 00       	call   80104aee <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 9b 82 10 	movl   $0x8010829b,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 a0 dd 10 80 	movl   $0x8010dda0,(%esp)
80100ab6:	e8 33 40 00 00       	call   80104aee <initlock>
...
80100b6e:	0f 85 3f 03 00 00    	jne    80100eb3 <exec+0x3b7>
  ...
  if((pgdir = setupkvm()) == 0)
80100b74:	e8 64 6e 00 00       	call   801079dd <setupkvm>
...
80100c0d:	e8 9d 71 00 00       	call   80107daf <allocuvm>
...
80100c4a:	e8 71 70 00 00       	call   80107cc0 <loaduvm>
...
80100cb5:	e8 f5 70 00 00       	call   80107daf <allocuvm>
...
80100cd9:	e8 f5 72 00 00       	call   80107fd3 <clearpteu>
  sp = sz;
...
80100d08:	e8 cf 42 00 00       	call   80104fdc <strlen>
...
80100d26:	e8 b1 42 00 00       	call   80104fdc <strlen>
...
80100d50:	e8 43 74 00 00       	call   80108198 <copyout>
...
80100df0:	e8 a3 73 00 00       	call   80108198 <copyout>
...
80100e47:	e8 42 41 00 00       	call   80104f8e <safestrcpy>
...
80100e99:	e8 30 6c 00 00       	call   80107ace <switchuvm>
  freevm(oldpgdir);
80100e9e:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ea1:	89 04 24             	mov    %eax,(%esp)
80100ea4:	e8 9c 70 00 00       	call   80107f45 <freevm>
  return 0;
...
80100edb:	e8 65 70 00 00       	call   80107f45 <freevm>
  if(ip)
...
80100efe:	c7 44 24 04 a1 82 10 	movl   $0x801082a1,0x4(%esp)
80100f05:	80 
80100f06:	c7 04 24 60 de 10 80 	movl   $0x8010de60,(%esp)
80100f0d:	e8 dc 3b 00 00       	call   80104aee <initlock>
}
80100f12:	c9                   	leave  
80100f13:	c3                   	ret    
...
80100f21:	e8 e9 3b 00 00       	call   80104b0f <acquire>
...
80100f4a:	e8 22 3c 00 00       	call   80104b71 <release>
      return f;
...
80100f68:	e8 04 3c 00 00       	call   80104b71 <release>
  return 0;
...
80100f81:	e8 89 3b 00 00       	call   80104b0f <acquire>
  if(f->ref < 1)
...
80100f8e:	7f 0c                	jg     80100f9c <filedup+0x28>
    panic("filedup");
80100f90:	c7 04 24 a8 82 10 80 	movl   $0x801082a8,(%esp)
...
80100fb2:	e8 ba 3b 00 00       	call   80104b71 <release>
  return f;
...
80100fc9:	e8 41 3b 00 00       	call   80104b0f <acquire>
  if(f->ref < 1)
...
80100fd6:	7f 0c                	jg     80100fe4 <fileclose+0x28>
    panic("fileclose");
80100fd8:	c7 04 24 b0 82 10 80 	movl   $0x801082b0,(%esp)
...
80101004:	e8 68 3b 00 00       	call   80104b71 <release>
    return;
...
8010104e:	e8 1e 3b 00 00       	call   80104b71 <release>
...
8010118d:	eb 0c                	jmp    8010119b <fileread+0xba>
  ...
  panic("fileread");
8010118f:	c7 04 24 ba 82 10 80 	movl   $0x801082ba,(%esp)
...
8010129b:	c7 04 24 c3 82 10 80 	movl   $0x801082c3,(%esp)
...
801012ce:	eb 0c                	jmp    801012dc <filewrite+0x13f>
  ...
  panic("filewrite");
801012d0:	c7 04 24 d3 82 10 80 	movl   $0x801082d3,(%esp)
...
80101318:	e8 14 3b 00 00       	call   80104e31 <memmove>
  brelse(bp);
...
8010135e:	e8 fb 39 00 00       	call   80104d5e <memset>
  log_write(bp);
...
801014c0:	0f 82 e1 fe ff ff    	jb     801013a7 <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014c6:	c7 04 24 dd 82 10 80 	movl   $0x801082dd,(%esp)
...
8010155d:	c7 04 24 f3 82 10 80 	movl   $0x801082f3,(%esp)
...
801015b1:	c7 44 24 04 06 83 10 	movl   $0x80108306,0x4(%esp)
801015b8:	80 
801015b9:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801015c0:	e8 29 35 00 00       	call   80104aee <initlock>
}
801015c5:	c9                   	leave  
801015c6:	c3                   	ret    
...
80101642:	e8 17 37 00 00       	call   80104d5e <memset>
      dip->type = type;
...
80101692:	0f 82 5a ff ff ff    	jb     801015f2 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
80101698:	c7 04 24 0d 83 10 80 	movl   $0x8010830d,(%esp)
...
8010173f:	e8 ed 36 00 00       	call   80104e31 <memmove>
  log_write(bp);
...
80101769:	e8 a1 33 00 00       	call   80104b0f <acquire>
...
801017b3:	e8 b9 33 00 00       	call   80104b71 <release>
      return ip;
...
801017e6:	c7 04 24 1f 83 10 80 	movl   $0x8010831f,(%esp)
...
80101824:	e8 48 33 00 00       	call   80104b71 <release>
...
8010183b:	e8 cf 32 00 00       	call   80104b0f <acquire>
  ip->ref++;
...
80101856:	e8 16 33 00 00       	call   80104b71 <release>
  return ip;
...
80101874:	7f 0c                	jg     80101882 <ilock+0x22>
    panic("ilock");
80101876:	c7 04 24 2f 83 10 80 	movl   $0x8010832f,(%esp)
8010187d:	e8 bb ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101882:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101889:	e8 81 32 00 00       	call   80104b0f <acquire>
...
8010189e:	e8 86 2f 00 00       	call   80104829 <sleep>
...
801018c8:	e8 a4 32 00 00       	call   80104b71 <release>
...
80101973:	e8 b9 34 00 00       	call   80104e31 <memmove>
    brelse(bp);
...
8010199e:	75 0c                	jne    801019ac <ilock+0x14c>
      panic("ilock: no type");
801019a0:	c7 04 24 35 83 10 80 	movl   $0x80108335,(%esp)
...
801019cf:	7f 0c                	jg     801019dd <iunlock+0x2f>
    panic("iunlock");
801019d1:	c7 04 24 44 83 10 80 	movl   $0x80108344,(%esp)
801019d8:	e8 60 eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019dd:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
801019e4:	e8 26 31 00 00       	call   80104b0f <acquire>
  ip->flags &= ~I_BUSY;
...
80101a00:	e8 00 2f 00 00       	call   80104905 <wakeup>
  release(&icache.lock);
80101a05:	c7 04 24 60 e8 10 80 	movl   $0x8010e860,(%esp)
80101a0c:	e8 60 31 00 00       	call   80104b71 <release>
}
80101a11:	c9                   	leave  
80101a12:	c3                   	ret    
...
80101a20:	e8 ea 30 00 00       	call   80104b0f <acquire>
...
80101a5c:	74 0c                	je     80101a6a <iput+0x57>
      panic("iput busy");
80101a5e:	c7 04 24 4c 83 10 80 	movl   $0x8010834c,(%esp)
...
80101a82:	e8 ea 30 00 00       	call   80104b71 <release>
    itrunc(ip);
...
80101aad:	e8 5d 30 00 00       	call   80104b0f <acquire>
    ip->flags = 0;
...
80101ac2:	e8 3e 2e 00 00       	call   80104905 <wakeup>
  }
  ip->ref--;
...
80101add:	e8 8f 30 00 00       	call   80104b71 <release>
}
80101ae2:	c9                   	leave  
80101ae3:	c3                   	ret    
...
80101bf2:	c7 04 24 56 83 10 80 	movl   $0x80108356,(%esp)
...
80101e8a:	e8 a2 2f 00 00       	call   80104e31 <memmove>
    brelse(bp);
...
80101ff0:	e8 3c 2e 00 00       	call   80104e31 <memmove>
    log_write(bp);
...
80102072:	e8 5e 2e 00 00       	call   80104ed5 <strncmp>
}
80102077:	c9                   	leave  
80102078:	c3                   	ret    
...
8010208c:	c7 04 24 69 83 10 80 	movl   $0x80108369,(%esp)
...
801020c8:	74 0c                	je     801020d6 <dirlookup+0x5d>
      panic("dirlink read");
801020ca:	c7 04 24 7b 83 10 80 	movl   $0x8010837b,(%esp)
...
801021ac:	74 0c                	je     801021ba <dirlink+0x79>
      panic("dirlink read");
801021ae:	c7 04 24 7b 83 10 80 	movl   $0x8010837b,(%esp)
...
801021f4:	e8 34 2d 00 00       	call   80104f2d <strncpy>
  de.inum = inum;
...
80102224:	74 0c                	je     80102232 <dirlink+0xf1>
    panic("dirlink");
80102226:	c7 04 24 88 83 10 80 	movl   $0x80108388,(%esp)
...
801022ad:	e8 7f 2b 00 00       	call   80104e31 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022c8:	e8 64 2b 00 00       	call   80104e31 <memmove>
    name[len] = 0;
...
80102524:	c7 44 24 04 90 83 10 	movl   $0x80108390,0x4(%esp)
8010252b:	80 
8010252c:	c7 04 24 00 b6 10 80 	movl   $0x8010b600,(%esp)
80102533:	e8 b6 25 00 00       	call   80104aee <initlock>
  picenable(IRQ_IDE);
...
801025ce:	75 0c                	jne    801025dc <idestart+0x18>
    panic("idestart");
801025d0:	c7 04 24 94 83 10 80 	movl   $0x80108394,(%esp)
...
801026f6:	e8 14 24 00 00       	call   80104b0f <acquire>
  if((b = idequeue) == 0){
...
80102710:	e8 5c 24 00 00       	call   80104b71 <release>
...
80102783:	e8 7d 21 00 00       	call   80104905 <wakeup>
...
801027a5:	e8 c7 23 00 00       	call   80104b71 <release>
}
801027aa:	c9                   	leave  
801027ab:	c3                   	ret    
...
801027be:	c7 04 24 9d 83 10 80 	movl   $0x8010839d,(%esp)
...
801027d7:	c7 04 24 b1 83 10 80 	movl   $0x801083b1,(%esp)
...
80102862:	e8 c2 1f 00 00       	call   80104829 <sleep>
...
8010287e:	e8 ee 22 00 00       	call   80104b71 <release>
}
80102883:	c9                   	leave  
80102884:	c3                   	ret    
...
8010290e:	c7 04 24 e4 83 10 80 	movl   $0x801083e4,(%esp)
...
801029cf:	c7 44 24 04 16 84 10 	movl   $0x80108416,0x4(%esp)
801029d6:	80 
801029d7:	c7 04 24 40 f8 10 80 	movl   $0x8010f840,(%esp)
801029de:	e8 0b 21 00 00       	call   80104aee <initlock>
  kmem.use_lock = 0;
...
80102a70:	81 7d 08 fc 28 11 80 	cmpl   $0x801128fc,0x8(%ebp)
...
80102a89:	76 0c                	jbe    80102a97 <kfree+0x39>
    panic("kfree");
80102a8b:	c7 04 24 1b 84 10 80 	movl   $0x8010841b,(%esp)
...
80102aad:	e8 ac 22 00 00       	call   80104d5e <memset>
...
80102ac2:	e8 48 20 00 00       	call   80104b0f <acquire>
  r = (struct run*)v;
...
80102af0:	e8 7c 20 00 00       	call   80104b71 <release>
}
80102af5:	c9                   	leave  
80102af6:	c3                   	ret    
...
80102b0d:	e8 fd 1f 00 00       	call   80104b0f <acquire>
  r = kmem.freelist;
...
80102b3a:	e8 32 20 00 00       	call   80104b71 <release>
  return (char*)r;
...
80102eb6:	c7 04 24 24 84 10 80 	movl   $0x80108424,(%esp)
...
8010300e:	c7 44 24 04 50 84 10 	movl   $0x80108450,0x4(%esp)
80103015:	80 
80103016:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
8010301d:	e8 cc 1a 00 00       	call   80104aee <initlock>
  readsb(ROOTDEV, &sb);
...
801030d0:	e8 5c 1d 00 00       	call   80104e31 <memmove>
...
80103222:	e8 e8 18 00 00       	call   80104b0f <acquire>
  while (log.busy) {
...
80103238:	e8 ec 15 00 00       	call   80104829 <sleep>
...
80103257:	e8 15 19 00 00       	call   80104b71 <release>
}
8010325c:	c9                   	leave  
8010325d:	c3                   	ret    
...
801032d8:	c7 04 24 54 84 10 80 	movl   $0x80108454,(%esp)
...
801032ed:	c7 04 24 6a 84 10 80 	movl   $0x8010846a,(%esp)
...
8010337c:	e8 b0 1a 00 00       	call   80104e31 <memmove>
  bwrite(lbuf);
...
80103440:	c7 04 24 81 84 10 80 	movl   $0x80108481,(%esp)
...
8010345b:	e8 28 33 00 00       	call   80106788 <uartinit>
  pinit();         // process table
80103460:	e8 8e 0b 00 00       	call   80103ff3 <pinit>
  tvinit();        // trap vectors
80103465:	e8 bd 2d 00 00       	call   80106227 <tvinit>
  binit();         // buffer cache
...
80103487:	e8 de 2c 00 00       	call   8010616a <timerinit>
...
801034a5:	e8 7e 0c 00 00       	call   80104128 <userinit>
...
801034b2:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801034b5:	e8 f7 45 00 00       	call   80107ab1 <switchkvm>
  seginit();
801034ba:	e8 7e 3f 00 00       	call   8010743d <seginit>
  lapicinit();
...
801034df:	c7 04 24 98 84 10 80 	movl   $0x80108498,(%esp)
801034e6:	e8 b6 ce ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
801034eb:	e8 ab 2e 00 00       	call   8010639b <idtinit>
...
8010350b:	e8 6d 11 00 00       	call   8010467d <scheduler>
...
8010353d:	e8 ef 18 00 00       	call   80104e31 <memmove>
...
801036cb:	00 
801036cc:	c7 44 24 04 ac 84 10 	movl   $0x801084ac,0x4(%esp)
801036d3:	80 
801036d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036d7:	89 04 24             	mov    %eax,(%esp)
801036da:	e8 f6 16 00 00       	call   80104dd5 <memcmp>
...
8010380c:	00 
8010380d:	c7 44 24 04 b1 84 10 	movl   $0x801084b1,0x4(%esp)
80103814:	80 
80103815:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103818:	89 04 24             	mov    %eax,(%esp)
8010381b:	e8 b5 15 00 00       	call   80104dd5 <memcmp>
...
801038e6:	8b 04 85 f4 84 10 80 	mov    -0x7fef7b0c(,%eax,4),%eax
...
8010391f:	c7 04 24 b6 84 10 80 	movl   $0x801084b6,(%esp)
...
801039b2:	c7 04 24 d4 84 10 80 	movl   $0x801084d4,(%esp)
...
80103cb7:	c7 44 24 04 08 85 10 	movl   $0x80108508,0x4(%esp)
80103cbe:	80 
80103cbf:	89 04 24             	mov    %eax,(%esp)
80103cc2:	e8 27 0e 00 00       	call   80104aee <initlock>
  (*f0)->type = FD_PIPE;
...
80103d6f:	e8 9b 0d 00 00       	call   80104b0f <acquire>
  if(writable){
...
80103d92:	e8 6e 0b 00 00       	call   80104905 <wakeup>
...
80103db1:	e8 4f 0b 00 00       	call   80104905 <wakeup>
  }
...
80103dd6:	e8 96 0d 00 00       	call   80104b71 <release>
    kfree((char*)p);
...
80103dee:	e8 7e 0d 00 00       	call   80104b71 <release>
}
80103df3:	c9                   	leave  
80103df4:	c3                   	ret    
...
80103e02:	e8 08 0d 00 00       	call   80104b0f <acquire>
  for(i = 0; i < n; i++){
...
80103e33:	e8 39 0d 00 00       	call   80104b71 <release>
        return -1;
...
80103e4d:	e8 b3 0a 00 00       	call   80104905 <wakeup>
...
80103e65:	e8 bf 09 00 00       	call   80104829 <sleep>
...
80103ecc:	e8 34 0a 00 00       	call   80104905 <wakeup>
  release(&p->lock);
80103ed1:	8b 45 08             	mov    0x8(%ebp),%eax
80103ed4:	89 04 24             	mov    %eax,(%esp)
80103ed7:	e8 95 0c 00 00       	call   80104b71 <release>
  return n;
...
80103ef2:	e8 18 0c 00 00       	call   80104b0f <acquire>
...
80103f0c:	e8 60 0c 00 00       	call   80104b71 <release>
      return -1;
...
80103f2e:	e8 f6 08 00 00       	call   80104829 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103fbe:	e8 42 09 00 00       	call   80104905 <wakeup>
  release(&p->lock);
80103fc3:	8b 45 08             	mov    0x8(%ebp),%eax
80103fc6:	89 04 24             	mov    %eax,(%esp)
80103fc9:	e8 a3 0b 00 00       	call   80104b71 <release>
  return i;
...
80103ff9:	c7 44 24 04 0d 85 10 	movl   $0x8010850d,0x4(%esp)
80104000:	80 
80104001:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104008:	e8 e1 0a 00 00       	call   80104aee <initlock>
}
8010400d:	c9                   	leave  
8010400e:	c3                   	ret    
...
8010401c:	e8 ee 0a 00 00       	call   80104b0f <acquire>
...
80104032:	74 26                	je     8010405a <allocproc+0x4b>
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104034:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
8010403b:	81 7d f4 54 20 11 80 	cmpl   $0x80112054,-0xc(%ebp)
80104042:	72 e6                	jb     8010402a <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
80104044:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010404b:	e8 21 0b 00 00       	call   80104b71 <release>
  return 0;
80104050:	b8 00 00 00 00       	mov    $0x0,%eax
80104055:	e9 cc 00 00 00       	jmp    80104126 <allocproc+0x117>
  char *sp;
...
80104073:	a3 04 b0 10 80       	mov    %eax,0x8010b004
  release(&ptable.lock);
80104078:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010407f:	e8 ed 0a 00 00       	call   80104b71 <release>
...
80104097:	75 11                	jne    801040aa <allocproc+0x9b>
    p->state = UNUSED;
80104099:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010409c:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return 0;
801040a3:	b8 00 00 00 00       	mov    $0x0,%eax
801040a8:	eb 7c                	jmp    80104126 <allocproc+0x117>
  }
  sp = p->kstack + KSTACKSIZE;
801040aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040ad:	8b 40 08             	mov    0x8(%eax),%eax
801040b0:	05 00 10 00 00       	add    $0x1000,%eax
801040b5:	89 45 f0             	mov    %eax,-0x10(%ebp)
  
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
801040b8:	83 6d f0 4c          	subl   $0x4c,-0x10(%ebp)
  p->tf = (struct trapframe*)sp;
801040bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040bf:	8b 55 f0             	mov    -0x10(%ebp),%edx
801040c2:	89 50 18             	mov    %edx,0x18(%eax)
  
  // Set up new context to start executing at forkret,
  // which returns to trapret.
  sp -= 4;
801040c5:	83 6d f0 04          	subl   $0x4,-0x10(%ebp)
  *(uint*)sp = (uint)trapret;
801040c9:	ba dc 61 10 80       	mov    $0x801061dc,%edx
801040ce:	8b 45 f0             	mov    -0x10(%ebp),%eax
801040d1:	89 10                	mov    %edx,(%eax)

  sp -= sizeof *p->context;
801040d3:	83 6d f0 14          	subl   $0x14,-0x10(%ebp)
  p->context = (struct context*)sp;
801040d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040da:	8b 55 f0             	mov    -0x10(%ebp),%edx
801040dd:	89 50 1c             	mov    %edx,0x1c(%eax)
  memset(p->context, 0, sizeof *p->context);
801040e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801040e3:	8b 40 1c             	mov    0x1c(%eax),%eax
801040e6:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801040ed:	00 
801040ee:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801040f5:	00 
801040f6:	89 04 24             	mov    %eax,(%esp)
801040f9:	e8 60 0c 00 00       	call   80104d5e <memset>
  p->context->eip = (uint)forkret;
801040fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104101:	8b 40 1c             	mov    0x1c(%eax),%eax
80104104:	ba fd 47 10 80       	mov    $0x801047fd,%edx
80104109:	89 50 10             	mov    %edx,0x10(%eax)

  //initialize custom signal handlers as -1
  (p->user_signalhandle)[0] = -1;
8010410c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010410f:	c7 40 7c ff ff ff ff 	movl   $0xffffffff,0x7c(%eax)
  (p->user_signalhandle)[1] = -1;
80104116:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104119:	c7 80 80 00 00 00 ff 	movl   $0xffffffff,0x80(%eax)
80104120:	ff ff ff 
  return p;
...
8010412b:	83 ec 28             	sub    $0x28,%esp
  ...
  p = allocproc();
8010412e:	e8 dc fe ff ff       	call   8010400f <allocproc>
80104133:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
80104136:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104139:	a3 48 b6 10 80       	mov    %eax,0x8010b648
  if((p->pgdir = setupkvm()) == 0)
8010413e:	e8 9a 38 00 00       	call   801079dd <setupkvm>
80104143:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104146:	89 42 04             	mov    %eax,0x4(%edx)
80104149:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010414c:	8b 40 04             	mov    0x4(%eax),%eax
8010414f:	85 c0                	test   %eax,%eax
80104151:	75 0c                	jne    8010415f <userinit+0x37>
    panic("userinit: out of memory?");
80104153:	c7 04 24 14 85 10 80 	movl   $0x80108514,(%esp)
8010415a:	e8 de c3 ff ff       	call   8010053d <panic>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
8010415f:	ba 2c 00 00 00       	mov    $0x2c,%edx
80104164:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104167:	8b 40 04             	mov    0x4(%eax),%eax
8010416a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010416e:	c7 44 24 04 e0 b4 10 	movl   $0x8010b4e0,0x4(%esp)
80104175:	80 
80104176:	89 04 24             	mov    %eax,(%esp)
80104179:	e8 b7 3a 00 00       	call   80107c35 <inituvm>
  p->sz = PGSIZE;
8010417e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104181:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  memset(p->tf, 0, sizeof(*p->tf));
80104187:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010418a:	8b 40 18             	mov    0x18(%eax),%eax
8010418d:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
80104194:	00 
80104195:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010419c:	00 
8010419d:	89 04 24             	mov    %eax,(%esp)
801041a0:	e8 b9 0b 00 00       	call   80104d5e <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
801041a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041a8:	8b 40 18             	mov    0x18(%eax),%eax
801041ab:	66 c7 40 3c 23 00    	movw   $0x23,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
801041b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041b4:	8b 40 18             	mov    0x18(%eax),%eax
801041b7:	66 c7 40 2c 2b 00    	movw   $0x2b,0x2c(%eax)
  p->tf->es = p->tf->ds;
801041bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041c0:	8b 40 18             	mov    0x18(%eax),%eax
801041c3:	8b 55 f4             	mov    -0xc(%ebp),%edx
801041c6:	8b 52 18             	mov    0x18(%edx),%edx
801041c9:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
801041cd:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
801041d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041d4:	8b 40 18             	mov    0x18(%eax),%eax
801041d7:	8b 55 f4             	mov    -0xc(%ebp),%edx
801041da:	8b 52 18             	mov    0x18(%edx),%edx
801041dd:	0f b7 52 2c          	movzwl 0x2c(%edx),%edx
801041e1:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
801041e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041e8:	8b 40 18             	mov    0x18(%eax),%eax
801041eb:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
801041f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801041f5:	8b 40 18             	mov    0x18(%eax),%eax
801041f8:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
801041ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104202:	8b 40 18             	mov    0x18(%eax),%eax
80104205:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)

  safestrcpy(p->name, "initcode", sizeof(p->name));
8010420c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010420f:	83 c0 6c             	add    $0x6c,%eax
80104212:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104219:	00 
8010421a:	c7 44 24 04 2d 85 10 	movl   $0x8010852d,0x4(%esp)
80104221:	80 
80104222:	89 04 24             	mov    %eax,(%esp)
80104225:	e8 64 0d 00 00       	call   80104f8e <safestrcpy>
  p->cwd = namei("/");
8010422a:	c7 04 24 36 85 10 80 	movl   $0x80108536,(%esp)
80104231:	e8 cc e1 ff ff       	call   80102402 <namei>
80104236:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104239:	89 42 68             	mov    %eax,0x68(%edx)
...
8010424b:	83 ec 28             	sub    $0x28,%esp
  ...
  sz = proc->sz;
8010424e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104254:	8b 00                	mov    (%eax),%eax
80104256:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(n > 0){
80104259:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010425d:	7e 34                	jle    80104293 <growproc+0x4b>
    if((sz = allocuvm(proc->pgdir, sz, sz + n)) == 0)
8010425f:	8b 45 08             	mov    0x8(%ebp),%eax
80104262:	89 c2                	mov    %eax,%edx
80104264:	03 55 f4             	add    -0xc(%ebp),%edx
...
80104277:	89 54 24 04          	mov    %edx,0x4(%esp)
8010427b:	89 04 24             	mov    %eax,(%esp)
8010427e:	e8 2c 3b 00 00       	call   80107daf <allocuvm>
80104283:	89 45 f4             	mov    %eax,-0xc(%ebp)
80104286:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010428a:	75 41                	jne    801042cd <growproc+0x85>
      return -1;
8010428c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104291:	eb 58                	jmp    801042eb <growproc+0xa3>
  } else if(n < 0){
80104293:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80104297:	79 34                	jns    801042cd <growproc+0x85>
    if((sz = deallocuvm(proc->pgdir, sz, sz + n)) == 0)
80104299:	8b 45 08             	mov    0x8(%ebp),%eax
8010429c:	89 c2                	mov    %eax,%edx
8010429e:	03 55 f4             	add    -0xc(%ebp),%edx
...
801042b8:	e8 cc 3b 00 00       	call   80107e89 <deallocuvm>
801042bd:	89 45 f4             	mov    %eax,-0xc(%ebp)
801042c0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801042c4:	75 07                	jne    801042cd <growproc+0x85>
      return -1;
801042c6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801042cb:	eb 1e                	jmp    801042eb <growproc+0xa3>
  }
  proc->sz = sz;
...
801042e1:	e8 e8 37 00 00       	call   80107ace <switchuvm>
  return 0;
...
801042f0:	57                   	push   %edi
801042f1:	56                   	push   %esi
801042f2:	53                   	push   %ebx
801042f3:	83 ec 2c             	sub    $0x2c,%esp
  int i, pid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
801042f6:	e8 14 fd ff ff       	call   8010400f <allocproc>
801042fb:	89 45 e0             	mov    %eax,-0x20(%ebp)
801042fe:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104302:	75 0a                	jne    8010430e <fork+0x21>
    return -1;
80104304:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104309:	e9 3a 01 00 00       	jmp    80104448 <fork+0x15b>

  // Copy process state from p.
  if((np->pgdir = copyuvm(proc->pgdir, proc->sz)) == 0){
8010430e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104314:	8b 10                	mov    (%eax),%edx
80104316:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010431c:	8b 40 04             	mov    0x4(%eax),%eax
8010431f:	89 54 24 04          	mov    %edx,0x4(%esp)
80104323:	89 04 24             	mov    %eax,(%esp)
80104326:	e8 ee 3c 00 00       	call   80108019 <copyuvm>
8010432b:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010432e:	89 42 04             	mov    %eax,0x4(%edx)
80104331:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104334:	8b 40 04             	mov    0x4(%eax),%eax
80104337:	85 c0                	test   %eax,%eax
80104339:	75 2c                	jne    80104367 <fork+0x7a>
    kfree(np->kstack);
8010433b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010433e:	8b 40 08             	mov    0x8(%eax),%eax
80104341:	89 04 24             	mov    %eax,(%esp)
80104344:	e8 15 e7 ff ff       	call   80102a5e <kfree>
    np->kstack = 0;
80104349:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010434c:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
    np->state = UNUSED;
80104353:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104356:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
    return -1;
8010435d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104362:	e9 e1 00 00 00       	jmp    80104448 <fork+0x15b>
  }
  np->sz = proc->sz;
80104367:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010436d:	8b 10                	mov    (%eax),%edx
8010436f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104372:	89 10                	mov    %edx,(%eax)
  np->parent = proc;
80104374:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010437b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010437e:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
80104381:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104384:	8b 50 18             	mov    0x18(%eax),%edx
80104387:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010438d:	8b 40 18             	mov    0x18(%eax),%eax
80104390:	89 c3                	mov    %eax,%ebx
80104392:	b8 13 00 00 00       	mov    $0x13,%eax
80104397:	89 d7                	mov    %edx,%edi
80104399:	89 de                	mov    %ebx,%esi
8010439b:	89 c1                	mov    %eax,%ecx
8010439d:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
8010439f:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043a2:	8b 40 18             	mov    0x18(%eax),%eax
801043a5:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
801043ac:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801043b3:	eb 3d                	jmp    801043f2 <fork+0x105>
    if(proc->ofile[i])
801043b5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043bb:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801043be:	83 c2 08             	add    $0x8,%edx
801043c1:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801043c5:	85 c0                	test   %eax,%eax
801043c7:	74 25                	je     801043ee <fork+0x101>
...
801043dc:	e8 93 cb ff ff       	call   80100f74 <filedup>
801043e1:	8b 55 e0             	mov    -0x20(%ebp),%edx
801043e4:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801043e7:	83 c1 08             	add    $0x8,%ecx
801043ea:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
801043ee:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
801043f2:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
801043f6:	7e bd                	jle    801043b5 <fork+0xc8>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
...
80104404:	e8 25 d4 ff ff       	call   8010182e <idup>
80104409:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010440c:	89 42 68             	mov    %eax,0x68(%edx)
 
  pid = np->pid;
8010440f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104412:	8b 40 10             	mov    0x10(%eax),%eax
80104415:	89 45 dc             	mov    %eax,-0x24(%ebp)
  np->state = RUNNABLE;
...
80104431:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104438:	00 
80104439:	89 54 24 04          	mov    %edx,0x4(%esp)
8010443d:	89 04 24             	mov    %eax,(%esp)
80104440:	e8 49 0b 00 00       	call   80104f8e <safestrcpy>
  return pid;
80104445:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
80104448:	83 c4 2c             	add    $0x2c,%esp
8010444b:	5b                   	pop    %ebx
8010444c:	5e                   	pop    %esi
8010444d:	5f                   	pop    %edi
8010444e:	5d                   	pop    %ebp
...
8010445d:	a1 48 b6 10 80       	mov    0x8010b648,%eax
80104462:	39 c2                	cmp    %eax,%edx
80104464:	75 0c                	jne    80104472 <exit+0x22>
    panic("init exiting");
80104466:	c7 04 24 38 85 10 80 	movl   $0x80108538,(%esp)
8010446d:	e8 cb c0 ff ff       	call   8010053d <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104472:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
80104479:	eb 44                	jmp    801044bf <exit+0x6f>
    if(proc->ofile[fd]){
...
8010448d:	74 2c                	je     801044bb <exit+0x6b>
      fileclose(proc->ofile[fd]);
8010448f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104495:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104498:	83 c2 08             	add    $0x8,%edx
8010449b:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010449f:	89 04 24             	mov    %eax,(%esp)
801044a2:	e8 15 cb ff ff       	call   80100fbc <fileclose>
      proc->ofile[fd] = 0;
801044a7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044ad:	8b 55 f0             	mov    -0x10(%ebp),%edx
801044b0:	83 c2 08             	add    $0x8,%edx
801044b3:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801044ba:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
801044bb:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
801044bf:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
801044c3:	7e b6                	jle    8010447b <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
...
801044cb:	8b 40 68             	mov    0x68(%eax),%eax
801044ce:	89 04 24             	mov    %eax,(%esp)
801044d1:	e8 3d d5 ff ff       	call   80101a13 <iput>
  proc->cwd = 0;
801044d6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044dc:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
801044e3:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801044ea:	e8 20 06 00 00       	call   80104b0f <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
801044ef:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044f5:	8b 40 14             	mov    0x14(%eax),%eax
801044f8:	89 04 24             	mov    %eax,(%esp)
801044fb:	e8 c4 03 00 00       	call   801048c4 <wakeup1>

  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104500:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
80104507:	eb 3b                	jmp    80104544 <exit+0xf4>
    if(p->parent == proc){
80104509:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010450c:	8b 50 14             	mov    0x14(%eax),%edx
8010450f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104515:	39 c2                	cmp    %eax,%edx
80104517:	75 24                	jne    8010453d <exit+0xed>
      p->parent = initproc;
80104519:	8b 15 48 b6 10 80    	mov    0x8010b648,%edx
...
8010452e:	75 0d                	jne    8010453d <exit+0xed>
        wakeup1(initproc);
80104530:	a1 48 b6 10 80       	mov    0x8010b648,%eax
80104535:	89 04 24             	mov    %eax,(%esp)
80104538:	e8 87 03 00 00       	call   801048c4 <wakeup1>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010453d:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104544:	81 7d f4 54 20 11 80 	cmpl   $0x80112054,-0xc(%ebp)
8010454b:	72 bc                	jb     80104509 <exit+0xb9>
        wakeup1(initproc);
    }
  }
...
80104553:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
8010455a:	e8 ba 01 00 00       	call   80104719 <sched>
  panic("zombie exit");
8010455f:	c7 04 24 45 85 10 80 	movl   $0x80108545,(%esp)
80104566:	e8 d2 bf ff ff       	call   8010053d <panic>
...
8010456e:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104571:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104578:	e8 92 05 00 00       	call   80104b0f <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
8010457d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104584:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
8010458b:	e9 9d 00 00 00       	jmp    8010462d <wait+0xc2>
      if(p->parent != proc)
80104590:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104593:	8b 50 14             	mov    0x14(%eax),%edx
80104596:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010459c:	39 c2                	cmp    %eax,%edx
8010459e:	0f 85 81 00 00 00    	jne    80104625 <wait+0xba>
        continue;
      havekids = 1;
801045a4:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE){
801045ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045ae:	8b 40 0c             	mov    0xc(%eax),%eax
801045b1:	83 f8 05             	cmp    $0x5,%eax
801045b4:	75 70                	jne    80104626 <wait+0xbb>
        // Found one.
        pid = p->pid;
801045b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045b9:	8b 40 10             	mov    0x10(%eax),%eax
801045bc:	89 45 ec             	mov    %eax,-0x14(%ebp)
        kfree(p->kstack);
801045bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045c2:	8b 40 08             	mov    0x8(%eax),%eax
801045c5:	89 04 24             	mov    %eax,(%esp)
801045c8:	e8 91 e4 ff ff       	call   80102a5e <kfree>
        p->kstack = 0;
801045cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045d0:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
        freevm(p->pgdir);
801045d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045da:	8b 40 04             	mov    0x4(%eax),%eax
801045dd:	89 04 24             	mov    %eax,(%esp)
801045e0:	e8 60 39 00 00       	call   80107f45 <freevm>
        p->state = UNUSED;
801045e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045e8:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
        p->pid = 0;
801045ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045f2:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        p->parent = 0;
801045f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045fc:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
        p->name[0] = 0;
80104603:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104606:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
        p->killed = 0;
8010460a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010460d:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
        release(&ptable.lock);
80104614:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010461b:	e8 51 05 00 00       	call   80104b71 <release>
        return pid;
80104620:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104623:	eb 56                	jmp    8010467b <wait+0x110>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104625:	90                   	nop
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104626:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
8010462d:	81 7d f4 54 20 11 80 	cmpl   $0x80112054,-0xc(%ebp)
80104634:	0f 82 56 ff ff ff    	jb     80104590 <wait+0x25>
        return pid;
      }
    }
...
8010463a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010463e:	74 0d                	je     8010464d <wait+0xe2>
80104640:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104646:	8b 40 24             	mov    0x24(%eax),%eax
80104649:	85 c0                	test   %eax,%eax
8010464b:	74 13                	je     80104660 <wait+0xf5>
      release(&ptable.lock);
8010464d:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104654:	e8 18 05 00 00       	call   80104b71 <release>
      return -1;
80104659:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010465e:	eb 1b                	jmp    8010467b <wait+0x110>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80104660:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104666:	c7 44 24 04 20 ff 10 	movl   $0x8010ff20,0x4(%esp)
8010466d:	80 
8010466e:	89 04 24             	mov    %eax,(%esp)
80104671:	e8 b3 01 00 00       	call   80104829 <sleep>
  }
80104676:	e9 02 ff ff ff       	jmp    8010457d <wait+0x12>
}
8010467b:	c9                   	leave  
8010467c:	c3                   	ret    
...
80104680:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
80104683:	e8 65 f9 ff ff       	call   80103fed <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80104688:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010468f:	e8 7b 04 00 00       	call   80104b0f <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104694:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
8010469b:	eb 62                	jmp    801046ff <scheduler+0x82>
      if(p->state != RUNNABLE)
8010469d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046a0:	8b 40 0c             	mov    0xc(%eax),%eax
801046a3:	83 f8 03             	cmp    $0x3,%eax
801046a6:	75 4f                	jne    801046f7 <scheduler+0x7a>
        continue;
...
801046ab:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
801046b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046b4:	89 04 24             	mov    %eax,(%esp)
801046b7:	e8 12 34 00 00       	call   80107ace <switchuvm>
      p->state = RUNNING;
801046bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046bf:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
801046c6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046cc:	8b 40 1c             	mov    0x1c(%eax),%eax
801046cf:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801046d6:	83 c2 04             	add    $0x4,%edx
801046d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801046dd:	89 14 24             	mov    %edx,(%esp)
801046e0:	e8 1f 09 00 00       	call   80105004 <swtch>
      switchkvm();
801046e5:	e8 c7 33 00 00       	call   80107ab1 <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
801046ea:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801046f1:	00 00 00 00 
801046f5:	eb 01                	jmp    801046f8 <scheduler+0x7b>
...
801046ff:	81 7d f4 54 20 11 80 	cmpl   $0x80112054,-0xc(%ebp)
80104706:	72 95                	jb     8010469d <scheduler+0x20>
    ...
    release(&ptable.lock);
80104708:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010470f:	e8 5d 04 00 00       	call   80104b71 <release>

  }
80104714:	e9 6a ff ff ff       	jmp    80104683 <scheduler+0x6>
...
8010471f:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104726:	e8 02 05 00 00       	call   80104c2d <holding>
8010472b:	85 c0                	test   %eax,%eax
8010472d:	75 0c                	jne    8010473b <sched+0x22>
    panic("sched ptable.lock");
8010472f:	c7 04 24 51 85 10 80 	movl   $0x80108551,(%esp)
80104736:	e8 02 be ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
8010473b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104741:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104747:	83 f8 01             	cmp    $0x1,%eax
8010474a:	74 0c                	je     80104758 <sched+0x3f>
    panic("sched locks");
8010474c:	c7 04 24 63 85 10 80 	movl   $0x80108563,(%esp)
80104753:	e8 e5 bd ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
80104758:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010475e:	8b 40 0c             	mov    0xc(%eax),%eax
80104761:	83 f8 04             	cmp    $0x4,%eax
80104764:	75 0c                	jne    80104772 <sched+0x59>
    panic("sched running");
80104766:	c7 04 24 6f 85 10 80 	movl   $0x8010856f,(%esp)
8010476d:	e8 cb bd ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
80104772:	e8 61 f8 ff ff       	call   80103fd8 <readeflags>
80104777:	25 00 02 00 00       	and    $0x200,%eax
8010477c:	85 c0                	test   %eax,%eax
8010477e:	74 0c                	je     8010478c <sched+0x73>
    panic("sched interruptible");
80104780:	c7 04 24 7d 85 10 80 	movl   $0x8010857d,(%esp)
80104787:	e8 b1 bd ff ff       	call   8010053d <panic>
  intena = cpu->intena;
8010478c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104792:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104798:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
8010479b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801047a1:	8b 40 04             	mov    0x4(%eax),%eax
801047a4:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801047ab:	83 c2 1c             	add    $0x1c,%edx
801047ae:	89 44 24 04          	mov    %eax,0x4(%esp)
801047b2:	89 14 24             	mov    %edx,(%esp)
801047b5:	e8 4a 08 00 00       	call   80105004 <swtch>
  cpu->intena = intena;
801047ba:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801047c0:	8b 55 f4             	mov    -0xc(%ebp),%edx
801047c3:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
801047c9:	c9                   	leave  
801047ca:	c3                   	ret    
...
801047d1:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801047d8:	e8 32 03 00 00       	call   80104b0f <acquire>
  proc->state = RUNNABLE;
801047dd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047e3:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
801047ea:	e8 2a ff ff ff       	call   80104719 <sched>
  release(&ptable.lock);
801047ef:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801047f6:	e8 76 03 00 00       	call   80104b71 <release>
}
801047fb:	c9                   	leave  
801047fc:	c3                   	ret    
...
80104800:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104803:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010480a:	e8 62 03 00 00       	call   80104b71 <release>

  if (first) {
8010480f:	a1 20 b0 10 80       	mov    0x8010b020,%eax
80104814:	85 c0                	test   %eax,%eax
80104816:	74 0f                	je     80104827 <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104818:	c7 05 20 b0 10 80 00 	movl   $0x0,0x8010b020
8010481f:	00 00 00 
    initlog();
80104822:	e8 e1 e7 ff ff       	call   80103008 <initlog>
  }
...
80104837:	75 0c                	jne    80104845 <sleep+0x1c>
    panic("sleep");
80104839:	c7 04 24 91 85 10 80 	movl   $0x80108591,(%esp)
80104840:	e8 f8 bc ff ff       	call   8010053d <panic>

  if(lk == 0)
80104845:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104849:	75 0c                	jne    80104857 <sleep+0x2e>
    panic("sleep without lk");
8010484b:	c7 04 24 97 85 10 80 	movl   $0x80108597,(%esp)
80104852:	e8 e6 bc ff ff       	call   8010053d <panic>
...
80104857:	81 7d 0c 20 ff 10 80 	cmpl   $0x8010ff20,0xc(%ebp)
8010485e:	74 17                	je     80104877 <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104860:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104867:	e8 a3 02 00 00       	call   80104b0f <acquire>
    release(lk);
8010486c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010486f:	89 04 24             	mov    %eax,(%esp)
80104872:	e8 fa 02 00 00       	call   80104b71 <release>
  }
...
80104880:	89 50 20             	mov    %edx,0x20(%eax)
  proc->state = SLEEPING;
80104883:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104889:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104890:	e8 84 fe ff ff       	call   80104719 <sched>

  // Tidy up.
  proc->chan = 0;
80104895:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010489b:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
801048a2:	81 7d 0c 20 ff 10 80 	cmpl   $0x8010ff20,0xc(%ebp)
801048a9:	74 17                	je     801048c2 <sleep+0x99>
    release(&ptable.lock);
801048ab:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
801048b2:	e8 ba 02 00 00       	call   80104b71 <release>
    acquire(lk);
801048b7:	8b 45 0c             	mov    0xc(%ebp),%eax
801048ba:	89 04 24             	mov    %eax,(%esp)
801048bd:	e8 4d 02 00 00       	call   80104b0f <acquire>
  }
}
801048c2:	c9                   	leave  
801048c3:	c3                   	ret    
...
801048c7:	83 ec 10             	sub    $0x10,%esp
  struct proc *p;

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801048ca:	c7 45 fc 54 ff 10 80 	movl   $0x8010ff54,-0x4(%ebp)
801048d1:	eb 27                	jmp    801048fa <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
801048d3:	8b 45 fc             	mov    -0x4(%ebp),%eax
801048d6:	8b 40 0c             	mov    0xc(%eax),%eax
801048d9:	83 f8 02             	cmp    $0x2,%eax
801048dc:	75 15                	jne    801048f3 <wakeup1+0x2f>
801048de:	8b 45 fc             	mov    -0x4(%ebp),%eax
801048e1:	8b 40 20             	mov    0x20(%eax),%eax
801048e4:	3b 45 08             	cmp    0x8(%ebp),%eax
801048e7:	75 0a                	jne    801048f3 <wakeup1+0x2f>
      p->state = RUNNABLE;
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801048f3:	81 45 fc 84 00 00 00 	addl   $0x84,-0x4(%ebp)
801048fa:	81 7d fc 54 20 11 80 	cmpl   $0x80112054,-0x4(%ebp)
80104901:	72 d0                	jb     801048d3 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80104903:	c9                   	leave  
...
80104908:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
8010490b:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104912:	e8 f8 01 00 00       	call   80104b0f <acquire>
  wakeup1(chan);
80104917:	8b 45 08             	mov    0x8(%ebp),%eax
8010491a:	89 04 24             	mov    %eax,(%esp)
8010491d:	e8 a2 ff ff ff       	call   801048c4 <wakeup1>
  release(&ptable.lock);
80104922:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
80104929:	e8 43 02 00 00       	call   80104b71 <release>
}
8010492e:	c9                   	leave  
8010492f:	c3                   	ret    
...
8010493d:	e8 cd 01 00 00       	call   80104b0f <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104942:	c7 45 f4 54 ff 10 80 	movl   $0x8010ff54,-0xc(%ebp)
80104949:	eb 44                	jmp    8010498f <kill+0x5f>
    if(p->pid == pid){
8010494b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010494e:	8b 40 10             	mov    0x10(%eax),%eax
80104951:	3b 45 08             	cmp    0x8(%ebp),%eax
80104954:	75 32                	jne    80104988 <kill+0x58>
      p->killed = 1;
80104956:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104959:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80104960:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104963:	8b 40 0c             	mov    0xc(%eax),%eax
80104966:	83 f8 02             	cmp    $0x2,%eax
80104969:	75 0a                	jne    80104975 <kill+0x45>
        p->state = RUNNABLE;
8010496b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010496e:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104975:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010497c:	e8 f0 01 00 00       	call   80104b71 <release>
      return 0;
80104981:	b8 00 00 00 00       	mov    $0x0,%eax
80104986:	eb 21                	jmp    801049a9 <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104988:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
8010498f:	81 7d f4 54 20 11 80 	cmpl   $0x80112054,-0xc(%ebp)
80104996:	72 b3                	jb     8010494b <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80104998:	c7 04 24 20 ff 10 80 	movl   $0x8010ff20,(%esp)
8010499f:	e8 cd 01 00 00       	call   80104b71 <release>
  return -1;
...
801049ae:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049b1:	c7 45 f0 54 ff 10 80 	movl   $0x8010ff54,-0x10(%ebp)
801049b8:	e9 db 00 00 00       	jmp    80104a98 <procdump+0xed>
    if(p->state == UNUSED)
801049bd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801049c0:	8b 40 0c             	mov    0xc(%eax),%eax
801049c3:	85 c0                	test   %eax,%eax
801049c5:	0f 84 c5 00 00 00    	je     80104a90 <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801049cb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801049ce:	8b 40 0c             	mov    0xc(%eax),%eax
801049d1:	83 f8 05             	cmp    $0x5,%eax
801049d4:	77 23                	ja     801049f9 <procdump+0x4e>
801049d6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801049d9:	8b 40 0c             	mov    0xc(%eax),%eax
801049dc:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
801049e3:	85 c0                	test   %eax,%eax
801049e5:	74 12                	je     801049f9 <procdump+0x4e>
      state = states[p->state];
801049e7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801049ea:	8b 40 0c             	mov    0xc(%eax),%eax
801049ed:	8b 04 85 08 b0 10 80 	mov    -0x7fef4ff8(,%eax,4),%eax
801049f4:	89 45 ec             	mov    %eax,-0x14(%ebp)
801049f7:	eb 07                	jmp    80104a00 <procdump+0x55>
    else
      state = "???";
801049f9:	c7 45 ec a8 85 10 80 	movl   $0x801085a8,-0x14(%ebp)
    cprintf("%d %s %s", p->pid, state, p->name);
80104a00:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a03:	8d 50 6c             	lea    0x6c(%eax),%edx
80104a06:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a09:	8b 40 10             	mov    0x10(%eax),%eax
80104a0c:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104a10:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104a13:	89 54 24 08          	mov    %edx,0x8(%esp)
80104a17:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a1b:	c7 04 24 ac 85 10 80 	movl   $0x801085ac,(%esp)
80104a22:	e8 7a b9 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80104a27:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a2a:	8b 40 0c             	mov    0xc(%eax),%eax
80104a2d:	83 f8 02             	cmp    $0x2,%eax
80104a30:	75 50                	jne    80104a82 <procdump+0xd7>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104a32:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104a35:	8b 40 1c             	mov    0x1c(%eax),%eax
80104a38:	8b 40 0c             	mov    0xc(%eax),%eax
80104a3b:	83 c0 08             	add    $0x8,%eax
80104a3e:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104a41:	89 54 24 04          	mov    %edx,0x4(%esp)
80104a45:	89 04 24             	mov    %eax,(%esp)
80104a48:	e8 73 01 00 00       	call   80104bc0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104a4d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104a54:	eb 1b                	jmp    80104a71 <procdump+0xc6>
        cprintf(" %p", pc[i]);
80104a56:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a59:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104a5d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a61:	c7 04 24 b5 85 10 80 	movl   $0x801085b5,(%esp)
80104a68:	e8 34 b9 ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
      getcallerpcs((uint*)p->context->ebp+2, pc);
      for(i=0; i<10 && pc[i] != 0; i++)
80104a6d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104a71:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104a75:	7f 0b                	jg     80104a82 <procdump+0xd7>
80104a77:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a7a:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104a7e:	85 c0                	test   %eax,%eax
80104a80:	75 d4                	jne    80104a56 <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104a82:	c7 04 24 b9 85 10 80 	movl   $0x801085b9,(%esp)
80104a89:	e8 13 b9 ff ff       	call   801003a1 <cprintf>
80104a8e:	eb 01                	jmp    80104a91 <procdump+0xe6>
  char *state;
  uint pc[10];
...
80104a90:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a91:	81 45 f0 84 00 00 00 	addl   $0x84,-0x10(%ebp)
80104a98:	81 7d f0 54 20 11 80 	cmpl   $0x80112054,-0x10(%ebp)
80104a9f:	0f 82 18 ff ff ff    	jb     801049bd <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104aaf:	9c                   	pushf  
80104ab0:	5b                   	pop    %ebx
80104ab1:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
80104ab4:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
xchg(volatile uint *addr, uint newval)
{
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
80104ad3:	8b 45 0c             	mov    0xc(%ebp),%eax
               "+m" (*addr), "=a" (result) :
80104ad6:	8b 4d 08             	mov    0x8(%ebp),%ecx
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80104adb:	89 d8                	mov    %ebx,%eax
80104add:	f0 87 02             	lock xchg %eax,(%edx)
80104ae0:	89 c3                	mov    %eax,%ebx
80104ae2:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
80104ae5:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80104af4:	8b 55 0c             	mov    0xc(%ebp),%edx
80104af7:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
...
80104b15:	e8 3d 01 00 00       	call   80104c57 <pushcli>
  if(holding(lk))
80104b1a:	8b 45 08             	mov    0x8(%ebp),%eax
80104b1d:	89 04 24             	mov    %eax,(%esp)
80104b20:	e8 08 01 00 00       	call   80104c2d <holding>
80104b25:	85 c0                	test   %eax,%eax
80104b27:	74 0c                	je     80104b35 <acquire+0x26>
    panic("acquire");
80104b29:	c7 04 24 e5 85 10 80 	movl   $0x801085e5,(%esp)
80104b30:	e8 08 ba ff ff       	call   8010053d <panic>
...
80104b39:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104b40:	00 
80104b41:	89 04 24             	mov    %eax,(%esp)
80104b44:	e8 80 ff ff ff       	call   80104ac9 <xchg>
80104b49:	85 c0                	test   %eax,%eax
80104b4b:	75 e9                	jne    80104b36 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104b4d:	8b 45 08             	mov    0x8(%ebp),%eax
80104b50:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104b57:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104b5a:	8b 45 08             	mov    0x8(%ebp),%eax
80104b5d:	83 c0 0c             	add    $0xc,%eax
80104b60:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b64:	8d 45 08             	lea    0x8(%ebp),%eax
80104b67:	89 04 24             	mov    %eax,(%esp)
80104b6a:	e8 51 00 00 00       	call   80104bc0 <getcallerpcs>
}
80104b6f:	c9                   	leave  
80104b70:	c3                   	ret    
...
80104b7d:	e8 ab 00 00 00       	call   80104c2d <holding>
80104b82:	85 c0                	test   %eax,%eax
80104b84:	75 0c                	jne    80104b92 <release+0x21>
    panic("release");
80104b86:	c7 04 24 ed 85 10 80 	movl   $0x801085ed,(%esp)
80104b8d:	e8 ab b9 ff ff       	call   8010053d <panic>

  lk->pcs[0] = 0;
80104b92:	8b 45 08             	mov    0x8(%ebp),%eax
80104b95:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80104b9c:	8b 45 08             	mov    0x8(%ebp),%eax
80104b9f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80104ba9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104bb0:	00 
80104bb1:	89 04 24             	mov    %eax,(%esp)
80104bb4:	e8 10 ff ff ff       	call   80104ac9 <xchg>

  popcli();
80104bb9:	e8 e1 00 00 00       	call   80104c9f <popcli>
}
80104bbe:	c9                   	leave  
80104bbf:	c3                   	ret    
...
80104bc9:	83 e8 08             	sub    $0x8,%eax
80104bcc:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80104bcf:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104bd6:	eb 32                	jmp    80104c0a <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104bd8:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104bdc:	74 47                	je     80104c25 <getcallerpcs+0x65>
80104bde:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104be5:	76 3e                	jbe    80104c25 <getcallerpcs+0x65>
80104be7:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104beb:	74 38                	je     80104c25 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104bed:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104bf0:	c1 e0 02             	shl    $0x2,%eax
80104bf3:	03 45 0c             	add    0xc(%ebp),%eax
80104bf6:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104bf9:	8b 52 04             	mov    0x4(%edx),%edx
80104bfc:	89 10                	mov    %edx,(%eax)
...
80104c03:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104c06:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104c0a:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104c0e:	7e c8                	jle    80104bd8 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104c10:	eb 13                	jmp    80104c25 <getcallerpcs+0x65>
    pcs[i] = 0;
80104c12:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104c15:	c1 e0 02             	shl    $0x2,%eax
80104c18:	03 45 0c             	add    0xc(%ebp),%eax
80104c1b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104c21:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104c25:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104c29:	7e e7                	jle    80104c12 <getcallerpcs+0x52>
    pcs[i] = 0;
}
80104c2b:	c9                   	leave  
80104c2c:	c3                   	ret    
...
80104c37:	74 17                	je     80104c50 <holding+0x23>
80104c39:	8b 45 08             	mov    0x8(%ebp),%eax
80104c3c:	8b 50 08             	mov    0x8(%eax),%edx
80104c3f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c45:	39 c2                	cmp    %eax,%edx
80104c47:	75 07                	jne    80104c50 <holding+0x23>
80104c49:	b8 01 00 00 00       	mov    $0x1,%eax
80104c4e:	eb 05                	jmp    80104c55 <holding+0x28>
...
80104c5a:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80104c5d:	e8 46 fe ff ff       	call   80104aa8 <readeflags>
80104c62:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104c65:	e8 53 fe ff ff       	call   80104abd <cli>
  if(cpu->ncli++ == 0)
80104c6a:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c70:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104c76:	85 d2                	test   %edx,%edx
80104c78:	0f 94 c1             	sete   %cl
80104c7b:	83 c2 01             	add    $0x1,%edx
80104c7e:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104c84:	84 c9                	test   %cl,%cl
80104c86:	74 15                	je     80104c9d <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80104c88:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104c8e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104c91:	81 e2 00 02 00 00    	and    $0x200,%edx
80104c97:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104c9d:	c9                   	leave  
80104c9e:	c3                   	ret    
...
80104ca2:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80104ca5:	e8 fe fd ff ff       	call   80104aa8 <readeflags>
80104caa:	25 00 02 00 00       	and    $0x200,%eax
80104caf:	85 c0                	test   %eax,%eax
80104cb1:	74 0c                	je     80104cbf <popcli+0x20>
    panic("popcli - interruptible");
80104cb3:	c7 04 24 f5 85 10 80 	movl   $0x801085f5,(%esp)
80104cba:	e8 7e b8 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
80104cbf:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104cc5:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104ccb:	83 ea 01             	sub    $0x1,%edx
80104cce:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104cd4:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104cda:	85 c0                	test   %eax,%eax
80104cdc:	79 0c                	jns    80104cea <popcli+0x4b>
    panic("popcli");
80104cde:	c7 04 24 0c 86 10 80 	movl   $0x8010860c,(%esp)
80104ce5:	e8 53 b8 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
80104cea:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104cf0:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104cf6:	85 c0                	test   %eax,%eax
80104cf8:	75 15                	jne    80104d0f <popcli+0x70>
80104cfa:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104d00:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104d06:	85 c0                	test   %eax,%eax
80104d08:	74 05                	je     80104d0f <popcli+0x70>
    sti();
80104d0a:	e8 b4 fd ff ff       	call   80104ac3 <sti>
}
80104d0f:	c9                   	leave  
80104d10:	c3                   	ret    
80104d11:	00 00                	add    %al,(%eax)
	...
...
80104d28:	fc                   	cld    
80104d29:	f3 aa                	rep stos %al,%es:(%edi)
...
80104d67:	83 e0 03             	and    $0x3,%eax
80104d6a:	85 c0                	test   %eax,%eax
80104d6c:	75 49                	jne    80104db7 <memset+0x59>
80104d6e:	8b 45 10             	mov    0x10(%ebp),%eax
80104d71:	83 e0 03             	and    $0x3,%eax
80104d74:	85 c0                	test   %eax,%eax
80104d76:	75 3f                	jne    80104db7 <memset+0x59>
    c &= 0xFF;
80104d78:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104d7f:	8b 45 10             	mov    0x10(%ebp),%eax
80104d82:	c1 e8 02             	shr    $0x2,%eax
80104d85:	89 c2                	mov    %eax,%edx
80104d87:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d8a:	89 c1                	mov    %eax,%ecx
80104d8c:	c1 e1 18             	shl    $0x18,%ecx
80104d8f:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d92:	c1 e0 10             	shl    $0x10,%eax
80104d95:	09 c1                	or     %eax,%ecx
80104d97:	8b 45 0c             	mov    0xc(%ebp),%eax
80104d9a:	c1 e0 08             	shl    $0x8,%eax
80104d9d:	09 c8                	or     %ecx,%eax
80104d9f:	0b 45 0c             	or     0xc(%ebp),%eax
80104da2:	89 54 24 08          	mov    %edx,0x8(%esp)
80104da6:	89 44 24 04          	mov    %eax,0x4(%esp)
80104daa:	8b 45 08             	mov    0x8(%ebp),%eax
80104dad:	89 04 24             	mov    %eax,(%esp)
80104db0:	e8 84 ff ff ff       	call   80104d39 <stosl>
80104db5:	eb 19                	jmp    80104dd0 <memset+0x72>
  } else
    stosb(dst, c, n);
80104db7:	8b 45 10             	mov    0x10(%ebp),%eax
80104dba:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80104dcb:	e8 44 ff ff ff       	call   80104d14 <stosb>
  return dst;
...
80104dde:	89 45 fc             	mov    %eax,-0x4(%ebp)
  s2 = v2;
80104de1:	8b 45 0c             	mov    0xc(%ebp),%eax
80104de4:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80104de7:	eb 32                	jmp    80104e1b <memcmp+0x46>
    if(*s1 != *s2)
80104de9:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104dec:	0f b6 10             	movzbl (%eax),%edx
80104def:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104df2:	0f b6 00             	movzbl (%eax),%eax
80104df5:	38 c2                	cmp    %al,%dl
80104df7:	74 1a                	je     80104e13 <memcmp+0x3e>
      return *s1 - *s2;
80104df9:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104dfc:	0f b6 00             	movzbl (%eax),%eax
80104dff:	0f b6 d0             	movzbl %al,%edx
80104e02:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104e05:	0f b6 00             	movzbl (%eax),%eax
80104e08:	0f b6 c0             	movzbl %al,%eax
80104e0b:	89 d1                	mov    %edx,%ecx
80104e0d:	29 c1                	sub    %eax,%ecx
80104e0f:	89 c8                	mov    %ecx,%eax
80104e11:	eb 1c                	jmp    80104e2f <memcmp+0x5a>
    s1++, s2++;
80104e13:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80104e17:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
  ...
  s2 = v2;
  while(n-- > 0){
80104e1b:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104e1f:	0f 95 c0             	setne  %al
80104e22:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104e26:	84 c0                	test   %al,%al
80104e28:	75 bf                	jne    80104de9 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
  ...
  return 0;
80104e2a:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104e2f:	c9                   	leave  
80104e30:	c3                   	ret    
...
80104e40:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
80104e43:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104e46:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80104e49:	73 54                	jae    80104e9f <memmove+0x6e>
80104e4b:	8b 45 10             	mov    0x10(%ebp),%eax
80104e4e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104e51:	01 d0                	add    %edx,%eax
80104e53:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80104e56:	76 47                	jbe    80104e9f <memmove+0x6e>
    s += n;
80104e58:	8b 45 10             	mov    0x10(%ebp),%eax
80104e5b:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80104e5e:	8b 45 10             	mov    0x10(%ebp),%eax
80104e61:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80104e64:	eb 13                	jmp    80104e79 <memmove+0x48>
      *--d = *--s;
80104e66:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80104e6a:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80104e6e:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104e71:	0f b6 10             	movzbl (%eax),%edx
80104e74:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104e77:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
    d += n;
    while(n-- > 0)
80104e79:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104e7d:	0f 95 c0             	setne  %al
80104e80:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104e84:	84 c0                	test   %al,%al
80104e86:	75 de                	jne    80104e66 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104e88:	eb 25                	jmp    80104eaf <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
80104e8d:	0f b6 10             	movzbl (%eax),%edx
80104e90:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104e93:	88 10                	mov    %dl,(%eax)
80104e95:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104e99:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80104e9d:	eb 01                	jmp    80104ea0 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
80104e9f:	90                   	nop
80104ea0:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104ea4:	0f 95 c0             	setne  %al
80104ea7:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104eab:	84 c0                	test   %al,%al
80104ead:	75 db                	jne    80104e8a <memmove+0x59>
      *d++ = *s++;
...
80104ebd:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80104ece:	e8 5e ff ff ff       	call   80104e31 <memmove>
}
80104ed3:	c9                   	leave  
80104ed4:	c3                   	ret    
...
80104ed6:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80104ed8:	eb 0c                	jmp    80104ee6 <strncmp+0x11>
    n--, p++, q++;
80104eda:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104ede:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80104ee2:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
  while(n > 0 && *p && *p == *q)
80104ee6:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104eea:	74 1a                	je     80104f06 <strncmp+0x31>
80104eec:	8b 45 08             	mov    0x8(%ebp),%eax
80104eef:	0f b6 00             	movzbl (%eax),%eax
80104ef2:	84 c0                	test   %al,%al
80104ef4:	74 10                	je     80104f06 <strncmp+0x31>
80104ef6:	8b 45 08             	mov    0x8(%ebp),%eax
80104ef9:	0f b6 10             	movzbl (%eax),%edx
80104efc:	8b 45 0c             	mov    0xc(%ebp),%eax
80104eff:	0f b6 00             	movzbl (%eax),%eax
80104f02:	38 c2                	cmp    %al,%dl
80104f04:	74 d4                	je     80104eda <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
80104f06:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104f0a:	75 07                	jne    80104f13 <strncmp+0x3e>
    return 0;
80104f0c:	b8 00 00 00 00       	mov    $0x0,%eax
80104f11:	eb 18                	jmp    80104f2b <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
80104f13:	8b 45 08             	mov    0x8(%ebp),%eax
80104f16:	0f b6 00             	movzbl (%eax),%eax
80104f19:	0f b6 d0             	movzbl %al,%edx
80104f1c:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f1f:	0f b6 00             	movzbl (%eax),%eax
80104f22:	0f b6 c0             	movzbl %al,%eax
80104f25:	89 d1                	mov    %edx,%ecx
80104f27:	29 c1                	sub    %eax,%ecx
80104f29:	89 c8                	mov    %ecx,%eax
}
80104f2b:	5d                   	pop    %ebp
80104f2c:	c3                   	ret    
...
80104f3e:	0f 9f c0             	setg   %al
80104f41:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104f45:	84 c0                	test   %al,%al
80104f47:	74 30                	je     80104f79 <strncpy+0x4c>
80104f49:	8b 45 0c             	mov    0xc(%ebp),%eax
80104f4c:	0f b6 10             	movzbl (%eax),%edx
80104f4f:	8b 45 08             	mov    0x8(%ebp),%eax
80104f52:	88 10                	mov    %dl,(%eax)
80104f54:	8b 45 08             	mov    0x8(%ebp),%eax
80104f57:	0f b6 00             	movzbl (%eax),%eax
80104f5a:	84 c0                	test   %al,%al
80104f5c:	0f 95 c0             	setne  %al
80104f5f:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80104f63:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104f67:	84 c0                	test   %al,%al
80104f69:	75 cf                	jne    80104f3a <strncpy+0xd>
    ;
  while(n-- > 0)
80104f6b:	eb 0c                	jmp    80104f79 <strncpy+0x4c>
    *s++ = 0;
80104f6d:	8b 45 08             	mov    0x8(%ebp),%eax
80104f70:	c6 00 00             	movb   $0x0,(%eax)
80104f73:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80104f77:	eb 01                	jmp    80104f7a <strncpy+0x4d>
  char *os;
...
80104f87:	75 e4                	jne    80104f6d <strncpy+0x40>
    *s++ = 0;
  return os;
...
80104f9e:	7f 05                	jg     80104fa5 <safestrcpy+0x17>
    return os;
80104fa0:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104fa3:	eb 35                	jmp    80104fda <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80104fa5:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80104fa9:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80104fad:	7e 22                	jle    80104fd1 <safestrcpy+0x43>
80104faf:	8b 45 0c             	mov    0xc(%ebp),%eax
80104fb2:	0f b6 10             	movzbl (%eax),%edx
...
80104fc2:	0f 95 c0             	setne  %al
80104fc5:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80104fc9:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104fcd:	84 c0                	test   %al,%al
80104fcf:	75 d4                	jne    80104fa5 <safestrcpy+0x17>
    ;
  *s = 0;
80104fd1:	8b 45 08             	mov    0x8(%ebp),%eax
80104fd4:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
80104fdf:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
80104fe2:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80104fe9:	eb 04                	jmp    80104fef <strlen+0x13>
80104feb:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80104fef:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104ff2:	03 45 08             	add    0x8(%ebp),%eax
80104ff5:	0f b6 00             	movzbl (%eax),%eax
80104ff8:	84 c0                	test   %al,%al
80104ffa:	75 ef                	jne    80104feb <strlen+0xf>
    ;
  return n;
80104ffc:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80104fff:	c9                   	leave  
80105000:	c3                   	ret    
80105001:	00 00                	add    %al,(%eax)
	...
...
swtch:
  movl 4(%esp), %eax
80105004:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105008:	8b 54 24 08          	mov    0x8(%esp),%edx
...
8010500f:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105010:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105012:	89 d4                	mov    %edx,%esp
...
80105027:	3b 45 08             	cmp    0x8(%ebp),%eax
8010502a:	76 12                	jbe    8010503e <fetchint+0x22>
8010502c:	8b 45 08             	mov    0x8(%ebp),%eax
8010502f:	8d 50 04             	lea    0x4(%eax),%edx
80105032:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105038:	8b 00                	mov    (%eax),%eax
8010503a:	39 c2                	cmp    %eax,%edx
8010503c:	76 07                	jbe    80105045 <fetchint+0x29>
    return -1;
8010503e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105043:	eb 0f                	jmp    80105054 <fetchint+0x38>
  *ip = *(int*)(addr);
...
8010504d:	89 10                	mov    %edx,(%eax)
  return 0;
8010504f:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105054:	5d                   	pop    %ebp
80105055:	c3                   	ret    
...
801050a5:	eb 11                	jmp    801050b8 <fetchstr+0x62>
...
801050b1:	72 da                	jb     8010508d <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
801050c6:	8b 40 18             	mov    0x18(%eax),%eax
801050c9:	8b 50 44             	mov    0x44(%eax),%edx
801050cc:	8b 45 08             	mov    0x8(%ebp),%eax
801050cf:	c1 e0 02             	shl    $0x2,%eax
801050d2:	01 d0                	add    %edx,%eax
801050d4:	8d 50 04             	lea    0x4(%eax),%edx
801050d7:	8b 45 0c             	mov    0xc(%ebp),%eax
801050da:	89 44 24 04          	mov    %eax,0x4(%esp)
801050de:	89 14 24             	mov    %edx,(%esp)
801050e1:	e8 36 ff ff ff       	call   8010501c <fetchint>
}
801050e6:	c9                   	leave  
801050e7:	c3                   	ret    
...
8010514d:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
80105150:	8d 45 fc             	lea    -0x4(%ebp),%eax
80105153:	89 44 24 04          	mov    %eax,0x4(%esp)
80105157:	8b 45 08             	mov    0x8(%ebp),%eax
8010515a:	89 04 24             	mov    %eax,(%esp)
8010515d:	e8 58 ff ff ff       	call   801050ba <argint>
80105162:	85 c0                	test   %eax,%eax
80105164:	79 07                	jns    8010516d <argstr+0x23>
    return -1;
80105166:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010516b:	eb 12                	jmp    8010517f <argstr+0x35>
  return fetchstr(addr, pp);
8010516d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105170:	8b 55 0c             	mov    0xc(%ebp),%edx
80105173:	89 54 24 04          	mov    %edx,0x4(%esp)
80105177:	89 04 24             	mov    %eax,(%esp)
8010517a:	e8 d7 fe ff ff       	call   80105056 <fetchstr>
}
8010517f:	c9                   	leave  
80105180:	c3                   	ret    
...
80105185:	83 ec 24             	sub    $0x24,%esp
  int num;
...
80105194:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105197:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010519b:	7e 30                	jle    801051cd <syscall+0x4c>
8010519d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051a0:	83 f8 16             	cmp    $0x16,%eax
801051a3:	77 28                	ja     801051cd <syscall+0x4c>
801051a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051a8:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801051af:	85 c0                	test   %eax,%eax
801051b1:	74 1a                	je     801051cd <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
801051b3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051b9:	8b 58 18             	mov    0x18(%eax),%ebx
801051bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051bf:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
801051c6:	ff d0                	call   *%eax
801051c8:	89 43 1c             	mov    %eax,0x1c(%ebx)
801051cb:	eb 3d                	jmp    8010520a <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801051cd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051d3:	8d 48 6c             	lea    0x6c(%eax),%ecx
801051d6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
801051dc:	8b 40 10             	mov    0x10(%eax),%eax
801051df:	8b 55 f4             	mov    -0xc(%ebp),%edx
801051e2:	89 54 24 0c          	mov    %edx,0xc(%esp)
801051e6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801051ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801051ee:	c7 04 24 13 86 10 80 	movl   $0x80108613,(%esp)
801051f5:	e8 a7 b1 ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801051fa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105200:	8b 40 18             	mov    0x18(%eax),%eax
80105203:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
80105259:	75 07                	jne    80105262 <argfd+0x52>
    return -1;
8010525b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105260:	eb 21                	jmp    80105283 <argfd+0x73>
  if(pfd)
80105262:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105266:	74 08                	je     80105270 <argfd+0x60>
    *pfd = fd;
...
80105274:	74 08                	je     8010527e <argfd+0x6e>
    *pf = f;
...
80105288:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010528b:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105292:	eb 30                	jmp    801052c4 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105294:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010529a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010529d:	83 c2 08             	add    $0x8,%edx
801052a0:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801052a4:	85 c0                	test   %eax,%eax
801052a6:	75 18                	jne    801052c0 <fdalloc+0x3b>
      proc->ofile[fd] = f;
801052a8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801052ae:	8b 55 fc             	mov    -0x4(%ebp),%edx
801052b1:	8d 4a 08             	lea    0x8(%edx),%ecx
801052b4:	8b 55 08             	mov    0x8(%ebp),%edx
801052b7:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
801052bb:	8b 45 fc             	mov    -0x4(%ebp),%eax
801052be:	eb 0f                	jmp    801052cf <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
801052c0:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801052c4:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
801052c8:	7e ca                	jle    80105294 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105335:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010533c:	00 
8010533d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105344:	e8 c7 fe ff ff       	call   80105210 <argfd>
80105349:	85 c0                	test   %eax,%eax
8010534b:	78 35                	js     80105382 <sys_read+0x5a>
8010534d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105350:	89 44 24 04          	mov    %eax,0x4(%esp)
80105354:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010535b:	e8 5a fd ff ff       	call   801050ba <argint>
80105360:	85 c0                	test   %eax,%eax
80105362:	78 1e                	js     80105382 <sys_read+0x5a>
80105364:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105367:	89 44 24 08          	mov    %eax,0x8(%esp)
8010536b:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010536e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105372:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105379:	e8 6a fd ff ff       	call   801050e8 <argptr>
8010537e:	85 c0                	test   %eax,%eax
80105380:	79 07                	jns    80105389 <sys_read+0x61>
    return -1;
80105382:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105387:	eb 19                	jmp    801053a2 <sys_read+0x7a>
  return fileread(f, p, n);
80105389:	8b 4d f0             	mov    -0x10(%ebp),%ecx
8010538c:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010538f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105392:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105396:	89 54 24 04          	mov    %edx,0x4(%esp)
8010539a:	89 04 24             	mov    %eax,(%esp)
8010539d:	e8 3f bd ff ff       	call   801010e1 <fileread>
}
801053a2:	c9                   	leave  
801053a3:	c3                   	ret    
...
801053b1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801053b8:	00 
801053b9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801053c0:	e8 4b fe ff ff       	call   80105210 <argfd>
801053c5:	85 c0                	test   %eax,%eax
801053c7:	78 35                	js     801053fe <sys_write+0x5a>
801053c9:	8d 45 f0             	lea    -0x10(%ebp),%eax
801053cc:	89 44 24 04          	mov    %eax,0x4(%esp)
801053d0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801053d7:	e8 de fc ff ff       	call   801050ba <argint>
801053dc:	85 c0                	test   %eax,%eax
801053de:	78 1e                	js     801053fe <sys_write+0x5a>
801053e0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801053e3:	89 44 24 08          	mov    %eax,0x8(%esp)
801053e7:	8d 45 ec             	lea    -0x14(%ebp),%eax
801053ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801053ee:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801053f5:	e8 ee fc ff ff       	call   801050e8 <argptr>
801053fa:	85 c0                	test   %eax,%eax
801053fc:	79 07                	jns    80105405 <sys_write+0x61>
    return -1;
801053fe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105403:	eb 19                	jmp    8010541e <sys_write+0x7a>
  return filewrite(f, p, n);
80105405:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105408:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010540b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010540e:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105412:	89 54 24 04          	mov    %edx,0x4(%esp)
80105416:	89 04 24             	mov    %eax,(%esp)
80105419:	e8 7f bd ff ff       	call   8010119d <filewrite>
}
8010541e:	c9                   	leave  
8010541f:	c3                   	ret    
...
80105429:	89 44 24 08          	mov    %eax,0x8(%esp)
8010542d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105430:	89 44 24 04          	mov    %eax,0x4(%esp)
80105434:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010543b:	e8 d0 fd ff ff       	call   80105210 <argfd>
80105440:	85 c0                	test   %eax,%eax
80105442:	79 07                	jns    8010544b <sys_close+0x2b>
    return -1;
80105444:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105449:	eb 24                	jmp    8010546f <sys_close+0x4f>
  proc->ofile[fd] = 0;
...
80105465:	e8 52 bb ff ff       	call   80100fbc <fileclose>
  return 0;
...
80105474:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  struct stat *st;
...
8010547e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105485:	00 
80105486:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010548d:	e8 7e fd ff ff       	call   80105210 <argfd>
80105492:	85 c0                	test   %eax,%eax
80105494:	78 1f                	js     801054b5 <sys_fstat+0x44>
80105496:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010549d:	00 
8010549e:	8d 45 f0             	lea    -0x10(%ebp),%eax
801054a1:	89 44 24 04          	mov    %eax,0x4(%esp)
801054a5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801054ac:	e8 37 fc ff ff       	call   801050e8 <argptr>
801054b1:	85 c0                	test   %eax,%eax
801054b3:	79 07                	jns    801054bc <sys_fstat+0x4b>
    return -1;
801054b5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054ba:	eb 12                	jmp    801054ce <sys_fstat+0x5d>
  return filestat(f, st);
801054bc:	8b 55 f0             	mov    -0x10(%ebp),%edx
801054bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054c2:	89 54 24 04          	mov    %edx,0x4(%esp)
801054c6:	89 04 24             	mov    %eax,(%esp)
801054c9:	e8 c4 bb ff ff       	call   80101092 <filestat>
}
801054ce:	c9                   	leave  
801054cf:	c3                   	ret    
...
801054d3:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
801054d6:	8d 45 d8             	lea    -0x28(%ebp),%eax
801054d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801054dd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801054e4:	e8 61 fc ff ff       	call   8010514a <argstr>
801054e9:	85 c0                	test   %eax,%eax
801054eb:	78 17                	js     80105504 <sys_link+0x34>
801054ed:	8d 45 dc             	lea    -0x24(%ebp),%eax
801054f0:	89 44 24 04          	mov    %eax,0x4(%esp)
801054f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801054fb:	e8 4a fc ff ff       	call   8010514a <argstr>
80105500:	85 c0                	test   %eax,%eax
80105502:	79 0a                	jns    8010550e <sys_link+0x3e>
    return -1;
80105504:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105509:	e9 3c 01 00 00       	jmp    8010564a <sys_link+0x17a>
  if((ip = namei(old)) == 0)
8010550e:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105511:	89 04 24             	mov    %eax,(%esp)
80105514:	e8 e9 ce ff ff       	call   80102402 <namei>
80105519:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010551c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105520:	75 0a                	jne    8010552c <sys_link+0x5c>
    return -1;
80105522:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105527:	e9 1e 01 00 00       	jmp    8010564a <sys_link+0x17a>

  begin_trans();
8010552c:	e8 e4 dc ff ff       	call   80103215 <begin_trans>

  ilock(ip);
80105531:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105534:	89 04 24             	mov    %eax,(%esp)
80105537:	e8 24 c3 ff ff       	call   80101860 <ilock>
  if(ip->type == T_DIR){
8010553c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010553f:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105543:	66 83 f8 01          	cmp    $0x1,%ax
80105547:	75 1a                	jne    80105563 <sys_link+0x93>
    iunlockput(ip);
80105549:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010554c:	89 04 24             	mov    %eax,(%esp)
8010554f:	e8 90 c5 ff ff       	call   80101ae4 <iunlockput>
    commit_trans();
80105554:	e8 05 dd ff ff       	call   8010325e <commit_trans>
    return -1;
80105559:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010555e:	e9 e7 00 00 00       	jmp    8010564a <sys_link+0x17a>
  }
...
8010557a:	e8 25 c1 ff ff       	call   801016a4 <iupdate>
  iunlock(ip);
8010557f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105582:	89 04 24             	mov    %eax,(%esp)
80105585:	e8 24 c4 ff ff       	call   801019ae <iunlock>

  if((dp = nameiparent(new, name)) == 0)
8010558a:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010558d:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105590:	89 54 24 04          	mov    %edx,0x4(%esp)
80105594:	89 04 24             	mov    %eax,(%esp)
80105597:	e8 88 ce ff ff       	call   80102424 <nameiparent>
8010559c:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010559f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801055a3:	74 68                	je     8010560d <sys_link+0x13d>
    goto bad;
  ilock(dp);
801055a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055a8:	89 04 24             	mov    %eax,(%esp)
801055ab:	e8 b0 c2 ff ff       	call   80101860 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801055b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055b3:	8b 10                	mov    (%eax),%edx
801055b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055b8:	8b 00                	mov    (%eax),%eax
801055ba:	39 c2                	cmp    %eax,%edx
801055bc:	75 20                	jne    801055de <sys_link+0x10e>
801055be:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055c1:	8b 40 04             	mov    0x4(%eax),%eax
801055c4:	89 44 24 08          	mov    %eax,0x8(%esp)
801055c8:	8d 45 e2             	lea    -0x1e(%ebp),%eax
801055cb:	89 44 24 04          	mov    %eax,0x4(%esp)
801055cf:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055d2:	89 04 24             	mov    %eax,(%esp)
801055d5:	e8 67 cb ff ff       	call   80102141 <dirlink>
801055da:	85 c0                	test   %eax,%eax
801055dc:	79 0d                	jns    801055eb <sys_link+0x11b>
    iunlockput(dp);
801055de:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055e1:	89 04 24             	mov    %eax,(%esp)
801055e4:	e8 fb c4 ff ff       	call   80101ae4 <iunlockput>
    goto bad;
801055e9:	eb 23                	jmp    8010560e <sys_link+0x13e>
  }
  iunlockput(dp);
801055eb:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055ee:	89 04 24             	mov    %eax,(%esp)
801055f1:	e8 ee c4 ff ff       	call   80101ae4 <iunlockput>
  iput(ip);
801055f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801055f9:	89 04 24             	mov    %eax,(%esp)
801055fc:	e8 12 c4 ff ff       	call   80101a13 <iput>

  commit_trans();
80105601:	e8 58 dc ff ff       	call   8010325e <commit_trans>

  return 0;
80105606:	b8 00 00 00 00       	mov    $0x0,%eax
8010560b:	eb 3d                	jmp    8010564a <sys_link+0x17a>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
80105614:	e8 47 c2 ff ff       	call   80101860 <ilock>
  ip->nlink--;
80105619:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010561c:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105620:	8d 50 ff             	lea    -0x1(%eax),%edx
80105623:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105626:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
8010562a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010562d:	89 04 24             	mov    %eax,(%esp)
80105630:	e8 6f c0 ff ff       	call   801016a4 <iupdate>
  iunlockput(ip);
80105635:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105638:	89 04 24             	mov    %eax,(%esp)
8010563b:	e8 a4 c4 ff ff       	call   80101ae4 <iunlockput>
  commit_trans();
80105640:	e8 19 dc ff ff       	call   8010325e <commit_trans>
  return -1;
...
8010564f:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105652:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105659:	eb 4b                	jmp    801056a6 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010565b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010565e:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105665:	00 
80105666:	89 44 24 08          	mov    %eax,0x8(%esp)
8010566a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010566d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105671:	8b 45 08             	mov    0x8(%ebp),%eax
80105674:	89 04 24             	mov    %eax,(%esp)
80105677:	e8 da c6 ff ff       	call   80101d56 <readi>
8010567c:	83 f8 10             	cmp    $0x10,%eax
8010567f:	74 0c                	je     8010568d <isdirempty+0x41>
      panic("isdirempty: readi");
80105681:	c7 04 24 2f 86 10 80 	movl   $0x8010862f,(%esp)
80105688:	e8 b0 ae ff ff       	call   8010053d <panic>
    if(de.inum != 0)
8010568d:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105691:	66 85 c0             	test   %ax,%ax
80105694:	74 07                	je     8010569d <isdirempty+0x51>
      return 0;
80105696:	b8 00 00 00 00       	mov    $0x0,%eax
8010569b:	eb 1b                	jmp    801056b8 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
801056b1:	72 a8                	jb     8010565b <isdirempty+0xf>
  ...
  return 1;
801056b3:	b8 01 00 00 00       	mov    $0x1,%eax
}
801056b8:	c9                   	leave  
801056b9:	c3                   	ret    
...
801056bd:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801056c0:	8d 45 cc             	lea    -0x34(%ebp),%eax
801056c3:	89 44 24 04          	mov    %eax,0x4(%esp)
801056c7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801056ce:	e8 77 fa ff ff       	call   8010514a <argstr>
801056d3:	85 c0                	test   %eax,%eax
801056d5:	79 0a                	jns    801056e1 <sys_unlink+0x27>
    return -1;
801056d7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056dc:	e9 aa 01 00 00       	jmp    8010588b <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
801056e1:	8b 45 cc             	mov    -0x34(%ebp),%eax
801056e4:	8d 55 d2             	lea    -0x2e(%ebp),%edx
801056e7:	89 54 24 04          	mov    %edx,0x4(%esp)
801056eb:	89 04 24             	mov    %eax,(%esp)
801056ee:	e8 31 cd ff ff       	call   80102424 <nameiparent>
801056f3:	89 45 f4             	mov    %eax,-0xc(%ebp)
801056f6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801056fa:	75 0a                	jne    80105706 <sys_unlink+0x4c>
    return -1;
801056fc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105701:	e9 85 01 00 00       	jmp    8010588b <sys_unlink+0x1d1>

  begin_trans();
80105706:	e8 0a db ff ff       	call   80103215 <begin_trans>

  ilock(dp);
8010570b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010570e:	89 04 24             	mov    %eax,(%esp)
80105711:	e8 4a c1 ff ff       	call   80101860 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105716:	c7 44 24 04 41 86 10 	movl   $0x80108641,0x4(%esp)
8010571d:	80 
8010571e:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105721:	89 04 24             	mov    %eax,(%esp)
80105724:	e8 2e c9 ff ff       	call   80102057 <namecmp>
80105729:	85 c0                	test   %eax,%eax
8010572b:	0f 84 45 01 00 00    	je     80105876 <sys_unlink+0x1bc>
80105731:	c7 44 24 04 43 86 10 	movl   $0x80108643,0x4(%esp)
80105738:	80 
80105739:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010573c:	89 04 24             	mov    %eax,(%esp)
8010573f:	e8 13 c9 ff ff       	call   80102057 <namecmp>
80105744:	85 c0                	test   %eax,%eax
80105746:	0f 84 2a 01 00 00    	je     80105876 <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
8010574c:	8d 45 c8             	lea    -0x38(%ebp),%eax
8010574f:	89 44 24 08          	mov    %eax,0x8(%esp)
80105753:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105756:	89 44 24 04          	mov    %eax,0x4(%esp)
8010575a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010575d:	89 04 24             	mov    %eax,(%esp)
80105760:	e8 14 c9 ff ff       	call   80102079 <dirlookup>
80105765:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105768:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010576c:	0f 84 03 01 00 00    	je     80105875 <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80105772:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105775:	89 04 24             	mov    %eax,(%esp)
80105778:	e8 e3 c0 ff ff       	call   80101860 <ilock>

  if(ip->nlink < 1)
8010577d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105780:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105784:	66 85 c0             	test   %ax,%ax
80105787:	7f 0c                	jg     80105795 <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80105789:	c7 04 24 46 86 10 80 	movl   $0x80108646,(%esp)
80105790:	e8 a8 ad ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105795:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105798:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010579c:	66 83 f8 01          	cmp    $0x1,%ax
801057a0:	75 1f                	jne    801057c1 <sys_unlink+0x107>
801057a2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057a5:	89 04 24             	mov    %eax,(%esp)
801057a8:	e8 9f fe ff ff       	call   8010564c <isdirempty>
801057ad:	85 c0                	test   %eax,%eax
801057af:	75 10                	jne    801057c1 <sys_unlink+0x107>
    iunlockput(ip);
801057b1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057b4:	89 04 24             	mov    %eax,(%esp)
801057b7:	e8 28 c3 ff ff       	call   80101ae4 <iunlockput>
    goto bad;
801057bc:	e9 b5 00 00 00       	jmp    80105876 <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
801057c1:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801057c8:	00 
801057c9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801057d0:	00 
801057d1:	8d 45 e0             	lea    -0x20(%ebp),%eax
801057d4:	89 04 24             	mov    %eax,(%esp)
801057d7:	e8 82 f5 ff ff       	call   80104d5e <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801057dc:	8b 45 c8             	mov    -0x38(%ebp),%eax
801057df:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801057e6:	00 
801057e7:	89 44 24 08          	mov    %eax,0x8(%esp)
801057eb:	8d 45 e0             	lea    -0x20(%ebp),%eax
801057ee:	89 44 24 04          	mov    %eax,0x4(%esp)
801057f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057f5:	89 04 24             	mov    %eax,(%esp)
801057f8:	e8 c4 c6 ff ff       	call   80101ec1 <writei>
801057fd:	83 f8 10             	cmp    $0x10,%eax
80105800:	74 0c                	je     8010580e <sys_unlink+0x154>
    panic("unlink: writei");
80105802:	c7 04 24 58 86 10 80 	movl   $0x80108658,(%esp)
80105809:	e8 2f ad ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
8010580e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105811:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105815:	66 83 f8 01          	cmp    $0x1,%ax
80105819:	75 1c                	jne    80105837 <sys_unlink+0x17d>
    dp->nlink--;
...
80105828:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
8010582c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010582f:	89 04 24             	mov    %eax,(%esp)
80105832:	e8 6d be ff ff       	call   801016a4 <iupdate>
  }
  iunlockput(dp);
80105837:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010583a:	89 04 24             	mov    %eax,(%esp)
8010583d:	e8 a2 c2 ff ff       	call   80101ae4 <iunlockput>

  ip->nlink--;
80105842:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105845:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105849:	8d 50 ff             	lea    -0x1(%eax),%edx
8010584c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010584f:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105853:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105856:	89 04 24             	mov    %eax,(%esp)
80105859:	e8 46 be ff ff       	call   801016a4 <iupdate>
  iunlockput(ip);
8010585e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105861:	89 04 24             	mov    %eax,(%esp)
80105864:	e8 7b c2 ff ff       	call   80101ae4 <iunlockput>

  commit_trans();
80105869:	e8 f0 d9 ff ff       	call   8010325e <commit_trans>

  return 0;
8010586e:	b8 00 00 00 00       	mov    $0x0,%eax
80105873:	eb 16                	jmp    8010588b <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
8010587c:	e8 63 c2 ff ff       	call   80101ae4 <iunlockput>
  commit_trans();
80105881:	e8 d8 d9 ff ff       	call   8010325e <commit_trans>
  return -1;
...
80105951:	e8 71 bc ff ff       	call   801015c7 <ialloc>
80105956:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105959:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010595d:	75 0c                	jne    8010596b <create+0xde>
    panic("create: ialloc");
8010595f:	c7 04 24 67 86 10 80 	movl   $0x80108667,(%esp)
80105966:	e8 d2 ab ff ff       	call   8010053d <panic>

  ilock(ip);
8010596b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010596e:	89 04 24             	mov    %eax,(%esp)
80105971:	e8 ea be ff ff       	call   80101860 <ilock>
  ip->major = major;
80105976:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105979:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
8010597d:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105981:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105984:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105988:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
8010598c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010598f:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105995:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105998:	89 04 24             	mov    %eax,(%esp)
8010599b:	e8 04 bd ff ff       	call   801016a4 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
801059a0:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
801059a5:	75 6a                	jne    80105a11 <create+0x184>
    dp->nlink++;  // for ".."
...
801059be:	e8 e1 bc ff ff       	call   801016a4 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801059c3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059c6:	8b 40 04             	mov    0x4(%eax),%eax
801059c9:	89 44 24 08          	mov    %eax,0x8(%esp)
801059cd:	c7 44 24 04 41 86 10 	movl   $0x80108641,0x4(%esp)
801059d4:	80 
801059d5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059d8:	89 04 24             	mov    %eax,(%esp)
801059db:	e8 61 c7 ff ff       	call   80102141 <dirlink>
801059e0:	85 c0                	test   %eax,%eax
801059e2:	78 21                	js     80105a05 <create+0x178>
801059e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059e7:	8b 40 04             	mov    0x4(%eax),%eax
801059ea:	89 44 24 08          	mov    %eax,0x8(%esp)
801059ee:	c7 44 24 04 43 86 10 	movl   $0x80108643,0x4(%esp)
801059f5:	80 
...
80105a03:	79 0c                	jns    80105a11 <create+0x184>
      panic("create dots");
80105a05:	c7 04 24 76 86 10 80 	movl   $0x80108676,(%esp)
...
80105a28:	e8 14 c7 ff ff       	call   80102141 <dirlink>
80105a2d:	85 c0                	test   %eax,%eax
80105a2f:	79 0c                	jns    80105a3d <create+0x1b0>
    panic("create: dirlink");
80105a31:	c7 04 24 82 86 10 80 	movl   $0x80108682,(%esp)
80105a38:	e8 00 ab ff ff       	call   8010053d <panic>

  iunlockput(dp);
80105a3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a40:	89 04 24             	mov    %eax,(%esp)
80105a43:	e8 9c c0 ff ff       	call   80101ae4 <iunlockput>
...
80105a50:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105a53:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105a56:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a5a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a61:	e8 e4 f6 ff ff       	call   8010514a <argstr>
80105a66:	85 c0                	test   %eax,%eax
80105a68:	78 17                	js     80105a81 <sys_open+0x34>
80105a6a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105a6d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105a78:	e8 3d f6 ff ff       	call   801050ba <argint>
80105a7d:	85 c0                	test   %eax,%eax
80105a7f:	79 0a                	jns    80105a8b <sys_open+0x3e>
    return -1;
80105a81:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a86:	e9 46 01 00 00       	jmp    80105bd1 <sys_open+0x184>
  if(omode & O_CREATE){
80105a8b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105a8e:	25 00 02 00 00       	and    $0x200,%eax
80105a93:	85 c0                	test   %eax,%eax
80105a95:	74 40                	je     80105ad7 <sys_open+0x8a>
    begin_trans();
80105a97:	e8 79 d7 ff ff       	call   80103215 <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80105a9c:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105a9f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105aa6:	00 
80105aa7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105aae:	00 
80105aaf:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105ab6:	00 
80105ab7:	89 04 24             	mov    %eax,(%esp)
80105aba:	e8 ce fd ff ff       	call   8010588d <create>
80105abf:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80105ac2:	e8 97 d7 ff ff       	call   8010325e <commit_trans>
    if(ip == 0)
80105ac7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105acb:	75 5c                	jne    80105b29 <sys_open+0xdc>
      return -1;
80105acd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ad2:	e9 fa 00 00 00       	jmp    80105bd1 <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
80105ad7:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105ada:	89 04 24             	mov    %eax,(%esp)
80105add:	e8 20 c9 ff ff       	call   80102402 <namei>
80105ae2:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ae5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ae9:	75 0a                	jne    80105af5 <sys_open+0xa8>
      return -1;
80105aeb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105af0:	e9 dc 00 00 00       	jmp    80105bd1 <sys_open+0x184>
    ilock(ip);
80105af5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105af8:	89 04 24             	mov    %eax,(%esp)
80105afb:	e8 60 bd ff ff       	call   80101860 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105b00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b03:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b07:	66 83 f8 01          	cmp    $0x1,%ax
80105b0b:	75 1c                	jne    80105b29 <sys_open+0xdc>
80105b0d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105b10:	85 c0                	test   %eax,%eax
80105b12:	74 15                	je     80105b29 <sys_open+0xdc>
      iunlockput(ip);
80105b14:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b17:	89 04 24             	mov    %eax,(%esp)
80105b1a:	e8 c5 bf ff ff       	call   80101ae4 <iunlockput>
      return -1;
80105b1f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b24:	e9 a8 00 00 00       	jmp    80105bd1 <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105b29:	e8 e6 b3 ff ff       	call   80100f14 <filealloc>
80105b2e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105b31:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b35:	74 14                	je     80105b4b <sys_open+0xfe>
80105b37:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b3a:	89 04 24             	mov    %eax,(%esp)
80105b3d:	e8 43 f7 ff ff       	call   80105285 <fdalloc>
80105b42:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105b45:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105b49:	79 23                	jns    80105b6e <sys_open+0x121>
    if(f)
80105b4b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b4f:	74 0b                	je     80105b5c <sys_open+0x10f>
      fileclose(f);
80105b51:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b54:	89 04 24             	mov    %eax,(%esp)
80105b57:	e8 60 b4 ff ff       	call   80100fbc <fileclose>
    iunlockput(ip);
80105b5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b5f:	89 04 24             	mov    %eax,(%esp)
80105b62:	e8 7d bf ff ff       	call   80101ae4 <iunlockput>
    return -1;
80105b67:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b6c:	eb 63                	jmp    80105bd1 <sys_open+0x184>
  }
  iunlock(ip);
80105b6e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b71:	89 04 24             	mov    %eax,(%esp)
80105b74:	e8 35 be ff ff       	call   801019ae <iunlock>

  f->type = FD_INODE;
80105b79:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b7c:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105b82:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b85:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105b88:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105b8b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b8e:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105b95:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105b98:	83 e0 01             	and    $0x1,%eax
80105b9b:	85 c0                	test   %eax,%eax
80105b9d:	0f 94 c2             	sete   %dl
...
80105bae:	75 0a                	jne    80105bba <sys_open+0x16d>
80105bb0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105bb3:	83 e0 02             	and    $0x2,%eax
80105bb6:	85 c0                	test   %eax,%eax
80105bb8:	74 07                	je     80105bc1 <sys_open+0x174>
80105bba:	b8 01 00 00 00       	mov    $0x1,%eax
80105bbf:	eb 05                	jmp    80105bc6 <sys_open+0x179>
...
80105bd6:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_trans();
80105bd9:	e8 37 d6 ff ff       	call   80103215 <begin_trans>
...
80105bec:	e8 59 f5 ff ff       	call   8010514a <argstr>
80105bf1:	85 c0                	test   %eax,%eax
80105bf3:	78 2c                	js     80105c21 <sys_mkdir+0x4e>
80105bf5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105bf8:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105bff:	00 
80105c00:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105c07:	00 
80105c08:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105c0f:	00 
80105c10:	89 04 24             	mov    %eax,(%esp)
80105c13:	e8 75 fc ff ff       	call   8010588d <create>
80105c18:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c1b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c1f:	75 0c                	jne    80105c2d <sys_mkdir+0x5a>
    commit_trans();
80105c21:	e8 38 d6 ff ff       	call   8010325e <commit_trans>
    return -1;
80105c26:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c2b:	eb 15                	jmp    80105c42 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80105c2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c30:	89 04 24             	mov    %eax,(%esp)
80105c33:	e8 ac be ff ff       	call   80101ae4 <iunlockput>
  commit_trans();
80105c38:	e8 21 d6 ff ff       	call   8010325e <commit_trans>
  return 0;
...
80105c47:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
...
80105c80:	78 47                	js     80105cc9 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105c82:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105c85:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c89:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105c90:	e8 25 f4 ff ff       	call   801050ba <argint>
  int len;
  int major, minor;
...
80105c97:	78 30                	js     80105cc9 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80105c99:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105c9c:	0f bf c8             	movswl %ax,%ecx
80105c9f:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105ca2:	0f bf d0             	movswl %ax,%edx
80105ca5:	8b 45 ec             	mov    -0x14(%ebp),%eax
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105ca8:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80105cac:	89 54 24 08          	mov    %edx,0x8(%esp)
80105cb0:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80105cb7:	00 
80105cb8:	89 04 24             	mov    %eax,(%esp)
80105cbb:	e8 cd fb ff ff       	call   8010588d <create>
80105cc0:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105cc3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105cc7:	75 0c                	jne    80105cd5 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
80105cc9:	e8 90 d5 ff ff       	call   8010325e <commit_trans>
    return -1;
80105cce:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cd3:	eb 15                	jmp    80105cea <sys_mknod+0xa6>
  }
  iunlockput(ip);
80105cd5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cd8:	89 04 24             	mov    %eax,(%esp)
80105cdb:	e8 04 be ff ff       	call   80101ae4 <iunlockput>
  commit_trans();
80105ce0:	e8 79 d5 ff ff       	call   8010325e <commit_trans>
  return 0;
...
80105d80:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80105d94:	e8 b1 f3 ff ff       	call   8010514a <argstr>
80105d99:	85 c0                	test   %eax,%eax
80105d9b:	78 1a                	js     80105db7 <sys_exec+0x3a>
80105d9d:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80105da3:	89 44 24 04          	mov    %eax,0x4(%esp)
80105da7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105dae:	e8 07 f3 ff ff       	call   801050ba <argint>
80105db3:	85 c0                	test   %eax,%eax
80105db5:	79 0a                	jns    80105dc1 <sys_exec+0x44>
    return -1;
80105db7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dbc:	e9 cc 00 00 00       	jmp    80105e8d <sys_exec+0x110>
  }
  memset(argv, 0, sizeof(argv));
80105dc1:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80105dc8:	00 
80105dc9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105dd0:	00 
80105dd1:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80105dd7:	89 04 24             	mov    %eax,(%esp)
80105dda:	e8 7f ef ff ff       	call   80104d5e <memset>
  for(i=0;; i++){
80105ddf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
80105de6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105de9:	83 f8 1f             	cmp    $0x1f,%eax
80105dec:	76 0a                	jbe    80105df8 <sys_exec+0x7b>
      return -1;
80105dee:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105df3:	e9 95 00 00 00       	jmp    80105e8d <sys_exec+0x110>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105df8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dfb:	c1 e0 02             	shl    $0x2,%eax
80105dfe:	89 c2                	mov    %eax,%edx
80105e00:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80105e06:	01 c2                	add    %eax,%edx
80105e08:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80105e0e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e12:	89 14 24             	mov    %edx,(%esp)
80105e15:	e8 02 f2 ff ff       	call   8010501c <fetchint>
80105e1a:	85 c0                	test   %eax,%eax
80105e1c:	79 07                	jns    80105e25 <sys_exec+0xa8>
      return -1;
80105e1e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e23:	eb 68                	jmp    80105e8d <sys_exec+0x110>
    if(uarg == 0){
80105e25:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80105e2b:	85 c0                	test   %eax,%eax
80105e2d:	75 26                	jne    80105e55 <sys_exec+0xd8>
      argv[i] = 0;
80105e2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e32:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80105e39:	00 00 00 00 
      break;
80105e3d:	90                   	nop
    }
...
80105e4e:	e8 a9 ac ff ff       	call   80100afc <exec>
80105e53:	eb 38                	jmp    80105e8d <sys_exec+0x110>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80105e82:	eb 09                	jmp    80105e8d <sys_exec+0x110>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80105e84:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
80105e88:	e9 59 ff ff ff       	jmp    80105de6 <sys_exec+0x69>
  return exec(path, argv);
}
80105e8d:	c9                   	leave  
80105e8e:	c3                   	ret    
...
80105e95:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105e9c:	00 
80105e9d:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105ea0:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ea4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105eab:	e8 38 f2 ff ff       	call   801050e8 <argptr>
80105eb0:	85 c0                	test   %eax,%eax
80105eb2:	79 0a                	jns    80105ebe <sys_pipe+0x2f>
    return -1;
80105eb4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105eb9:	e9 9b 00 00 00       	jmp    80105f59 <sys_pipe+0xca>
...
80105ecb:	e8 50 dd ff ff       	call   80103c20 <pipealloc>
80105ed0:	85 c0                	test   %eax,%eax
80105ed2:	79 07                	jns    80105edb <sys_pipe+0x4c>
    return -1;
80105ed4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ed9:	eb 7e                	jmp    80105f59 <sys_pipe+0xca>
  fd0 = -1;
80105edb:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105ee2:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105ee5:	89 04 24             	mov    %eax,(%esp)
80105ee8:	e8 98 f3 ff ff       	call   80105285 <fdalloc>
80105eed:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ef0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ef4:	78 14                	js     80105f0a <sys_pipe+0x7b>
80105ef6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ef9:	89 04 24             	mov    %eax,(%esp)
80105efc:	e8 84 f3 ff ff       	call   80105285 <fdalloc>
80105f01:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f04:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f08:	79 37                	jns    80105f41 <sys_pipe+0xb2>
    if(fd0 >= 0)
80105f0a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f0e:	78 14                	js     80105f24 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
...
80105f5f:	83 ec 08             	sub    $0x8,%esp
  return fork();
80105f62:	e8 86 e3 ff ff       	call   801042ed <fork>
}
80105f67:	c9                   	leave  
80105f68:	c3                   	ret    
...
80105f6c:	83 ec 08             	sub    $0x8,%esp
  exit();
80105f6f:	e8 dc e4 ff ff       	call   80104450 <exit>
...
80105f7e:	83 ec 08             	sub    $0x8,%esp
  return wait();
80105f81:	e8 e5 e5 ff ff       	call   8010456b <wait>
}
80105f86:	c9                   	leave  
80105f87:	c3                   	ret    
...
80105f95:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f9c:	e8 19 f1 ff ff       	call   801050ba <argint>
80105fa1:	85 c0                	test   %eax,%eax
80105fa3:	79 07                	jns    80105fac <sys_kill+0x24>
    return -1;
80105fa5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105faa:	eb 0b                	jmp    80105fb7 <sys_kill+0x2f>
  return kill(pid);
80105fac:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105faf:	89 04 24             	mov    %eax,(%esp)
80105fb2:	e8 79 e9 ff ff       	call   80104930 <kill>
}
80105fb7:	c9                   	leave  
80105fb8:	c3                   	ret    
...
80105fba:	89 e5                	mov    %esp,%ebp
  return proc->pid;
80105fbc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105fc2:	8b 40 10             	mov    0x10(%eax),%eax
}
80105fc5:	5d                   	pop    %ebp
80105fc6:	c3                   	ret    
...
80105fca:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
80105fcd:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105fd0:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fd4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105fdb:	e8 da f0 ff ff       	call   801050ba <argint>
80105fe0:	85 c0                	test   %eax,%eax
80105fe2:	79 07                	jns    80105feb <sys_sbrk+0x24>
    return -1;
80105fe4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fe9:	eb 24                	jmp    8010600f <sys_sbrk+0x48>
  addr = proc->sz;
...
80105ffc:	e8 47 e2 ff ff       	call   80104248 <growproc>
80106001:	85 c0                	test   %eax,%eax
80106003:	79 07                	jns    8010600c <sys_sbrk+0x45>
    return -1;
80106005:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010600a:	eb 03                	jmp    8010600f <sys_sbrk+0x48>
  return addr;
...
80106025:	e8 90 f0 ff ff       	call   801050ba <argint>
8010602a:	85 c0                	test   %eax,%eax
8010602c:	79 07                	jns    80106035 <sys_sleep+0x24>
    return -1;
8010602e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106033:	eb 6c                	jmp    801060a1 <sys_sleep+0x90>
  acquire(&tickslock);
80106035:	c7 04 24 60 20 11 80 	movl   $0x80112060,(%esp)
8010603c:	e8 ce ea ff ff       	call   80104b0f <acquire>
  ticks0 = ticks;
80106041:	a1 a0 28 11 80       	mov    0x801128a0,%eax
80106046:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106049:	eb 34                	jmp    8010607f <sys_sleep+0x6e>
    if(proc->killed){
8010604b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106051:	8b 40 24             	mov    0x24(%eax),%eax
80106054:	85 c0                	test   %eax,%eax
80106056:	74 13                	je     8010606b <sys_sleep+0x5a>
      release(&tickslock);
80106058:	c7 04 24 60 20 11 80 	movl   $0x80112060,(%esp)
8010605f:	e8 0d eb ff ff       	call   80104b71 <release>
      return -1;
80106064:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106069:	eb 36                	jmp    801060a1 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
8010606b:	c7 44 24 04 60 20 11 	movl   $0x80112060,0x4(%esp)
80106072:	80 
80106073:	c7 04 24 a0 28 11 80 	movl   $0x801128a0,(%esp)
8010607a:	e8 aa e7 ff ff       	call   80104829 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010607f:	a1 a0 28 11 80       	mov    0x801128a0,%eax
80106084:	89 c2                	mov    %eax,%edx
80106086:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106089:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010608c:	39 c2                	cmp    %eax,%edx
8010608e:	72 bb                	jb     8010604b <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106090:	c7 04 24 60 20 11 80 	movl   $0x80112060,(%esp)
80106097:	e8 d5 ea ff ff       	call   80104b71 <release>
  return 0;
...
801060a6:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801060a9:	c7 04 24 60 20 11 80 	movl   $0x80112060,(%esp)
801060b0:	e8 5a ea ff ff       	call   80104b0f <acquire>
  xticks = ticks;
801060b5:	a1 a0 28 11 80       	mov    0x801128a0,%eax
801060ba:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801060bd:	c7 04 24 60 20 11 80 	movl   $0x80112060,(%esp)
801060c4:	e8 a8 ea ff ff       	call   80104b71 <release>
  return xticks;
...
801060d1:	83 ec 28             	sub    $0x28,%esp
  int signum;
  int handle;
...
801060e2:	e8 d3 ef ff ff       	call   801050ba <argint>
801060e7:	85 c0                	test   %eax,%eax
801060e9:	79 07                	jns    801060f2 <sys_signal+0x24>
	  return -1;
801060eb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060f0:	eb 56                	jmp    80106148 <sys_signal+0x7a>
  if(argint(1,&handle) < 0)
801060f2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801060f5:	89 44 24 04          	mov    %eax,0x4(%esp)
801060f9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106100:	e8 b5 ef ff ff       	call   801050ba <argint>
80106105:	85 c0                	test   %eax,%eax
80106107:	79 07                	jns    80106110 <sys_signal+0x42>
	  return -1;
80106109:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010610e:	eb 38                	jmp    80106148 <sys_signal+0x7a>
  if(signum==SIGFPE)
80106110:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106113:	85 c0                	test   %eax,%eax
80106115:	75 0e                	jne    80106125 <sys_signal+0x57>
  	proc->user_signalhandle[0] = handle;
80106117:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010611d:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106120:	89 50 7c             	mov    %edx,0x7c(%eax)
80106123:	eb 20                	jmp    80106145 <sys_signal+0x77>
  else if(signum==SIGSEGV)
80106125:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106128:	83 f8 0e             	cmp    $0xe,%eax
8010612b:	75 11                	jne    8010613e <sys_signal+0x70>
  	proc->user_signalhandle[1] = handle;
8010612d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106133:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106136:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
8010613c:	eb 07                	jmp    80106145 <sys_signal+0x77>
  else
	return -1;
8010613e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106143:	eb 03                	jmp    80106148 <sys_signal+0x7a>
  return handle;
...
80106152:	8b 55 08             	mov    0x8(%ebp),%edx
80106155:	8b 45 0c             	mov    0xc(%ebp),%eax
80106158:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010615c:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010615f:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106163:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106167:	ee                   	out    %al,(%dx)
}
80106168:	c9                   	leave  
80106169:	c3                   	ret    
...
80106170:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106177:	00 
80106178:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
8010617f:	e8 c8 ff ff ff       	call   8010614c <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106184:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
8010618b:	00 
8010618c:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106193:	e8 b4 ff ff ff       	call   8010614c <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106198:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
8010619f:	00 
801061a0:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
801061a7:	e8 a0 ff ff ff       	call   8010614c <outb>
  picenable(IRQ_TIMER);
801061ac:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801061b3:	e8 f1 d8 ff ff       	call   80103aa9 <picenable>
}
801061b8:	c9                   	leave  
801061b9:	c3                   	ret    
	...
...
801061bd:	06                   	push   %es
  pushl %fs
801061be:	0f a0                	push   %fs
  pushl %gs
801061c0:	0f a8                	push   %gs
  pushal
801061c2:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801061c3:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801061c7:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801061c9:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801061cb:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801061cf:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801061d1:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801061d3:	54                   	push   %esp
  call trap
801061d4:	e8 7e 02 00 00       	call   80106457 <trap>
  addl $4, %esp
...
801061eb:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801061ee:	8b 45 0c             	mov    0xc(%ebp),%eax
801061f1:	83 e8 01             	sub    $0x1,%eax
801061f4:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801061f8:	8b 45 08             	mov    0x8(%ebp),%eax
801061fb:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801061ff:	8b 45 08             	mov    0x8(%ebp),%eax
80106202:	c1 e8 10             	shr    $0x10,%eax
80106205:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106209:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010620c:	0f 01 18             	lidtl  (%eax)
}
8010620f:	c9                   	leave  
80106210:	c3                   	ret    
...
80106218:	0f 20 d3             	mov    %cr2,%ebx
8010621b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
8010621e:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
8010622a:	83 ec 28             	sub    $0x28,%esp
  int i;

  for(i = 0; i < 256; i++)
8010622d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106234:	e9 c3 00 00 00       	jmp    801062fc <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106239:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010623c:	8b 04 85 9c b0 10 80 	mov    -0x7fef4f64(,%eax,4),%eax
80106243:	89 c2                	mov    %eax,%edx
80106245:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106248:	66 89 14 c5 a0 20 11 	mov    %dx,-0x7feedf60(,%eax,8)
8010624f:	80 
80106250:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106253:	66 c7 04 c5 a2 20 11 	movw   $0x8,-0x7feedf5e(,%eax,8)
8010625a:	80 08 00 
8010625d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106260:	0f b6 14 c5 a4 20 11 	movzbl -0x7feedf5c(,%eax,8),%edx
80106267:	80 
80106268:	83 e2 e0             	and    $0xffffffe0,%edx
8010626b:	88 14 c5 a4 20 11 80 	mov    %dl,-0x7feedf5c(,%eax,8)
80106272:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106275:	0f b6 14 c5 a4 20 11 	movzbl -0x7feedf5c(,%eax,8),%edx
8010627c:	80 
8010627d:	83 e2 1f             	and    $0x1f,%edx
80106280:	88 14 c5 a4 20 11 80 	mov    %dl,-0x7feedf5c(,%eax,8)
80106287:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010628a:	0f b6 14 c5 a5 20 11 	movzbl -0x7feedf5b(,%eax,8),%edx
80106291:	80 
80106292:	83 e2 f0             	and    $0xfffffff0,%edx
80106295:	83 ca 0e             	or     $0xe,%edx
80106298:	88 14 c5 a5 20 11 80 	mov    %dl,-0x7feedf5b(,%eax,8)
8010629f:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062a2:	0f b6 14 c5 a5 20 11 	movzbl -0x7feedf5b(,%eax,8),%edx
801062a9:	80 
801062aa:	83 e2 ef             	and    $0xffffffef,%edx
801062ad:	88 14 c5 a5 20 11 80 	mov    %dl,-0x7feedf5b(,%eax,8)
801062b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062b7:	0f b6 14 c5 a5 20 11 	movzbl -0x7feedf5b(,%eax,8),%edx
801062be:	80 
801062bf:	83 e2 9f             	and    $0xffffff9f,%edx
801062c2:	88 14 c5 a5 20 11 80 	mov    %dl,-0x7feedf5b(,%eax,8)
801062c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062cc:	0f b6 14 c5 a5 20 11 	movzbl -0x7feedf5b(,%eax,8),%edx
801062d3:	80 
801062d4:	83 ca 80             	or     $0xffffff80,%edx
801062d7:	88 14 c5 a5 20 11 80 	mov    %dl,-0x7feedf5b(,%eax,8)
801062de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062e1:	8b 04 85 9c b0 10 80 	mov    -0x7fef4f64(,%eax,4),%eax
801062e8:	c1 e8 10             	shr    $0x10,%eax
801062eb:	89 c2                	mov    %eax,%edx
801062ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062f0:	66 89 14 c5 a6 20 11 	mov    %dx,-0x7feedf5a(,%eax,8)
801062f7:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
801062f8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801062fc:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106303:	0f 8e 30 ff ff ff    	jle    80106239 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106309:	a1 9c b1 10 80       	mov    0x8010b19c,%eax
8010630e:	66 a3 a0 22 11 80    	mov    %ax,0x801122a0
80106314:	66 c7 05 a2 22 11 80 	movw   $0x8,0x801122a2
8010631b:	08 00 
8010631d:	0f b6 05 a4 22 11 80 	movzbl 0x801122a4,%eax
80106324:	83 e0 e0             	and    $0xffffffe0,%eax
80106327:	a2 a4 22 11 80       	mov    %al,0x801122a4
8010632c:	0f b6 05 a4 22 11 80 	movzbl 0x801122a4,%eax
80106333:	83 e0 1f             	and    $0x1f,%eax
80106336:	a2 a4 22 11 80       	mov    %al,0x801122a4
8010633b:	0f b6 05 a5 22 11 80 	movzbl 0x801122a5,%eax
80106342:	83 c8 0f             	or     $0xf,%eax
80106345:	a2 a5 22 11 80       	mov    %al,0x801122a5
8010634a:	0f b6 05 a5 22 11 80 	movzbl 0x801122a5,%eax
80106351:	83 e0 ef             	and    $0xffffffef,%eax
80106354:	a2 a5 22 11 80       	mov    %al,0x801122a5
80106359:	0f b6 05 a5 22 11 80 	movzbl 0x801122a5,%eax
80106360:	83 c8 60             	or     $0x60,%eax
80106363:	a2 a5 22 11 80       	mov    %al,0x801122a5
80106368:	0f b6 05 a5 22 11 80 	movzbl 0x801122a5,%eax
8010636f:	83 c8 80             	or     $0xffffff80,%eax
80106372:	a2 a5 22 11 80       	mov    %al,0x801122a5
80106377:	a1 9c b1 10 80       	mov    0x8010b19c,%eax
8010637c:	c1 e8 10             	shr    $0x10,%eax
8010637f:	66 a3 a6 22 11 80    	mov    %ax,0x801122a6
  
  initlock(&tickslock, "time");
80106385:	c7 44 24 04 94 86 10 	movl   $0x80108694,0x4(%esp)
8010638c:	80 
8010638d:	c7 04 24 60 20 11 80 	movl   $0x80112060,(%esp)
80106394:	e8 55 e7 ff ff       	call   80104aee <initlock>
}
80106399:	c9                   	leave  
8010639a:	c3                   	ret    
...
8010639e:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801063a1:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801063a8:	00 
801063a9:	c7 04 24 a0 20 11 80 	movl   $0x801120a0,(%esp)
801063b0:	e8 33 fe ff ff       	call   801061e8 <lidt>
}
801063b5:	c9                   	leave  
801063b6:	c3                   	ret    

801063b7 <callUserHandler>:

void callUserHandler(uint sighandler) 
{ 
801063b7:	55                   	push   %ebp
801063b8:	89 e5                	mov    %esp,%ebp
801063ba:	83 ec 28             	sub    $0x28,%esp
...
801063d4:	89 54 24 04          	mov    %edx,0x4(%esp)
801063d8:	89 04 24             	mov    %eax,(%esp)
801063db:	e8 5b 1d 00 00       	call   8010813b <uva2ka>
801063e0:	89 45 f4             	mov    %eax,-0xc(%ebp)
 if ((proc->tf->esp & 0xFFF) == 0) 
801063e3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801063e9:	8b 40 18             	mov    0x18(%eax),%eax
801063ec:	8b 40 44             	mov    0x44(%eax),%eax
801063ef:	25 ff 0f 00 00       	and    $0xfff,%eax
801063f4:	85 c0                	test   %eax,%eax
801063f6:	75 0c                	jne    80106404 <callUserHandler+0x4d>
 panic("esp_offset == 0");  
801063f8:	c7 04 24 99 86 10 80 	movl   $0x80108699,(%esp)
801063ff:	e8 39 a1 ff ff       	call   8010053d <panic>
 *(int*)(addr + ((proc->tf->esp - 4) & 0xFFF)) = proc->tf->eip; 
80106404:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010640a:	8b 40 18             	mov    0x18(%eax),%eax
8010640d:	8b 40 44             	mov    0x44(%eax),%eax
80106410:	83 e8 04             	sub    $0x4,%eax
80106413:	25 ff 0f 00 00       	and    $0xfff,%eax
80106418:	03 45 f4             	add    -0xc(%ebp),%eax
8010641b:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80106422:	8b 52 18             	mov    0x18(%edx),%edx
80106425:	8b 52 38             	mov    0x38(%edx),%edx
80106428:	89 10                	mov    %edx,(%eax)
 proc->tf->esp -= 4;  
8010642a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106430:	8b 40 18             	mov    0x18(%eax),%eax
80106433:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010643a:	8b 52 18             	mov    0x18(%edx),%edx
8010643d:	8b 52 44             	mov    0x44(%edx),%edx
80106440:	83 ea 04             	sub    $0x4,%edx
80106443:	89 50 44             	mov    %edx,0x44(%eax)
...
8010645d:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == SIGFPE)
80106460:	8b 45 08             	mov    0x8(%ebp),%eax
80106463:	8b 40 30             	mov    0x30(%eax),%eax
80106466:	85 c0                	test   %eax,%eax
80106468:	75 24                	jne    8010648e <trap+0x37>
  {
	  if(proc->user_signalhandle[SIGFPE] !=-1)
8010646a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106470:	8b 40 7c             	mov    0x7c(%eax),%eax
80106473:	83 f8 ff             	cmp    $0xffffffff,%eax
80106476:	74 4b                	je     801064c3 <trap+0x6c>
		proc->tf = tf;
		proc->tf->esp = proc->tf->esp -4;
		proc->tf->esp = proc->tf->eip;
                proc->tf->eip = proc->user_signalhandle[T_DIVIDE];
		*/
		callUserHandler(proc->user_signalhandle[SIGFPE]);
80106478:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010647e:	8b 40 7c             	mov    0x7c(%eax),%eax
80106481:	89 04 24             	mov    %eax,(%esp)
80106484:	e8 2e ff ff ff       	call   801063b7 <callUserHandler>
		return;
80106489:	e9 a9 02 00 00       	jmp    80106737 <trap+0x2e0>
	  }
  }
  else if(tf->trapno == SIGSEGV)
8010648e:	8b 45 08             	mov    0x8(%ebp),%eax
80106491:	8b 40 30             	mov    0x30(%eax),%eax
80106494:	83 f8 0e             	cmp    $0xe,%eax
80106497:	75 2a                	jne    801064c3 <trap+0x6c>
  {
	  if(proc->user_signalhandle[SIGSEGV-13] !=-1)
80106499:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010649f:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
801064a5:	83 f8 ff             	cmp    $0xffffffff,%eax
801064a8:	74 19                	je     801064c3 <trap+0x6c>
	  {
		callUserHandler(proc->user_signalhandle[SIGSEGV-13]);
801064aa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801064b0:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
801064b6:	89 04 24             	mov    %eax,(%esp)
801064b9:	e8 f9 fe ff ff       	call   801063b7 <callUserHandler>
		return;
801064be:	e9 74 02 00 00       	jmp    80106737 <trap+0x2e0>
	  }
  }

  if(tf->trapno == T_SYSCALL){
801064c3:	8b 45 08             	mov    0x8(%ebp),%eax
801064c6:	8b 40 30             	mov    0x30(%eax),%eax
801064c9:	83 f8 40             	cmp    $0x40,%eax
801064cc:	75 3e                	jne    8010650c <trap+0xb5>
    if(proc->killed)
801064ce:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801064d4:	8b 40 24             	mov    0x24(%eax),%eax
801064d7:	85 c0                	test   %eax,%eax
801064d9:	74 05                	je     801064e0 <trap+0x89>
      exit();
801064db:	e8 70 df ff ff       	call   80104450 <exit>
    proc->tf = tf;
801064e0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801064e6:	8b 55 08             	mov    0x8(%ebp),%edx
801064e9:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
801064ec:	e8 90 ec ff ff       	call   80105181 <syscall>
    if(proc->killed)
801064f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801064f7:	8b 40 24             	mov    0x24(%eax),%eax
801064fa:	85 c0                	test   %eax,%eax
801064fc:	0f 84 34 02 00 00    	je     80106736 <trap+0x2df>
      exit();
80106502:	e8 49 df ff ff       	call   80104450 <exit>
    return;
80106507:	e9 2a 02 00 00       	jmp    80106736 <trap+0x2df>
  }

  switch(tf->trapno){
8010650c:	8b 45 08             	mov    0x8(%ebp),%eax
8010650f:	8b 40 30             	mov    0x30(%eax),%eax
80106512:	83 e8 20             	sub    $0x20,%eax
80106515:	83 f8 1f             	cmp    $0x1f,%eax
80106518:	0f 87 bc 00 00 00    	ja     801065da <trap+0x183>
8010651e:	8b 04 85 4c 87 10 80 	mov    -0x7fef78b4(,%eax,4),%eax
80106525:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106527:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010652d:	0f b6 00             	movzbl (%eax),%eax
80106530:	84 c0                	test   %al,%al
80106532:	75 31                	jne    80106565 <trap+0x10e>
      acquire(&tickslock);
80106534:	c7 04 24 60 20 11 80 	movl   $0x80112060,(%esp)
8010653b:	e8 cf e5 ff ff       	call   80104b0f <acquire>
      ticks++;
80106540:	a1 a0 28 11 80       	mov    0x801128a0,%eax
80106545:	83 c0 01             	add    $0x1,%eax
80106548:	a3 a0 28 11 80       	mov    %eax,0x801128a0
      wakeup(&ticks);
8010654d:	c7 04 24 a0 28 11 80 	movl   $0x801128a0,(%esp)
80106554:	e8 ac e3 ff ff       	call   80104905 <wakeup>
      release(&tickslock);
80106559:	c7 04 24 60 20 11 80 	movl   $0x80112060,(%esp)
80106560:	e8 0c e6 ff ff       	call   80104b71 <release>
    }
    lapiceoi();
80106565:	e8 77 c9 ff ff       	call   80102ee1 <lapiceoi>
    break;
8010656a:	e9 41 01 00 00       	jmp    801066b0 <trap+0x259>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
8010656f:	e8 75 c1 ff ff       	call   801026e9 <ideintr>
    lapiceoi();
80106574:	e8 68 c9 ff ff       	call   80102ee1 <lapiceoi>
    break;
80106579:	e9 32 01 00 00       	jmp    801066b0 <trap+0x259>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
8010657e:	e8 3c c7 ff ff       	call   80102cbf <kbdintr>
    lapiceoi();
80106583:	e8 59 c9 ff ff       	call   80102ee1 <lapiceoi>
    break;
80106588:	e9 23 01 00 00       	jmp    801066b0 <trap+0x259>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
8010658d:	e8 aa 03 00 00       	call   8010693c <uartintr>
    lapiceoi();
80106592:	e8 4a c9 ff ff       	call   80102ee1 <lapiceoi>
    break;
80106597:	e9 14 01 00 00       	jmp    801066b0 <trap+0x259>
  case T_IRQ0 + 7:
...
8010659c:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010659f:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
801065a2:	8b 45 08             	mov    0x8(%ebp),%eax
801065a5:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801065a9:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
801065ac:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801065b2:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801065b5:	0f b6 c0             	movzbl %al,%eax
801065b8:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801065bc:	89 54 24 08          	mov    %edx,0x8(%esp)
801065c0:	89 44 24 04          	mov    %eax,0x4(%esp)
801065c4:	c7 04 24 ac 86 10 80 	movl   $0x801086ac,(%esp)
801065cb:	e8 d1 9d ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
801065d0:	e8 0c c9 ff ff       	call   80102ee1 <lapiceoi>
    break;
801065d5:	e9 d6 00 00 00       	jmp    801066b0 <trap+0x259>
...
801065e2:	74 11                	je     801065f5 <trap+0x19e>
...
801065f3:	75 46                	jne    8010663b <trap+0x1e4>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801065f5:	e8 17 fc ff ff       	call   80106211 <rcr2>
...
801065fa:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801065fd:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106600:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106607:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010660a:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
8010660d:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106610:	8b 52 30             	mov    0x30(%edx),%edx
80106613:	89 44 24 10          	mov    %eax,0x10(%esp)
80106617:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010661b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010661f:	89 54 24 04          	mov    %edx,0x4(%esp)
80106623:	c7 04 24 d0 86 10 80 	movl   $0x801086d0,(%esp)
8010662a:	e8 72 9d ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
8010662f:	c7 04 24 02 87 10 80 	movl   $0x80108702,(%esp)
80106636:	e8 02 9f ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010663b:	e8 d1 fb ff ff       	call   80106211 <rcr2>
...
80106642:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106645:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106648:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010664e:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106651:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106654:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106657:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
8010665a:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010665d:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106660:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106666:	83 c0 6c             	add    $0x6c,%eax
80106669:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010666c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106672:	8b 40 10             	mov    0x10(%eax),%eax
80106675:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106679:	89 7c 24 18          	mov    %edi,0x18(%esp)
8010667d:	89 74 24 14          	mov    %esi,0x14(%esp)
80106681:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106685:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106689:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010668c:	89 54 24 08          	mov    %edx,0x8(%esp)
80106690:	89 44 24 04          	mov    %eax,0x4(%esp)
80106694:	c7 04 24 08 87 10 80 	movl   $0x80108708,(%esp)
8010669b:	e8 01 9d ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
801066a0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066a6:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801066ad:	eb 01                	jmp    801066b0 <trap+0x259>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801066d7:	75 05                	jne    801066de <trap+0x287>
    exit();
801066d9:	e8 72 dd ff ff       	call   80104450 <exit>
...
801066e6:	74 1e                	je     80106706 <trap+0x2af>
801066e8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066ee:	8b 40 0c             	mov    0xc(%eax),%eax
801066f1:	83 f8 04             	cmp    $0x4,%eax
801066f4:	75 10                	jne    80106706 <trap+0x2af>
801066f6:	8b 45 08             	mov    0x8(%ebp),%eax
801066f9:	8b 40 30             	mov    0x30(%eax),%eax
801066fc:	83 f8 20             	cmp    $0x20,%eax
801066ff:	75 05                	jne    80106706 <trap+0x2af>
    yield();
80106701:	e8 c5 e0 ff ff       	call   801047cb <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106706:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010670c:	85 c0                	test   %eax,%eax
8010670e:	74 27                	je     80106737 <trap+0x2e0>
80106710:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106716:	8b 40 24             	mov    0x24(%eax),%eax
80106719:	85 c0                	test   %eax,%eax
8010671b:	74 1a                	je     80106737 <trap+0x2e0>
8010671d:	8b 45 08             	mov    0x8(%ebp),%eax
80106720:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106724:	0f b7 c0             	movzwl %ax,%eax
80106727:	83 e0 03             	and    $0x3,%eax
8010672a:	83 f8 03             	cmp    $0x3,%eax
8010672d:	75 08                	jne    80106737 <trap+0x2e0>
    exit();
8010672f:	e8 1c dd ff ff       	call   80104450 <exit>
80106734:	eb 01                	jmp    80106737 <trap+0x2e0>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80106737:	83 c4 3c             	add    $0x3c,%esp
8010673a:	5b                   	pop    %ebx
8010673b:	5e                   	pop    %esi
8010673c:	5f                   	pop    %edi
8010673d:	5d                   	pop    %ebp
...
80106744:	83 ec 14             	sub    $0x14,%esp
80106747:	8b 45 08             	mov    0x8(%ebp),%eax
8010674a:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010674e:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80106752:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80106756:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
8010675a:	ec                   	in     (%dx),%al
8010675b:	89 c3                	mov    %eax,%ebx
8010675d:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80106760:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80106764:	83 c4 14             	add    $0x14,%esp
80106767:	5b                   	pop    %ebx
80106768:	5d                   	pop    %ebp
80106769:	c3                   	ret    
...
80106776:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
...
8010678b:	83 ec 28             	sub    $0x28,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
8010678e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106795:	00 
80106796:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010679d:	e8 c8 ff ff ff       	call   8010676a <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801067a2:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801067a9:	00 
801067aa:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801067b1:	e8 b4 ff ff ff       	call   8010676a <outb>
  outb(COM1+0, 115200/9600);
801067b6:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801067bd:	00 
801067be:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801067c5:	e8 a0 ff ff ff       	call   8010676a <outb>
  outb(COM1+1, 0);
801067ca:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801067d1:	00 
801067d2:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801067d9:	e8 8c ff ff ff       	call   8010676a <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801067de:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801067e5:	00 
801067e6:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801067ed:	e8 78 ff ff ff       	call   8010676a <outb>
  outb(COM1+4, 0);
801067f2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801067f9:	00 
801067fa:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106801:	e8 64 ff ff ff       	call   8010676a <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106806:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010680d:	00 
8010680e:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106815:	e8 50 ff ff ff       	call   8010676a <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
8010681a:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106821:	e8 1a ff ff ff       	call   80106740 <inb>
80106826:	3c ff                	cmp    $0xff,%al
80106828:	74 6c                	je     80106896 <uartinit+0x10e>
    return;
  uart = 1;
8010682a:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
80106831:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106834:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010683b:	e8 00 ff ff ff       	call   80106740 <inb>
  inb(COM1+0);
80106840:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106847:	e8 f4 fe ff ff       	call   80106740 <inb>
  picenable(IRQ_COM1);
8010684c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106853:	e8 51 d2 ff ff       	call   80103aa9 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106858:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010685f:	00 
80106860:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106867:	e8 02 c1 ff ff       	call   8010296e <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010686c:	c7 45 f4 cc 87 10 80 	movl   $0x801087cc,-0xc(%ebp)
80106873:	eb 15                	jmp    8010688a <uartinit+0x102>
    uartputc(*p);
80106875:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106878:	0f b6 00             	movzbl (%eax),%eax
8010687b:	0f be c0             	movsbl %al,%eax
8010687e:	89 04 24             	mov    %eax,(%esp)
80106881:	e8 13 00 00 00       	call   80106899 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106886:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010688a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010688d:	0f b6 00             	movzbl (%eax),%eax
80106890:	84 c0                	test   %al,%al
80106892:	75 e1                	jne    80106875 <uartinit+0xed>
80106894:	eb 01                	jmp    80106897 <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
8010689c:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
8010689f:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
801068a4:	85 c0                	test   %eax,%eax
801068a6:	74 4d                	je     801068f5 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801068a8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801068af:	eb 10                	jmp    801068c1 <uartputc+0x28>
    microdelay(10);
801068b1:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801068b8:	e8 49 c6 ff ff       	call   80102f06 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801068bd:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801068c1:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801068c5:	7f 16                	jg     801068dd <uartputc+0x44>
801068c7:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801068ce:	e8 6d fe ff ff       	call   80106740 <inb>
801068d3:	0f b6 c0             	movzbl %al,%eax
801068d6:	83 e0 20             	and    $0x20,%eax
801068d9:	85 c0                	test   %eax,%eax
801068db:	74 d4                	je     801068b1 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
801068dd:	8b 45 08             	mov    0x8(%ebp),%eax
801068e0:	0f b6 c0             	movzbl %al,%eax
801068e3:	89 44 24 04          	mov    %eax,0x4(%esp)
801068e7:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801068ee:	e8 77 fe ff ff       	call   8010676a <outb>
801068f3:	eb 01                	jmp    801068f6 <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
801068fb:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
801068fe:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106903:	85 c0                	test   %eax,%eax
80106905:	75 07                	jne    8010690e <uartgetc+0x16>
    return -1;
80106907:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010690c:	eb 2c                	jmp    8010693a <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
8010690e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106915:	e8 26 fe ff ff       	call   80106740 <inb>
8010691a:	0f b6 c0             	movzbl %al,%eax
8010691d:	83 e0 01             	and    $0x1,%eax
80106920:	85 c0                	test   %eax,%eax
80106922:	75 07                	jne    8010692b <uartgetc+0x33>
    return -1;
80106924:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106929:	eb 0f                	jmp    8010693a <uartgetc+0x42>
  return inb(COM1+0);
8010692b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106932:	e8 09 fe ff ff       	call   80106740 <inb>
80106937:	0f b6 c0             	movzbl %al,%eax
}
8010693a:	c9                   	leave  
8010693b:	c3                   	ret    
...
8010693f:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80106942:	c7 04 24 f8 68 10 80 	movl   $0x801068f8,(%esp)
80106949:	e8 5f 9e ff ff       	call   801007ad <consoleintr>
}
8010694e:	c9                   	leave  
8010694f:	c3                   	ret    
...
80106952:	6a 00                	push   $0x0
  jmp alltraps
80106954:	e9 63 f8 ff ff       	jmp    801061bc <alltraps>
...
8010695b:	6a 01                	push   $0x1
  jmp alltraps
8010695d:	e9 5a f8 ff ff       	jmp    801061bc <alltraps>
...
80106962:	6a 00                	push   $0x0
  pushl $2
80106964:	6a 02                	push   $0x2
  jmp alltraps
80106966:	e9 51 f8 ff ff       	jmp    801061bc <alltraps>
...
8010696b:	6a 00                	push   $0x0
  pushl $3
8010696d:	6a 03                	push   $0x3
  jmp alltraps
8010696f:	e9 48 f8 ff ff       	jmp    801061bc <alltraps>
...
80106976:	6a 04                	push   $0x4
  jmp alltraps
80106978:	e9 3f f8 ff ff       	jmp    801061bc <alltraps>
...
8010697d:	6a 00                	push   $0x0
  pushl $5
8010697f:	6a 05                	push   $0x5
  jmp alltraps
80106981:	e9 36 f8 ff ff       	jmp    801061bc <alltraps>
...
80106988:	6a 06                	push   $0x6
  jmp alltraps
8010698a:	e9 2d f8 ff ff       	jmp    801061bc <alltraps>
...
8010698f:	6a 00                	push   $0x0
  pushl $7
80106991:	6a 07                	push   $0x7
  jmp alltraps
80106993:	e9 24 f8 ff ff       	jmp    801061bc <alltraps>

80106998 <vector8>:
.globl vector8
vector8:
  pushl $8
80106998:	6a 08                	push   $0x8
  jmp alltraps
8010699a:	e9 1d f8 ff ff       	jmp    801061bc <alltraps>
...
8010699f:	6a 00                	push   $0x0
  pushl $9
801069a1:	6a 09                	push   $0x9
  jmp alltraps
801069a3:	e9 14 f8 ff ff       	jmp    801061bc <alltraps>

801069a8 <vector10>:
.globl vector10
vector10:
  pushl $10
801069a8:	6a 0a                	push   $0xa
  jmp alltraps
801069aa:	e9 0d f8 ff ff       	jmp    801061bc <alltraps>

801069af <vector11>:
.globl vector11
vector11:
  pushl $11
801069af:	6a 0b                	push   $0xb
  jmp alltraps
801069b1:	e9 06 f8 ff ff       	jmp    801061bc <alltraps>

801069b6 <vector12>:
.globl vector12
vector12:
  pushl $12
801069b6:	6a 0c                	push   $0xc
  jmp alltraps
801069b8:	e9 ff f7 ff ff       	jmp    801061bc <alltraps>

801069bd <vector13>:
.globl vector13
vector13:
  pushl $13
801069bd:	6a 0d                	push   $0xd
  jmp alltraps
801069bf:	e9 f8 f7 ff ff       	jmp    801061bc <alltraps>

801069c4 <vector14>:
.globl vector14
vector14:
  pushl $14
801069c4:	6a 0e                	push   $0xe
  jmp alltraps
801069c6:	e9 f1 f7 ff ff       	jmp    801061bc <alltraps>
...
801069cb:	6a 00                	push   $0x0
  pushl $15
801069cd:	6a 0f                	push   $0xf
  jmp alltraps
801069cf:	e9 e8 f7 ff ff       	jmp    801061bc <alltraps>
...
801069d4:	6a 00                	push   $0x0
  pushl $16
801069d6:	6a 10                	push   $0x10
  jmp alltraps
801069d8:	e9 df f7 ff ff       	jmp    801061bc <alltraps>

801069dd <vector17>:
.globl vector17
vector17:
  pushl $17
801069dd:	6a 11                	push   $0x11
  jmp alltraps
801069df:	e9 d8 f7 ff ff       	jmp    801061bc <alltraps>
...
801069e4:	6a 00                	push   $0x0
  pushl $18
801069e6:	6a 12                	push   $0x12
  jmp alltraps
801069e8:	e9 cf f7 ff ff       	jmp    801061bc <alltraps>
...
801069ed:	6a 00                	push   $0x0
  pushl $19
801069ef:	6a 13                	push   $0x13
  jmp alltraps
801069f1:	e9 c6 f7 ff ff       	jmp    801061bc <alltraps>
...
801069f6:	6a 00                	push   $0x0
  pushl $20
801069f8:	6a 14                	push   $0x14
  jmp alltraps
801069fa:	e9 bd f7 ff ff       	jmp    801061bc <alltraps>
...
801069ff:	6a 00                	push   $0x0
  pushl $21
80106a01:	6a 15                	push   $0x15
  jmp alltraps
80106a03:	e9 b4 f7 ff ff       	jmp    801061bc <alltraps>
...
80106a08:	6a 00                	push   $0x0
  pushl $22
80106a0a:	6a 16                	push   $0x16
  jmp alltraps
80106a0c:	e9 ab f7 ff ff       	jmp    801061bc <alltraps>
...
80106a11:	6a 00                	push   $0x0
  pushl $23
80106a13:	6a 17                	push   $0x17
  jmp alltraps
80106a15:	e9 a2 f7 ff ff       	jmp    801061bc <alltraps>
...
80106a1a:	6a 00                	push   $0x0
  pushl $24
80106a1c:	6a 18                	push   $0x18
  jmp alltraps
80106a1e:	e9 99 f7 ff ff       	jmp    801061bc <alltraps>
...
80106a23:	6a 00                	push   $0x0
  pushl $25
80106a25:	6a 19                	push   $0x19
  jmp alltraps
80106a27:	e9 90 f7 ff ff       	jmp    801061bc <alltraps>
...
80106a2c:	6a 00                	push   $0x0
  pushl $26
80106a2e:	6a 1a                	push   $0x1a
  jmp alltraps
80106a30:	e9 87 f7 ff ff       	jmp    801061bc <alltraps>
...
80106a35:	6a 00                	push   $0x0
  pushl $27
80106a37:	6a 1b                	push   $0x1b
  jmp alltraps
80106a39:	e9 7e f7 ff ff       	jmp    801061bc <alltraps>
...
80106a3e:	6a 00                	push   $0x0
  pushl $28
80106a40:	6a 1c                	push   $0x1c
  jmp alltraps
80106a42:	e9 75 f7 ff ff       	jmp    801061bc <alltraps>
...
80106a47:	6a 00                	push   $0x0
  pushl $29
80106a49:	6a 1d                	push   $0x1d
  jmp alltraps
80106a4b:	e9 6c f7 ff ff       	jmp    801061bc <alltraps>
...
80106a50:	6a 00                	push   $0x0
  pushl $30
80106a52:	6a 1e                	push   $0x1e
  jmp alltraps
80106a54:	e9 63 f7 ff ff       	jmp    801061bc <alltraps>
...
80106a59:	6a 00                	push   $0x0
  pushl $31
80106a5b:	6a 1f                	push   $0x1f
  jmp alltraps
80106a5d:	e9 5a f7 ff ff       	jmp    801061bc <alltraps>
...
80106a62:	6a 00                	push   $0x0
  pushl $32
80106a64:	6a 20                	push   $0x20
  jmp alltraps
80106a66:	e9 51 f7 ff ff       	jmp    801061bc <alltraps>
...
80106a6b:	6a 00                	push   $0x0
  pushl $33
80106a6d:	6a 21                	push   $0x21
  jmp alltraps
80106a6f:	e9 48 f7 ff ff       	jmp    801061bc <alltraps>
...
80106a74:	6a 00                	push   $0x0
  pushl $34
80106a76:	6a 22                	push   $0x22
  jmp alltraps
80106a78:	e9 3f f7 ff ff       	jmp    801061bc <alltraps>
...
80106a7d:	6a 00                	push   $0x0
  pushl $35
80106a7f:	6a 23                	push   $0x23
  jmp alltraps
80106a81:	e9 36 f7 ff ff       	jmp    801061bc <alltraps>
...
80106a86:	6a 00                	push   $0x0
  pushl $36
80106a88:	6a 24                	push   $0x24
  jmp alltraps
80106a8a:	e9 2d f7 ff ff       	jmp    801061bc <alltraps>
...
80106a8f:	6a 00                	push   $0x0
  pushl $37
80106a91:	6a 25                	push   $0x25
  jmp alltraps
80106a93:	e9 24 f7 ff ff       	jmp    801061bc <alltraps>
...
80106a98:	6a 00                	push   $0x0
  pushl $38
80106a9a:	6a 26                	push   $0x26
  jmp alltraps
80106a9c:	e9 1b f7 ff ff       	jmp    801061bc <alltraps>
...
80106aa1:	6a 00                	push   $0x0
  pushl $39
80106aa3:	6a 27                	push   $0x27
  jmp alltraps
80106aa5:	e9 12 f7 ff ff       	jmp    801061bc <alltraps>
...
80106aaa:	6a 00                	push   $0x0
  pushl $40
80106aac:	6a 28                	push   $0x28
  jmp alltraps
80106aae:	e9 09 f7 ff ff       	jmp    801061bc <alltraps>
...
80106ab3:	6a 00                	push   $0x0
  pushl $41
80106ab5:	6a 29                	push   $0x29
  jmp alltraps
80106ab7:	e9 00 f7 ff ff       	jmp    801061bc <alltraps>
...
80106abc:	6a 00                	push   $0x0
  pushl $42
80106abe:	6a 2a                	push   $0x2a
  jmp alltraps
80106ac0:	e9 f7 f6 ff ff       	jmp    801061bc <alltraps>
...
80106ac5:	6a 00                	push   $0x0
  pushl $43
80106ac7:	6a 2b                	push   $0x2b
  jmp alltraps
80106ac9:	e9 ee f6 ff ff       	jmp    801061bc <alltraps>
...
80106ace:	6a 00                	push   $0x0
  pushl $44
80106ad0:	6a 2c                	push   $0x2c
  jmp alltraps
80106ad2:	e9 e5 f6 ff ff       	jmp    801061bc <alltraps>
...
80106ad7:	6a 00                	push   $0x0
  pushl $45
80106ad9:	6a 2d                	push   $0x2d
  jmp alltraps
80106adb:	e9 dc f6 ff ff       	jmp    801061bc <alltraps>
...
80106ae0:	6a 00                	push   $0x0
  pushl $46
80106ae2:	6a 2e                	push   $0x2e
  jmp alltraps
80106ae4:	e9 d3 f6 ff ff       	jmp    801061bc <alltraps>
...
80106ae9:	6a 00                	push   $0x0
  pushl $47
80106aeb:	6a 2f                	push   $0x2f
  jmp alltraps
80106aed:	e9 ca f6 ff ff       	jmp    801061bc <alltraps>
...
80106af2:	6a 00                	push   $0x0
  pushl $48
80106af4:	6a 30                	push   $0x30
  jmp alltraps
80106af6:	e9 c1 f6 ff ff       	jmp    801061bc <alltraps>
...
80106afb:	6a 00                	push   $0x0
  pushl $49
80106afd:	6a 31                	push   $0x31
  jmp alltraps
80106aff:	e9 b8 f6 ff ff       	jmp    801061bc <alltraps>
...
80106b04:	6a 00                	push   $0x0
  pushl $50
80106b06:	6a 32                	push   $0x32
  jmp alltraps
80106b08:	e9 af f6 ff ff       	jmp    801061bc <alltraps>
...
80106b0d:	6a 00                	push   $0x0
  pushl $51
80106b0f:	6a 33                	push   $0x33
  jmp alltraps
80106b11:	e9 a6 f6 ff ff       	jmp    801061bc <alltraps>
...
80106b16:	6a 00                	push   $0x0
  pushl $52
80106b18:	6a 34                	push   $0x34
  jmp alltraps
80106b1a:	e9 9d f6 ff ff       	jmp    801061bc <alltraps>
...
80106b1f:	6a 00                	push   $0x0
  pushl $53
80106b21:	6a 35                	push   $0x35
  jmp alltraps
80106b23:	e9 94 f6 ff ff       	jmp    801061bc <alltraps>
...
80106b28:	6a 00                	push   $0x0
  pushl $54
80106b2a:	6a 36                	push   $0x36
  jmp alltraps
80106b2c:	e9 8b f6 ff ff       	jmp    801061bc <alltraps>
...
80106b31:	6a 00                	push   $0x0
  pushl $55
80106b33:	6a 37                	push   $0x37
  jmp alltraps
80106b35:	e9 82 f6 ff ff       	jmp    801061bc <alltraps>
...
80106b3a:	6a 00                	push   $0x0
  pushl $56
80106b3c:	6a 38                	push   $0x38
  jmp alltraps
80106b3e:	e9 79 f6 ff ff       	jmp    801061bc <alltraps>
...
80106b43:	6a 00                	push   $0x0
  pushl $57
80106b45:	6a 39                	push   $0x39
  jmp alltraps
80106b47:	e9 70 f6 ff ff       	jmp    801061bc <alltraps>
...
80106b4c:	6a 00                	push   $0x0
  pushl $58
80106b4e:	6a 3a                	push   $0x3a
  jmp alltraps
80106b50:	e9 67 f6 ff ff       	jmp    801061bc <alltraps>
...
80106b55:	6a 00                	push   $0x0
  pushl $59
80106b57:	6a 3b                	push   $0x3b
  jmp alltraps
80106b59:	e9 5e f6 ff ff       	jmp    801061bc <alltraps>
...
80106b5e:	6a 00                	push   $0x0
  pushl $60
80106b60:	6a 3c                	push   $0x3c
  jmp alltraps
80106b62:	e9 55 f6 ff ff       	jmp    801061bc <alltraps>
...
80106b67:	6a 00                	push   $0x0
  pushl $61
80106b69:	6a 3d                	push   $0x3d
  jmp alltraps
80106b6b:	e9 4c f6 ff ff       	jmp    801061bc <alltraps>
...
80106b70:	6a 00                	push   $0x0
  pushl $62
80106b72:	6a 3e                	push   $0x3e
  jmp alltraps
80106b74:	e9 43 f6 ff ff       	jmp    801061bc <alltraps>
...
80106b79:	6a 00                	push   $0x0
  pushl $63
80106b7b:	6a 3f                	push   $0x3f
  jmp alltraps
80106b7d:	e9 3a f6 ff ff       	jmp    801061bc <alltraps>
...
80106b82:	6a 00                	push   $0x0
  pushl $64
80106b84:	6a 40                	push   $0x40
  jmp alltraps
80106b86:	e9 31 f6 ff ff       	jmp    801061bc <alltraps>
...
80106b8b:	6a 00                	push   $0x0
  pushl $65
80106b8d:	6a 41                	push   $0x41
  jmp alltraps
80106b8f:	e9 28 f6 ff ff       	jmp    801061bc <alltraps>
...
80106b94:	6a 00                	push   $0x0
  pushl $66
80106b96:	6a 42                	push   $0x42
  jmp alltraps
80106b98:	e9 1f f6 ff ff       	jmp    801061bc <alltraps>
...
80106b9d:	6a 00                	push   $0x0
  pushl $67
80106b9f:	6a 43                	push   $0x43
  jmp alltraps
80106ba1:	e9 16 f6 ff ff       	jmp    801061bc <alltraps>
...
80106ba6:	6a 00                	push   $0x0
  pushl $68
80106ba8:	6a 44                	push   $0x44
  jmp alltraps
80106baa:	e9 0d f6 ff ff       	jmp    801061bc <alltraps>
...
80106baf:	6a 00                	push   $0x0
  pushl $69
80106bb1:	6a 45                	push   $0x45
  jmp alltraps
80106bb3:	e9 04 f6 ff ff       	jmp    801061bc <alltraps>
...
80106bb8:	6a 00                	push   $0x0
  pushl $70
80106bba:	6a 46                	push   $0x46
  jmp alltraps
80106bbc:	e9 fb f5 ff ff       	jmp    801061bc <alltraps>
...
80106bc1:	6a 00                	push   $0x0
  pushl $71
80106bc3:	6a 47                	push   $0x47
  jmp alltraps
80106bc5:	e9 f2 f5 ff ff       	jmp    801061bc <alltraps>
...
80106bca:	6a 00                	push   $0x0
  pushl $72
80106bcc:	6a 48                	push   $0x48
  jmp alltraps
80106bce:	e9 e9 f5 ff ff       	jmp    801061bc <alltraps>
...
80106bd3:	6a 00                	push   $0x0
  pushl $73
80106bd5:	6a 49                	push   $0x49
  jmp alltraps
80106bd7:	e9 e0 f5 ff ff       	jmp    801061bc <alltraps>
...
80106bdc:	6a 00                	push   $0x0
  pushl $74
80106bde:	6a 4a                	push   $0x4a
  jmp alltraps
80106be0:	e9 d7 f5 ff ff       	jmp    801061bc <alltraps>
...
80106be5:	6a 00                	push   $0x0
  pushl $75
80106be7:	6a 4b                	push   $0x4b
  jmp alltraps
80106be9:	e9 ce f5 ff ff       	jmp    801061bc <alltraps>
...
80106bee:	6a 00                	push   $0x0
  pushl $76
80106bf0:	6a 4c                	push   $0x4c
  jmp alltraps
80106bf2:	e9 c5 f5 ff ff       	jmp    801061bc <alltraps>
...
80106bf7:	6a 00                	push   $0x0
  pushl $77
80106bf9:	6a 4d                	push   $0x4d
  jmp alltraps
80106bfb:	e9 bc f5 ff ff       	jmp    801061bc <alltraps>
...
80106c00:	6a 00                	push   $0x0
  pushl $78
80106c02:	6a 4e                	push   $0x4e
  jmp alltraps
80106c04:	e9 b3 f5 ff ff       	jmp    801061bc <alltraps>
...
80106c09:	6a 00                	push   $0x0
  pushl $79
80106c0b:	6a 4f                	push   $0x4f
  jmp alltraps
80106c0d:	e9 aa f5 ff ff       	jmp    801061bc <alltraps>
...
80106c12:	6a 00                	push   $0x0
  pushl $80
80106c14:	6a 50                	push   $0x50
  jmp alltraps
80106c16:	e9 a1 f5 ff ff       	jmp    801061bc <alltraps>
...
80106c1b:	6a 00                	push   $0x0
  pushl $81
80106c1d:	6a 51                	push   $0x51
  jmp alltraps
80106c1f:	e9 98 f5 ff ff       	jmp    801061bc <alltraps>
...
80106c24:	6a 00                	push   $0x0
  pushl $82
80106c26:	6a 52                	push   $0x52
  jmp alltraps
80106c28:	e9 8f f5 ff ff       	jmp    801061bc <alltraps>
...
80106c2d:	6a 00                	push   $0x0
  pushl $83
80106c2f:	6a 53                	push   $0x53
  jmp alltraps
80106c31:	e9 86 f5 ff ff       	jmp    801061bc <alltraps>
...
80106c36:	6a 00                	push   $0x0
  pushl $84
80106c38:	6a 54                	push   $0x54
  jmp alltraps
80106c3a:	e9 7d f5 ff ff       	jmp    801061bc <alltraps>
...
80106c3f:	6a 00                	push   $0x0
  pushl $85
80106c41:	6a 55                	push   $0x55
  jmp alltraps
80106c43:	e9 74 f5 ff ff       	jmp    801061bc <alltraps>
...
80106c48:	6a 00                	push   $0x0
  pushl $86
80106c4a:	6a 56                	push   $0x56
  jmp alltraps
80106c4c:	e9 6b f5 ff ff       	jmp    801061bc <alltraps>
...
80106c51:	6a 00                	push   $0x0
  pushl $87
80106c53:	6a 57                	push   $0x57
  jmp alltraps
80106c55:	e9 62 f5 ff ff       	jmp    801061bc <alltraps>
...
80106c5a:	6a 00                	push   $0x0
  pushl $88
80106c5c:	6a 58                	push   $0x58
  jmp alltraps
80106c5e:	e9 59 f5 ff ff       	jmp    801061bc <alltraps>
...
80106c63:	6a 00                	push   $0x0
  pushl $89
80106c65:	6a 59                	push   $0x59
  jmp alltraps
80106c67:	e9 50 f5 ff ff       	jmp    801061bc <alltraps>
...
80106c6c:	6a 00                	push   $0x0
  pushl $90
80106c6e:	6a 5a                	push   $0x5a
  jmp alltraps
80106c70:	e9 47 f5 ff ff       	jmp    801061bc <alltraps>
...
80106c75:	6a 00                	push   $0x0
  pushl $91
80106c77:	6a 5b                	push   $0x5b
  jmp alltraps
80106c79:	e9 3e f5 ff ff       	jmp    801061bc <alltraps>
...
80106c7e:	6a 00                	push   $0x0
  pushl $92
80106c80:	6a 5c                	push   $0x5c
  jmp alltraps
80106c82:	e9 35 f5 ff ff       	jmp    801061bc <alltraps>
...
80106c87:	6a 00                	push   $0x0
  pushl $93
80106c89:	6a 5d                	push   $0x5d
  jmp alltraps
80106c8b:	e9 2c f5 ff ff       	jmp    801061bc <alltraps>
...
80106c90:	6a 00                	push   $0x0
  pushl $94
80106c92:	6a 5e                	push   $0x5e
  jmp alltraps
80106c94:	e9 23 f5 ff ff       	jmp    801061bc <alltraps>
...
80106c99:	6a 00                	push   $0x0
  pushl $95
80106c9b:	6a 5f                	push   $0x5f
  jmp alltraps
80106c9d:	e9 1a f5 ff ff       	jmp    801061bc <alltraps>
...
80106ca2:	6a 00                	push   $0x0
  pushl $96
80106ca4:	6a 60                	push   $0x60
  jmp alltraps
80106ca6:	e9 11 f5 ff ff       	jmp    801061bc <alltraps>
...
80106cab:	6a 00                	push   $0x0
  pushl $97
80106cad:	6a 61                	push   $0x61
  jmp alltraps
80106caf:	e9 08 f5 ff ff       	jmp    801061bc <alltraps>
...
80106cb4:	6a 00                	push   $0x0
  pushl $98
80106cb6:	6a 62                	push   $0x62
  jmp alltraps
80106cb8:	e9 ff f4 ff ff       	jmp    801061bc <alltraps>
...
80106cbd:	6a 00                	push   $0x0
  pushl $99
80106cbf:	6a 63                	push   $0x63
  jmp alltraps
80106cc1:	e9 f6 f4 ff ff       	jmp    801061bc <alltraps>
...
80106cc6:	6a 00                	push   $0x0
  pushl $100
80106cc8:	6a 64                	push   $0x64
  jmp alltraps
80106cca:	e9 ed f4 ff ff       	jmp    801061bc <alltraps>
...
80106ccf:	6a 00                	push   $0x0
  pushl $101
80106cd1:	6a 65                	push   $0x65
  jmp alltraps
80106cd3:	e9 e4 f4 ff ff       	jmp    801061bc <alltraps>
...
80106cd8:	6a 00                	push   $0x0
  pushl $102
80106cda:	6a 66                	push   $0x66
  jmp alltraps
80106cdc:	e9 db f4 ff ff       	jmp    801061bc <alltraps>
...
80106ce1:	6a 00                	push   $0x0
  pushl $103
80106ce3:	6a 67                	push   $0x67
  jmp alltraps
80106ce5:	e9 d2 f4 ff ff       	jmp    801061bc <alltraps>
...
80106cea:	6a 00                	push   $0x0
  pushl $104
80106cec:	6a 68                	push   $0x68
  jmp alltraps
80106cee:	e9 c9 f4 ff ff       	jmp    801061bc <alltraps>
...
80106cf3:	6a 00                	push   $0x0
  pushl $105
80106cf5:	6a 69                	push   $0x69
  jmp alltraps
80106cf7:	e9 c0 f4 ff ff       	jmp    801061bc <alltraps>
...
80106cfc:	6a 00                	push   $0x0
  pushl $106
80106cfe:	6a 6a                	push   $0x6a
  jmp alltraps
80106d00:	e9 b7 f4 ff ff       	jmp    801061bc <alltraps>
...
80106d05:	6a 00                	push   $0x0
  pushl $107
80106d07:	6a 6b                	push   $0x6b
  jmp alltraps
80106d09:	e9 ae f4 ff ff       	jmp    801061bc <alltraps>
...
80106d0e:	6a 00                	push   $0x0
  pushl $108
80106d10:	6a 6c                	push   $0x6c
  jmp alltraps
80106d12:	e9 a5 f4 ff ff       	jmp    801061bc <alltraps>
...
80106d17:	6a 00                	push   $0x0
  pushl $109
80106d19:	6a 6d                	push   $0x6d
  jmp alltraps
80106d1b:	e9 9c f4 ff ff       	jmp    801061bc <alltraps>
...
80106d20:	6a 00                	push   $0x0
  pushl $110
80106d22:	6a 6e                	push   $0x6e
  jmp alltraps
80106d24:	e9 93 f4 ff ff       	jmp    801061bc <alltraps>
...
80106d29:	6a 00                	push   $0x0
  pushl $111
80106d2b:	6a 6f                	push   $0x6f
  jmp alltraps
80106d2d:	e9 8a f4 ff ff       	jmp    801061bc <alltraps>
...
80106d32:	6a 00                	push   $0x0
  pushl $112
80106d34:	6a 70                	push   $0x70
  jmp alltraps
80106d36:	e9 81 f4 ff ff       	jmp    801061bc <alltraps>
...
80106d3b:	6a 00                	push   $0x0
  pushl $113
80106d3d:	6a 71                	push   $0x71
  jmp alltraps
80106d3f:	e9 78 f4 ff ff       	jmp    801061bc <alltraps>
...
80106d44:	6a 00                	push   $0x0
  pushl $114
80106d46:	6a 72                	push   $0x72
  jmp alltraps
80106d48:	e9 6f f4 ff ff       	jmp    801061bc <alltraps>
...
80106d4d:	6a 00                	push   $0x0
  pushl $115
80106d4f:	6a 73                	push   $0x73
  jmp alltraps
80106d51:	e9 66 f4 ff ff       	jmp    801061bc <alltraps>
...
80106d56:	6a 00                	push   $0x0
  pushl $116
80106d58:	6a 74                	push   $0x74
  jmp alltraps
80106d5a:	e9 5d f4 ff ff       	jmp    801061bc <alltraps>
...
80106d5f:	6a 00                	push   $0x0
  pushl $117
80106d61:	6a 75                	push   $0x75
  jmp alltraps
80106d63:	e9 54 f4 ff ff       	jmp    801061bc <alltraps>
...
80106d68:	6a 00                	push   $0x0
  pushl $118
80106d6a:	6a 76                	push   $0x76
  jmp alltraps
80106d6c:	e9 4b f4 ff ff       	jmp    801061bc <alltraps>
...
80106d71:	6a 00                	push   $0x0
  pushl $119
80106d73:	6a 77                	push   $0x77
  jmp alltraps
80106d75:	e9 42 f4 ff ff       	jmp    801061bc <alltraps>
...
80106d7a:	6a 00                	push   $0x0
  pushl $120
80106d7c:	6a 78                	push   $0x78
  jmp alltraps
80106d7e:	e9 39 f4 ff ff       	jmp    801061bc <alltraps>
...
80106d83:	6a 00                	push   $0x0
  pushl $121
80106d85:	6a 79                	push   $0x79
  jmp alltraps
80106d87:	e9 30 f4 ff ff       	jmp    801061bc <alltraps>
...
80106d8c:	6a 00                	push   $0x0
  pushl $122
80106d8e:	6a 7a                	push   $0x7a
  jmp alltraps
80106d90:	e9 27 f4 ff ff       	jmp    801061bc <alltraps>
...
80106d95:	6a 00                	push   $0x0
  pushl $123
80106d97:	6a 7b                	push   $0x7b
  jmp alltraps
80106d99:	e9 1e f4 ff ff       	jmp    801061bc <alltraps>
...
80106d9e:	6a 00                	push   $0x0
  pushl $124
80106da0:	6a 7c                	push   $0x7c
  jmp alltraps
80106da2:	e9 15 f4 ff ff       	jmp    801061bc <alltraps>
...
80106da7:	6a 00                	push   $0x0
  pushl $125
80106da9:	6a 7d                	push   $0x7d
  jmp alltraps
80106dab:	e9 0c f4 ff ff       	jmp    801061bc <alltraps>
...
80106db0:	6a 00                	push   $0x0
  pushl $126
80106db2:	6a 7e                	push   $0x7e
  jmp alltraps
80106db4:	e9 03 f4 ff ff       	jmp    801061bc <alltraps>
...
80106db9:	6a 00                	push   $0x0
  pushl $127
80106dbb:	6a 7f                	push   $0x7f
  jmp alltraps
80106dbd:	e9 fa f3 ff ff       	jmp    801061bc <alltraps>
...
80106dc2:	6a 00                	push   $0x0
  pushl $128
80106dc4:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106dc9:	e9 ee f3 ff ff       	jmp    801061bc <alltraps>
...
80106dce:	6a 00                	push   $0x0
  pushl $129
80106dd0:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106dd5:	e9 e2 f3 ff ff       	jmp    801061bc <alltraps>
...
80106dda:	6a 00                	push   $0x0
  pushl $130
80106ddc:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106de1:	e9 d6 f3 ff ff       	jmp    801061bc <alltraps>
...
80106de6:	6a 00                	push   $0x0
  pushl $131
80106de8:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106ded:	e9 ca f3 ff ff       	jmp    801061bc <alltraps>
...
80106df2:	6a 00                	push   $0x0
  pushl $132
80106df4:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106df9:	e9 be f3 ff ff       	jmp    801061bc <alltraps>
...
80106dfe:	6a 00                	push   $0x0
  pushl $133
80106e00:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106e05:	e9 b2 f3 ff ff       	jmp    801061bc <alltraps>
...
80106e0a:	6a 00                	push   $0x0
  pushl $134
80106e0c:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106e11:	e9 a6 f3 ff ff       	jmp    801061bc <alltraps>
...
80106e16:	6a 00                	push   $0x0
  pushl $135
80106e18:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106e1d:	e9 9a f3 ff ff       	jmp    801061bc <alltraps>
...
80106e22:	6a 00                	push   $0x0
  pushl $136
80106e24:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106e29:	e9 8e f3 ff ff       	jmp    801061bc <alltraps>
...
80106e2e:	6a 00                	push   $0x0
  pushl $137
80106e30:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106e35:	e9 82 f3 ff ff       	jmp    801061bc <alltraps>
...
80106e3a:	6a 00                	push   $0x0
  pushl $138
80106e3c:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106e41:	e9 76 f3 ff ff       	jmp    801061bc <alltraps>
...
80106e46:	6a 00                	push   $0x0
  pushl $139
80106e48:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106e4d:	e9 6a f3 ff ff       	jmp    801061bc <alltraps>
...
80106e52:	6a 00                	push   $0x0
  pushl $140
80106e54:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106e59:	e9 5e f3 ff ff       	jmp    801061bc <alltraps>
...
80106e5e:	6a 00                	push   $0x0
  pushl $141
80106e60:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106e65:	e9 52 f3 ff ff       	jmp    801061bc <alltraps>
...
80106e6a:	6a 00                	push   $0x0
  pushl $142
80106e6c:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106e71:	e9 46 f3 ff ff       	jmp    801061bc <alltraps>
...
80106e76:	6a 00                	push   $0x0
  pushl $143
80106e78:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106e7d:	e9 3a f3 ff ff       	jmp    801061bc <alltraps>
...
80106e82:	6a 00                	push   $0x0
  pushl $144
80106e84:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106e89:	e9 2e f3 ff ff       	jmp    801061bc <alltraps>
...
80106e8e:	6a 00                	push   $0x0
  pushl $145
80106e90:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106e95:	e9 22 f3 ff ff       	jmp    801061bc <alltraps>
...
80106e9a:	6a 00                	push   $0x0
  pushl $146
80106e9c:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106ea1:	e9 16 f3 ff ff       	jmp    801061bc <alltraps>
...
80106ea6:	6a 00                	push   $0x0
  pushl $147
80106ea8:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106ead:	e9 0a f3 ff ff       	jmp    801061bc <alltraps>
...
80106eb2:	6a 00                	push   $0x0
  pushl $148
80106eb4:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106eb9:	e9 fe f2 ff ff       	jmp    801061bc <alltraps>
...
80106ebe:	6a 00                	push   $0x0
  pushl $149
80106ec0:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106ec5:	e9 f2 f2 ff ff       	jmp    801061bc <alltraps>
...
80106eca:	6a 00                	push   $0x0
  pushl $150
80106ecc:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106ed1:	e9 e6 f2 ff ff       	jmp    801061bc <alltraps>
...
80106ed6:	6a 00                	push   $0x0
  pushl $151
80106ed8:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106edd:	e9 da f2 ff ff       	jmp    801061bc <alltraps>
...
80106ee2:	6a 00                	push   $0x0
  pushl $152
80106ee4:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106ee9:	e9 ce f2 ff ff       	jmp    801061bc <alltraps>
...
80106eee:	6a 00                	push   $0x0
  pushl $153
80106ef0:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106ef5:	e9 c2 f2 ff ff       	jmp    801061bc <alltraps>
...
80106efa:	6a 00                	push   $0x0
  pushl $154
80106efc:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106f01:	e9 b6 f2 ff ff       	jmp    801061bc <alltraps>
...
80106f06:	6a 00                	push   $0x0
  pushl $155
80106f08:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106f0d:	e9 aa f2 ff ff       	jmp    801061bc <alltraps>
...
80106f12:	6a 00                	push   $0x0
  pushl $156
80106f14:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106f19:	e9 9e f2 ff ff       	jmp    801061bc <alltraps>
...
80106f1e:	6a 00                	push   $0x0
  pushl $157
80106f20:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106f25:	e9 92 f2 ff ff       	jmp    801061bc <alltraps>
...
80106f2a:	6a 00                	push   $0x0
  pushl $158
80106f2c:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106f31:	e9 86 f2 ff ff       	jmp    801061bc <alltraps>
...
80106f36:	6a 00                	push   $0x0
  pushl $159
80106f38:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106f3d:	e9 7a f2 ff ff       	jmp    801061bc <alltraps>
...
80106f42:	6a 00                	push   $0x0
  pushl $160
80106f44:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106f49:	e9 6e f2 ff ff       	jmp    801061bc <alltraps>
...
80106f4e:	6a 00                	push   $0x0
  pushl $161
80106f50:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106f55:	e9 62 f2 ff ff       	jmp    801061bc <alltraps>
...
80106f5a:	6a 00                	push   $0x0
  pushl $162
80106f5c:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106f61:	e9 56 f2 ff ff       	jmp    801061bc <alltraps>
...
80106f66:	6a 00                	push   $0x0
  pushl $163
80106f68:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106f6d:	e9 4a f2 ff ff       	jmp    801061bc <alltraps>
...
80106f72:	6a 00                	push   $0x0
  pushl $164
80106f74:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106f79:	e9 3e f2 ff ff       	jmp    801061bc <alltraps>
...
80106f7e:	6a 00                	push   $0x0
  pushl $165
80106f80:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106f85:	e9 32 f2 ff ff       	jmp    801061bc <alltraps>
...
80106f8a:	6a 00                	push   $0x0
  pushl $166
80106f8c:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106f91:	e9 26 f2 ff ff       	jmp    801061bc <alltraps>
...
80106f96:	6a 00                	push   $0x0
  pushl $167
80106f98:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106f9d:	e9 1a f2 ff ff       	jmp    801061bc <alltraps>
...
80106fa2:	6a 00                	push   $0x0
  pushl $168
80106fa4:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106fa9:	e9 0e f2 ff ff       	jmp    801061bc <alltraps>
...
80106fae:	6a 00                	push   $0x0
  pushl $169
80106fb0:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106fb5:	e9 02 f2 ff ff       	jmp    801061bc <alltraps>
...
80106fba:	6a 00                	push   $0x0
  pushl $170
80106fbc:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106fc1:	e9 f6 f1 ff ff       	jmp    801061bc <alltraps>
...
80106fc6:	6a 00                	push   $0x0
  pushl $171
80106fc8:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106fcd:	e9 ea f1 ff ff       	jmp    801061bc <alltraps>
...
80106fd2:	6a 00                	push   $0x0
  pushl $172
80106fd4:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106fd9:	e9 de f1 ff ff       	jmp    801061bc <alltraps>
...
80106fde:	6a 00                	push   $0x0
  pushl $173
80106fe0:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106fe5:	e9 d2 f1 ff ff       	jmp    801061bc <alltraps>
...
80106fea:	6a 00                	push   $0x0
  pushl $174
80106fec:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106ff1:	e9 c6 f1 ff ff       	jmp    801061bc <alltraps>
...
80106ff6:	6a 00                	push   $0x0
  pushl $175
80106ff8:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106ffd:	e9 ba f1 ff ff       	jmp    801061bc <alltraps>
...
80107002:	6a 00                	push   $0x0
  pushl $176
80107004:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107009:	e9 ae f1 ff ff       	jmp    801061bc <alltraps>
...
8010700e:	6a 00                	push   $0x0
  pushl $177
80107010:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107015:	e9 a2 f1 ff ff       	jmp    801061bc <alltraps>
...
8010701a:	6a 00                	push   $0x0
  pushl $178
8010701c:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107021:	e9 96 f1 ff ff       	jmp    801061bc <alltraps>
...
80107026:	6a 00                	push   $0x0
  pushl $179
80107028:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
8010702d:	e9 8a f1 ff ff       	jmp    801061bc <alltraps>
...
80107032:	6a 00                	push   $0x0
  pushl $180
80107034:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107039:	e9 7e f1 ff ff       	jmp    801061bc <alltraps>
...
8010703e:	6a 00                	push   $0x0
  pushl $181
80107040:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107045:	e9 72 f1 ff ff       	jmp    801061bc <alltraps>
...
8010704a:	6a 00                	push   $0x0
  pushl $182
8010704c:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107051:	e9 66 f1 ff ff       	jmp    801061bc <alltraps>
...
80107056:	6a 00                	push   $0x0
  pushl $183
80107058:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010705d:	e9 5a f1 ff ff       	jmp    801061bc <alltraps>
...
80107062:	6a 00                	push   $0x0
  pushl $184
80107064:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107069:	e9 4e f1 ff ff       	jmp    801061bc <alltraps>
...
8010706e:	6a 00                	push   $0x0
  pushl $185
80107070:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107075:	e9 42 f1 ff ff       	jmp    801061bc <alltraps>
...
8010707a:	6a 00                	push   $0x0
  pushl $186
8010707c:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107081:	e9 36 f1 ff ff       	jmp    801061bc <alltraps>
...
80107086:	6a 00                	push   $0x0
  pushl $187
80107088:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
8010708d:	e9 2a f1 ff ff       	jmp    801061bc <alltraps>
...
80107092:	6a 00                	push   $0x0
  pushl $188
80107094:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107099:	e9 1e f1 ff ff       	jmp    801061bc <alltraps>
...
8010709e:	6a 00                	push   $0x0
  pushl $189
801070a0:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801070a5:	e9 12 f1 ff ff       	jmp    801061bc <alltraps>
...
801070aa:	6a 00                	push   $0x0
  pushl $190
801070ac:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801070b1:	e9 06 f1 ff ff       	jmp    801061bc <alltraps>
...
801070b6:	6a 00                	push   $0x0
  pushl $191
801070b8:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801070bd:	e9 fa f0 ff ff       	jmp    801061bc <alltraps>
...
801070c2:	6a 00                	push   $0x0
  pushl $192
801070c4:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801070c9:	e9 ee f0 ff ff       	jmp    801061bc <alltraps>
...
801070ce:	6a 00                	push   $0x0
  pushl $193
801070d0:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801070d5:	e9 e2 f0 ff ff       	jmp    801061bc <alltraps>
...
801070da:	6a 00                	push   $0x0
  pushl $194
801070dc:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801070e1:	e9 d6 f0 ff ff       	jmp    801061bc <alltraps>
...
801070e6:	6a 00                	push   $0x0
  pushl $195
801070e8:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801070ed:	e9 ca f0 ff ff       	jmp    801061bc <alltraps>
...
801070f2:	6a 00                	push   $0x0
  pushl $196
801070f4:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801070f9:	e9 be f0 ff ff       	jmp    801061bc <alltraps>
...
801070fe:	6a 00                	push   $0x0
  pushl $197
80107100:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107105:	e9 b2 f0 ff ff       	jmp    801061bc <alltraps>
...
8010710a:	6a 00                	push   $0x0
  pushl $198
8010710c:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107111:	e9 a6 f0 ff ff       	jmp    801061bc <alltraps>
...
80107116:	6a 00                	push   $0x0
  pushl $199
80107118:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
8010711d:	e9 9a f0 ff ff       	jmp    801061bc <alltraps>
...
80107122:	6a 00                	push   $0x0
  pushl $200
80107124:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107129:	e9 8e f0 ff ff       	jmp    801061bc <alltraps>
...
8010712e:	6a 00                	push   $0x0
  pushl $201
80107130:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107135:	e9 82 f0 ff ff       	jmp    801061bc <alltraps>
...
8010713a:	6a 00                	push   $0x0
  pushl $202
8010713c:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107141:	e9 76 f0 ff ff       	jmp    801061bc <alltraps>
...
80107146:	6a 00                	push   $0x0
  pushl $203
80107148:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
8010714d:	e9 6a f0 ff ff       	jmp    801061bc <alltraps>
...
80107152:	6a 00                	push   $0x0
  pushl $204
80107154:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107159:	e9 5e f0 ff ff       	jmp    801061bc <alltraps>
...
8010715e:	6a 00                	push   $0x0
  pushl $205
80107160:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107165:	e9 52 f0 ff ff       	jmp    801061bc <alltraps>
...
8010716a:	6a 00                	push   $0x0
  pushl $206
8010716c:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107171:	e9 46 f0 ff ff       	jmp    801061bc <alltraps>
...
80107176:	6a 00                	push   $0x0
  pushl $207
80107178:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
8010717d:	e9 3a f0 ff ff       	jmp    801061bc <alltraps>
...
80107182:	6a 00                	push   $0x0
  pushl $208
80107184:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107189:	e9 2e f0 ff ff       	jmp    801061bc <alltraps>
...
8010718e:	6a 00                	push   $0x0
  pushl $209
80107190:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107195:	e9 22 f0 ff ff       	jmp    801061bc <alltraps>
...
8010719a:	6a 00                	push   $0x0
  pushl $210
8010719c:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801071a1:	e9 16 f0 ff ff       	jmp    801061bc <alltraps>
...
801071a6:	6a 00                	push   $0x0
  pushl $211
801071a8:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801071ad:	e9 0a f0 ff ff       	jmp    801061bc <alltraps>
...
801071b2:	6a 00                	push   $0x0
  pushl $212
801071b4:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801071b9:	e9 fe ef ff ff       	jmp    801061bc <alltraps>
...
801071be:	6a 00                	push   $0x0
  pushl $213
801071c0:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801071c5:	e9 f2 ef ff ff       	jmp    801061bc <alltraps>
...
801071ca:	6a 00                	push   $0x0
  pushl $214
801071cc:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801071d1:	e9 e6 ef ff ff       	jmp    801061bc <alltraps>
...
801071d6:	6a 00                	push   $0x0
  pushl $215
801071d8:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801071dd:	e9 da ef ff ff       	jmp    801061bc <alltraps>
...
801071e2:	6a 00                	push   $0x0
  pushl $216
801071e4:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801071e9:	e9 ce ef ff ff       	jmp    801061bc <alltraps>
...
801071ee:	6a 00                	push   $0x0
  pushl $217
801071f0:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801071f5:	e9 c2 ef ff ff       	jmp    801061bc <alltraps>
...
801071fa:	6a 00                	push   $0x0
  pushl $218
801071fc:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107201:	e9 b6 ef ff ff       	jmp    801061bc <alltraps>
...
80107206:	6a 00                	push   $0x0
  pushl $219
80107208:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
8010720d:	e9 aa ef ff ff       	jmp    801061bc <alltraps>
...
80107212:	6a 00                	push   $0x0
  pushl $220
80107214:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107219:	e9 9e ef ff ff       	jmp    801061bc <alltraps>
...
8010721e:	6a 00                	push   $0x0
  pushl $221
80107220:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107225:	e9 92 ef ff ff       	jmp    801061bc <alltraps>
...
8010722a:	6a 00                	push   $0x0
  pushl $222
8010722c:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107231:	e9 86 ef ff ff       	jmp    801061bc <alltraps>
...
80107236:	6a 00                	push   $0x0
  pushl $223
80107238:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
8010723d:	e9 7a ef ff ff       	jmp    801061bc <alltraps>
...
80107242:	6a 00                	push   $0x0
  pushl $224
80107244:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107249:	e9 6e ef ff ff       	jmp    801061bc <alltraps>
...
8010724e:	6a 00                	push   $0x0
  pushl $225
80107250:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107255:	e9 62 ef ff ff       	jmp    801061bc <alltraps>
...
8010725a:	6a 00                	push   $0x0
  pushl $226
8010725c:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107261:	e9 56 ef ff ff       	jmp    801061bc <alltraps>
...
80107266:	6a 00                	push   $0x0
  pushl $227
80107268:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
8010726d:	e9 4a ef ff ff       	jmp    801061bc <alltraps>
...
80107272:	6a 00                	push   $0x0
  pushl $228
80107274:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107279:	e9 3e ef ff ff       	jmp    801061bc <alltraps>
...
8010727e:	6a 00                	push   $0x0
  pushl $229
80107280:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107285:	e9 32 ef ff ff       	jmp    801061bc <alltraps>
...
8010728a:	6a 00                	push   $0x0
  pushl $230
8010728c:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107291:	e9 26 ef ff ff       	jmp    801061bc <alltraps>
...
80107296:	6a 00                	push   $0x0
  pushl $231
80107298:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
8010729d:	e9 1a ef ff ff       	jmp    801061bc <alltraps>
...
801072a2:	6a 00                	push   $0x0
  pushl $232
801072a4:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801072a9:	e9 0e ef ff ff       	jmp    801061bc <alltraps>
...
801072ae:	6a 00                	push   $0x0
  pushl $233
801072b0:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801072b5:	e9 02 ef ff ff       	jmp    801061bc <alltraps>
...
801072ba:	6a 00                	push   $0x0
  pushl $234
801072bc:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801072c1:	e9 f6 ee ff ff       	jmp    801061bc <alltraps>
...
801072c6:	6a 00                	push   $0x0
  pushl $235
801072c8:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801072cd:	e9 ea ee ff ff       	jmp    801061bc <alltraps>
...
801072d2:	6a 00                	push   $0x0
  pushl $236
801072d4:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801072d9:	e9 de ee ff ff       	jmp    801061bc <alltraps>
...
801072de:	6a 00                	push   $0x0
  pushl $237
801072e0:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801072e5:	e9 d2 ee ff ff       	jmp    801061bc <alltraps>
...
801072ea:	6a 00                	push   $0x0
  pushl $238
801072ec:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801072f1:	e9 c6 ee ff ff       	jmp    801061bc <alltraps>
...
801072f6:	6a 00                	push   $0x0
  pushl $239
801072f8:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801072fd:	e9 ba ee ff ff       	jmp    801061bc <alltraps>
...
80107302:	6a 00                	push   $0x0
  pushl $240
80107304:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107309:	e9 ae ee ff ff       	jmp    801061bc <alltraps>
...
8010730e:	6a 00                	push   $0x0
  pushl $241
80107310:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107315:	e9 a2 ee ff ff       	jmp    801061bc <alltraps>
...
8010731a:	6a 00                	push   $0x0
  pushl $242
8010731c:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107321:	e9 96 ee ff ff       	jmp    801061bc <alltraps>
...
80107326:	6a 00                	push   $0x0
  pushl $243
80107328:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
8010732d:	e9 8a ee ff ff       	jmp    801061bc <alltraps>
...
80107332:	6a 00                	push   $0x0
  pushl $244
80107334:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107339:	e9 7e ee ff ff       	jmp    801061bc <alltraps>
...
8010733e:	6a 00                	push   $0x0
  pushl $245
80107340:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107345:	e9 72 ee ff ff       	jmp    801061bc <alltraps>
...
8010734a:	6a 00                	push   $0x0
  pushl $246
8010734c:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107351:	e9 66 ee ff ff       	jmp    801061bc <alltraps>
...
80107356:	6a 00                	push   $0x0
  pushl $247
80107358:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
8010735d:	e9 5a ee ff ff       	jmp    801061bc <alltraps>
...
80107362:	6a 00                	push   $0x0
  pushl $248
80107364:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107369:	e9 4e ee ff ff       	jmp    801061bc <alltraps>
...
8010736e:	6a 00                	push   $0x0
  pushl $249
80107370:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107375:	e9 42 ee ff ff       	jmp    801061bc <alltraps>
...
8010737a:	6a 00                	push   $0x0
  pushl $250
8010737c:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107381:	e9 36 ee ff ff       	jmp    801061bc <alltraps>
...
80107386:	6a 00                	push   $0x0
  pushl $251
80107388:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
8010738d:	e9 2a ee ff ff       	jmp    801061bc <alltraps>
...
80107392:	6a 00                	push   $0x0
  pushl $252
80107394:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107399:	e9 1e ee ff ff       	jmp    801061bc <alltraps>
...
8010739e:	6a 00                	push   $0x0
  pushl $253
801073a0:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801073a5:	e9 12 ee ff ff       	jmp    801061bc <alltraps>
...
801073aa:	6a 00                	push   $0x0
  pushl $254
801073ac:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801073b1:	e9 06 ee ff ff       	jmp    801061bc <alltraps>
...
801073b6:	6a 00                	push   $0x0
  pushl $255
801073b8:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801073bd:	e9 fa ed ff ff       	jmp    801061bc <alltraps>
	...
...
801073c7:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801073ca:	8b 45 0c             	mov    0xc(%ebp),%eax
801073cd:	83 e8 01             	sub    $0x1,%eax
801073d0:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801073d4:	8b 45 08             	mov    0x8(%ebp),%eax
801073d7:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801073db:	8b 45 08             	mov    0x8(%ebp),%eax
801073de:	c1 e8 10             	shr    $0x10,%eax
801073e1:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
801073e5:	8d 45 fa             	lea    -0x6(%ebp),%eax
801073e8:	0f 01 10             	lgdtl  (%eax)
}
801073eb:	c9                   	leave  
801073ec:	c3                   	ret    
...
801073f6:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
801073fa:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801073fe:	0f 00 d8             	ltr    %ax
}
80107401:	c9                   	leave  
80107402:	c3                   	ret    
...
8010740c:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
80107410:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
80107414:	8e e8                	mov    %eax,%gs
}
80107416:	c9                   	leave  
80107417:	c3                   	ret    
...
80107441:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107444:	e8 3c ba ff ff       	call   80102e85 <cpunum>
80107449:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
8010744f:	05 20 f9 10 80       	add    $0x8010f920,%eax
...
801075cc:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
801075d3:	ff ff 
801075d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075d8:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
801075df:	00 00 
801075e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801075e4:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
...
801075fb:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107601:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107604:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010760b:	83 ca 10             	or     $0x10,%edx
8010760e:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107614:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107617:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
8010761e:	83 ca 60             	or     $0x60,%edx
80107621:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107627:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010762a:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107631:	83 ca 80             	or     $0xffffff80,%edx
80107634:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
...
80107650:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107657:	83 e2 ef             	and    $0xffffffef,%edx
8010765a:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107660:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107663:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010766a:	83 e2 df             	and    $0xffffffdf,%edx
8010766d:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107673:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107676:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
8010767d:	83 ca 40             	or     $0x40,%edx
80107680:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107686:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107689:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107690:	83 ca 80             	or     $0xffffff80,%edx
80107693:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107699:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010769c:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801076a3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076a6:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801076ad:	ff ff 
801076af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076b2:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
801076b9:	00 00 
801076bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076be:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
...
801076d5:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801076db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076de:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801076e5:	83 ca 10             	or     $0x10,%edx
801076e8:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
801076ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801076f1:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
801076f8:	83 ca 60             	or     $0x60,%edx
801076fb:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107701:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107704:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010770b:	83 ca 80             	or     $0xffffff80,%edx
8010770e:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
...
8010772a:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107731:	83 e2 ef             	and    $0xffffffef,%edx
80107734:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010773a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010773d:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107744:	83 e2 df             	and    $0xffffffdf,%edx
80107747:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
8010774d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107750:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107757:	83 ca 40             	or     $0x40,%edx
8010775a:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107760:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107763:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
8010776a:	83 ca 80             	or     $0xffffff80,%edx
8010776d:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107773:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107776:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010777d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107780:	05 b4 00 00 00       	add    $0xb4,%eax
80107785:	89 c3                	mov    %eax,%ebx
80107787:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010778a:	05 b4 00 00 00       	add    $0xb4,%eax
8010778f:	c1 e8 10             	shr    $0x10,%eax
80107792:	89 c1                	mov    %eax,%ecx
80107794:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107797:	05 b4 00 00 00       	add    $0xb4,%eax
8010779c:	c1 e8 18             	shr    $0x18,%eax
8010779f:	89 c2                	mov    %eax,%edx
801077a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077a4:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
801077ab:	00 00 
801077ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077b0:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
801077b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ba:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
801077c0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077c3:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801077ca:	83 e1 f0             	and    $0xfffffff0,%ecx
801077cd:	83 c9 02             	or     $0x2,%ecx
801077d0:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801077d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077d9:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801077e0:	83 c9 10             	or     $0x10,%ecx
801077e3:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801077e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ec:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
801077f3:	83 e1 9f             	and    $0xffffff9f,%ecx
801077f6:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
801077fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077ff:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107806:	83 c9 80             	or     $0xffffff80,%ecx
80107809:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010780f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107812:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107819:	83 e1 f0             	and    $0xfffffff0,%ecx
8010781c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107822:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107825:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010782c:	83 e1 ef             	and    $0xffffffef,%ecx
8010782f:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107835:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107838:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010783f:	83 e1 df             	and    $0xffffffdf,%ecx
80107842:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107848:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010784b:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107852:	83 c9 40             	or     $0x40,%ecx
80107855:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010785b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010785e:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107865:	83 c9 80             	or     $0xffffff80,%ecx
80107868:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010786e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107871:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107877:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010787a:	83 c0 70             	add    $0x70,%eax
8010787d:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107884:	00 
80107885:	89 04 24             	mov    %eax,(%esp)
80107888:	e8 37 fb ff ff       	call   801073c4 <lgdt>
  loadgs(SEG_KCPU << 3);
8010788d:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107894:	e8 6a fb ff ff       	call   80107403 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107899:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010789c:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801078a2:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801078a9:	00 00 00 00 
}
801078ad:	83 c4 24             	add    $0x24,%esp
801078b0:	5b                   	pop    %ebx
801078b1:	5d                   	pop    %ebp
801078b2:	c3                   	ret    
...
801078b6:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801078b9:	8b 45 0c             	mov    0xc(%ebp),%eax
801078bc:	c1 e8 16             	shr    $0x16,%eax
801078bf:	c1 e0 02             	shl    $0x2,%eax
801078c2:	03 45 08             	add    0x8(%ebp),%eax
801078c5:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
801078c8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801078cb:	8b 00                	mov    (%eax),%eax
801078cd:	83 e0 01             	and    $0x1,%eax
801078d0:	84 c0                	test   %al,%al
801078d2:	74 17                	je     801078eb <walkpgdir+0x38>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
801078d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801078d7:	8b 00                	mov    (%eax),%eax
801078d9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801078de:	89 04 24             	mov    %eax,(%esp)
801078e1:	e8 4a fb ff ff       	call   80107430 <p2v>
801078e6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801078e9:	eb 4b                	jmp    80107936 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801078eb:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801078ef:	74 0e                	je     801078ff <walkpgdir+0x4c>
801078f1:	e8 01 b2 ff ff       	call   80102af7 <kalloc>
801078f6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801078f9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801078fd:	75 07                	jne    80107906 <walkpgdir+0x53>
      return 0;
801078ff:	b8 00 00 00 00       	mov    $0x0,%eax
80107904:	eb 41                	jmp    80107947 <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107906:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010790d:	00 
8010790e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107915:	00 
80107916:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107919:	89 04 24             	mov    %eax,(%esp)
8010791c:	e8 3d d4 ff ff       	call   80104d5e <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table 
    // entries, if necessary.
    *pde = v2p(pgtab) | PTE_P | PTE_W | PTE_U;
80107921:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107924:	89 04 24             	mov    %eax,(%esp)
80107927:	e8 f7 fa ff ff       	call   80107423 <v2p>
8010792c:	89 c2                	mov    %eax,%edx
8010792e:	83 ca 07             	or     $0x7,%edx
80107931:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107934:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107936:	8b 45 0c             	mov    0xc(%ebp),%eax
80107939:	c1 e8 0c             	shr    $0xc,%eax
8010793c:	25 ff 03 00 00       	and    $0x3ff,%eax
80107941:	c1 e0 02             	shl    $0x2,%eax
80107944:	03 45 f4             	add    -0xc(%ebp),%eax
}
80107947:	c9                   	leave  
80107948:	c3                   	ret    
...
8010794c:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
8010795d:	03 45 10             	add    0x10(%ebp),%eax
80107960:	83 e8 01             	sub    $0x1,%eax
80107963:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107968:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010796b:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107972:	00 
80107973:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107976:	89 44 24 04          	mov    %eax,0x4(%esp)
8010797a:	8b 45 08             	mov    0x8(%ebp),%eax
8010797d:	89 04 24             	mov    %eax,(%esp)
80107980:	e8 2e ff ff ff       	call   801078b3 <walkpgdir>
80107985:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107988:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010798c:	75 07                	jne    80107995 <mappages+0x4c>
      return -1;
8010798e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107993:	eb 46                	jmp    801079db <mappages+0x92>
    if(*pte & PTE_P)
80107995:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107998:	8b 00                	mov    (%eax),%eax
8010799a:	83 e0 01             	and    $0x1,%eax
8010799d:	84 c0                	test   %al,%al
8010799f:	74 0c                	je     801079ad <mappages+0x64>
      panic("remap");
801079a1:	c7 04 24 d4 87 10 80 	movl   $0x801087d4,(%esp)
801079a8:	e8 90 8b ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
801079ad:	8b 45 18             	mov    0x18(%ebp),%eax
801079b0:	0b 45 14             	or     0x14(%ebp),%eax
801079b3:	89 c2                	mov    %eax,%edx
801079b5:	83 ca 01             	or     $0x1,%edx
801079b8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801079bb:	89 10                	mov    %edx,(%eax)
    if(a == last)
801079bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079c0:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801079c3:	74 10                	je     801079d5 <mappages+0x8c>
      break;
    a += PGSIZE;
801079c5:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
801079cc:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
801079d3:	eb 96                	jmp    8010796b <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
801079d5:	90                   	nop
  ...
  return 0;
801079d6:	b8 00 00 00 00       	mov    $0x0,%eax
}
801079db:	c9                   	leave  
801079dc:	c3                   	ret    
...
801079e1:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
801079e4:	e8 0e b1 ff ff       	call   80102af7 <kalloc>
801079e9:	89 45 f0             	mov    %eax,-0x10(%ebp)
801079ec:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801079f0:	75 0a                	jne    801079fc <setupkvm+0x1f>
    return 0;
801079f2:	b8 00 00 00 00       	mov    $0x0,%eax
801079f7:	e9 98 00 00 00       	jmp    80107a94 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
801079fc:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107a03:	00 
80107a04:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107a0b:	00 
80107a0c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a0f:	89 04 24             	mov    %eax,(%esp)
80107a12:	e8 47 d3 ff ff       	call   80104d5e <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107a17:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107a1e:	e8 0d fa ff ff       	call   80107430 <p2v>
80107a23:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107a28:	76 0c                	jbe    80107a36 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107a2a:	c7 04 24 da 87 10 80 	movl   $0x801087da,(%esp)
80107a31:	e8 07 8b ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107a36:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107a3d:	eb 49                	jmp    80107a88 <setupkvm+0xab>
...
80107a3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107a42:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80107a45:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107a48:	8b 50 04             	mov    0x4(%eax),%edx
80107a4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a4e:	8b 58 08             	mov    0x8(%eax),%ebx
80107a51:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a54:	8b 40 04             	mov    0x4(%eax),%eax
80107a57:	29 c3                	sub    %eax,%ebx
80107a59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a5c:	8b 00                	mov    (%eax),%eax
80107a5e:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107a62:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107a66:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107a6a:	89 44 24 04          	mov    %eax,0x4(%esp)
80107a6e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a71:	89 04 24             	mov    %eax,(%esp)
80107a74:	e8 d0 fe ff ff       	call   80107949 <mappages>
80107a79:	85 c0                	test   %eax,%eax
80107a7b:	79 07                	jns    80107a84 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107a7d:	b8 00 00 00 00       	mov    $0x0,%eax
80107a82:	eb 10                	jmp    80107a94 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107a84:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107a88:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107a8f:	72 ae                	jb     80107a3f <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107a94:	83 c4 34             	add    $0x34,%esp
80107a97:	5b                   	pop    %ebx
80107a98:	5d                   	pop    %ebp
80107a99:	c3                   	ret    
...
80107a9d:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107aa0:	e8 38 ff ff ff       	call   801079dd <setupkvm>
80107aa5:	a3 f8 28 11 80       	mov    %eax,0x801128f8
  switchkvm();
80107aaa:	e8 02 00 00 00       	call   80107ab1 <switchkvm>
}
80107aaf:	c9                   	leave  
80107ab0:	c3                   	ret    
...
80107ab7:	a1 f8 28 11 80       	mov    0x801128f8,%eax
80107abc:	89 04 24             	mov    %eax,(%esp)
80107abf:	e8 5f f9 ff ff       	call   80107423 <v2p>
80107ac4:	89 04 24             	mov    %eax,(%esp)
80107ac7:	e8 4c f9 ff ff       	call   80107418 <lcr3>
}
80107acc:	c9                   	leave  
80107acd:	c3                   	ret    
...
80107ad2:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107ad5:	e8 7d d1 ff ff       	call   80104c57 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107ada:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107ae0:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107ae7:	83 c2 08             	add    $0x8,%edx
80107aea:	89 d3                	mov    %edx,%ebx
80107aec:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107af3:	83 c2 08             	add    $0x8,%edx
80107af6:	c1 ea 10             	shr    $0x10,%edx
80107af9:	89 d1                	mov    %edx,%ecx
80107afb:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107b02:	83 c2 08             	add    $0x8,%edx
80107b05:	c1 ea 18             	shr    $0x18,%edx
80107b08:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107b0f:	67 00 
80107b11:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107b18:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107b1e:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107b25:	83 e1 f0             	and    $0xfffffff0,%ecx
80107b28:	83 c9 09             	or     $0x9,%ecx
80107b2b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107b31:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107b38:	83 c9 10             	or     $0x10,%ecx
80107b3b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107b41:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107b48:	83 e1 9f             	and    $0xffffff9f,%ecx
80107b4b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107b51:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107b58:	83 c9 80             	or     $0xffffff80,%ecx
80107b5b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107b61:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107b68:	83 e1 f0             	and    $0xfffffff0,%ecx
80107b6b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107b71:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107b78:	83 e1 ef             	and    $0xffffffef,%ecx
80107b7b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107b81:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107b88:	83 e1 df             	and    $0xffffffdf,%ecx
80107b8b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107b91:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107b98:	83 c9 40             	or     $0x40,%ecx
80107b9b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ba1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107ba8:	83 e1 7f             	and    $0x7f,%ecx
80107bab:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107bb1:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107bb7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107bbd:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80107bc4:	83 e2 ef             	and    $0xffffffef,%edx
80107bc7:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107bcd:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107bd3:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107bd9:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107bdf:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107be6:	8b 52 08             	mov    0x8(%edx),%edx
80107be9:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107bef:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107bf2:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107bf9:	e8 ef f7 ff ff       	call   801073ed <ltr>
  if(p->pgdir == 0)
80107bfe:	8b 45 08             	mov    0x8(%ebp),%eax
80107c01:	8b 40 04             	mov    0x4(%eax),%eax
80107c04:	85 c0                	test   %eax,%eax
80107c06:	75 0c                	jne    80107c14 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107c08:	c7 04 24 eb 87 10 80 	movl   $0x801087eb,(%esp)
80107c0f:	e8 29 89 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107c14:	8b 45 08             	mov    0x8(%ebp),%eax
80107c17:	8b 40 04             	mov    0x4(%eax),%eax
80107c1a:	89 04 24             	mov    %eax,(%esp)
80107c1d:	e8 01 f8 ff ff       	call   80107423 <v2p>
80107c22:	89 04 24             	mov    %eax,(%esp)
80107c25:	e8 ee f7 ff ff       	call   80107418 <lcr3>
  popcli();
80107c2a:	e8 70 d0 ff ff       	call   80104c9f <popcli>
}
80107c2f:	83 c4 14             	add    $0x14,%esp
80107c32:	5b                   	pop    %ebx
80107c33:	5d                   	pop    %ebp
80107c34:	c3                   	ret    
...
80107c38:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107c3b:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107c42:	76 0c                	jbe    80107c50 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107c44:	c7 04 24 ff 87 10 80 	movl   $0x801087ff,(%esp)
80107c4b:	e8 ed 88 ff ff       	call   8010053d <panic>
  mem = kalloc();
80107c50:	e8 a2 ae ff ff       	call   80102af7 <kalloc>
...
80107c6e:	e8 eb d0 ff ff       	call   80104d5e <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107c73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c76:	89 04 24             	mov    %eax,(%esp)
80107c79:	e8 a5 f7 ff ff       	call   80107423 <v2p>
80107c7e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107c85:	00 
80107c86:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107c8a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107c91:	00 
80107c92:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107c99:	00 
80107c9a:	8b 45 08             	mov    0x8(%ebp),%eax
80107c9d:	89 04 24             	mov    %eax,(%esp)
80107ca0:	e8 a4 fc ff ff       	call   80107949 <mappages>
  memmove(mem, init, sz);
80107ca5:	8b 45 10             	mov    0x10(%ebp),%eax
80107ca8:	89 44 24 08          	mov    %eax,0x8(%esp)
80107cac:	8b 45 0c             	mov    0xc(%ebp),%eax
80107caf:	89 44 24 04          	mov    %eax,0x4(%esp)
80107cb3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cb6:	89 04 24             	mov    %eax,(%esp)
80107cb9:	e8 73 d1 ff ff       	call   80104e31 <memmove>
}
80107cbe:	c9                   	leave  
80107cbf:	c3                   	ret    
...
80107cc4:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
...
80107cd1:	74 0c                	je     80107cdf <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80107cd3:	c7 04 24 1c 88 10 80 	movl   $0x8010881c,(%esp)
80107cda:	e8 5e 88 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107cdf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107ce6:	e9 ad 00 00 00       	jmp    80107d98 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107ceb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cee:	8b 55 0c             	mov    0xc(%ebp),%edx
80107cf1:	01 d0                	add    %edx,%eax
80107cf3:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107cfa:	00 
80107cfb:	89 44 24 04          	mov    %eax,0x4(%esp)
80107cff:	8b 45 08             	mov    0x8(%ebp),%eax
80107d02:	89 04 24             	mov    %eax,(%esp)
80107d05:	e8 a9 fb ff ff       	call   801078b3 <walkpgdir>
80107d0a:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107d0d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107d11:	75 0c                	jne    80107d1f <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80107d13:	c7 04 24 3f 88 10 80 	movl   $0x8010883f,(%esp)
80107d1a:	e8 1e 88 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
80107d1f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107d22:	8b 00                	mov    (%eax),%eax
80107d24:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107d29:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80107d2c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d2f:	8b 55 18             	mov    0x18(%ebp),%edx
80107d32:	89 d1                	mov    %edx,%ecx
80107d34:	29 c1                	sub    %eax,%ecx
80107d36:	89 c8                	mov    %ecx,%eax
80107d38:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107d3d:	77 11                	ja     80107d50 <loaduvm+0x90>
      n = sz - i;
80107d3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d42:	8b 55 18             	mov    0x18(%ebp),%edx
80107d45:	89 d1                	mov    %edx,%ecx
80107d47:	29 c1                	sub    %eax,%ecx
80107d49:	89 c8                	mov    %ecx,%eax
80107d4b:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107d4e:	eb 07                	jmp    80107d57 <loaduvm+0x97>
    else
      n = PGSIZE;
80107d50:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80107d57:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d5a:	8b 55 14             	mov    0x14(%ebp),%edx
80107d5d:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80107d60:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107d63:	89 04 24             	mov    %eax,(%esp)
80107d66:	e8 c5 f6 ff ff       	call   80107430 <p2v>
80107d6b:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107d6e:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107d72:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107d76:	89 44 24 04          	mov    %eax,0x4(%esp)
80107d7a:	8b 45 10             	mov    0x10(%ebp),%eax
80107d7d:	89 04 24             	mov    %eax,(%esp)
80107d80:	e8 d1 9f ff ff       	call   80101d56 <readi>
80107d85:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107d88:	74 07                	je     80107d91 <loaduvm+0xd1>
      return -1;
80107d8a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107d8f:	eb 18                	jmp    80107da9 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80107d91:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107d98:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d9b:	3b 45 18             	cmp    0x18(%ebp),%eax
80107d9e:	0f 82 47 ff ff ff    	jb     80107ceb <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80107db2:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107dba:	79 0a                	jns    80107dc6 <allocuvm+0x17>
    return 0;
80107dbc:	b8 00 00 00 00       	mov    $0x0,%eax
80107dc1:	e9 c1 00 00 00       	jmp    80107e87 <allocuvm+0xd8>
  if(newsz < oldsz)
80107dc6:	8b 45 10             	mov    0x10(%ebp),%eax
80107dc9:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107dcc:	73 08                	jae    80107dd6 <allocuvm+0x27>
    return oldsz;
80107dce:	8b 45 0c             	mov    0xc(%ebp),%eax
80107dd1:	e9 b1 00 00 00       	jmp    80107e87 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80107dd6:	8b 45 0c             	mov    0xc(%ebp),%eax
80107dd9:	05 ff 0f 00 00       	add    $0xfff,%eax
80107dde:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107de3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80107de6:	e9 8d 00 00 00       	jmp    80107e78 <allocuvm+0xc9>
    mem = kalloc();
80107deb:	e8 07 ad ff ff       	call   80102af7 <kalloc>
80107df0:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107df3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107df7:	75 2c                	jne    80107e25 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80107df9:	c7 04 24 5d 88 10 80 	movl   $0x8010885d,(%esp)
80107e00:	e8 9c 85 ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107e05:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e08:	89 44 24 08          	mov    %eax,0x8(%esp)
80107e0c:	8b 45 10             	mov    0x10(%ebp),%eax
80107e0f:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e13:	8b 45 08             	mov    0x8(%ebp),%eax
80107e16:	89 04 24             	mov    %eax,(%esp)
80107e19:	e8 6b 00 00 00       	call   80107e89 <deallocuvm>
      return 0;
80107e1e:	b8 00 00 00 00       	mov    $0x0,%eax
80107e23:	eb 62                	jmp    80107e87 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80107e25:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e2c:	00 
80107e2d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107e34:	00 
80107e35:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e38:	89 04 24             	mov    %eax,(%esp)
80107e3b:	e8 1e cf ff ff       	call   80104d5e <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107e40:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e43:	89 04 24             	mov    %eax,(%esp)
80107e46:	e8 d8 f5 ff ff       	call   80107423 <v2p>
80107e4b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80107e4e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107e55:	00 
80107e56:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107e5a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e61:	00 
80107e62:	89 54 24 04          	mov    %edx,0x4(%esp)
80107e66:	8b 45 08             	mov    0x8(%ebp),%eax
80107e69:	89 04 24             	mov    %eax,(%esp)
80107e6c:	e8 d8 fa ff ff       	call   80107949 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80107e71:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107e78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e7b:	3b 45 10             	cmp    0x10(%ebp),%eax
80107e7e:	0f 82 67 ff ff ff    	jb     80107deb <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
80107e8c:	83 ec 28             	sub    $0x28,%esp
  ...
  if(newsz >= oldsz)
80107e8f:	8b 45 10             	mov    0x10(%ebp),%eax
80107e92:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107e95:	72 08                	jb     80107e9f <deallocuvm+0x16>
    return oldsz;
80107e97:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e9a:	e9 a4 00 00 00       	jmp    80107f43 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80107e9f:	8b 45 10             	mov    0x10(%ebp),%eax
80107ea2:	05 ff 0f 00 00       	add    $0xfff,%eax
80107ea7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107eac:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107eaf:	e9 80 00 00 00       	jmp    80107f34 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
80107eb4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eb7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107ebe:	00 
80107ebf:	89 44 24 04          	mov    %eax,0x4(%esp)
80107ec3:	8b 45 08             	mov    0x8(%ebp),%eax
80107ec6:	89 04 24             	mov    %eax,(%esp)
80107ec9:	e8 e5 f9 ff ff       	call   801078b3 <walkpgdir>
80107ece:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80107ed1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107ed5:	75 09                	jne    80107ee0 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80107ed7:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80107ede:	eb 4d                	jmp    80107f2d <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80107ee0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107ee3:	8b 00                	mov    (%eax),%eax
80107ee5:	83 e0 01             	and    $0x1,%eax
80107ee8:	84 c0                	test   %al,%al
80107eea:	74 41                	je     80107f2d <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
80107efd:	75 0c                	jne    80107f0b <deallocuvm+0x82>
        panic("kfree");
80107eff:	c7 04 24 75 88 10 80 	movl   $0x80108875,(%esp)
80107f06:	e8 32 86 ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
80107f0b:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107f0e:	89 04 24             	mov    %eax,(%esp)
80107f11:	e8 1a f5 ff ff       	call   80107430 <p2v>
80107f16:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80107f19:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107f1c:	89 04 24             	mov    %eax,(%esp)
80107f1f:	e8 3a ab ff ff       	call   80102a5e <kfree>
      *pte = 0;
80107f24:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107f27:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
80107f3a:	0f 82 74 ff ff ff    	jb     80107eb4 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
80107f48:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
80107f4b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
80107f4f:	75 0c                	jne    80107f5d <freevm+0x18>
    panic("freevm: no pgdir");
80107f51:	c7 04 24 7b 88 10 80 	movl   $0x8010887b,(%esp)
80107f58:	e8 e0 85 ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80107f5d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80107f64:	00 
80107f65:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80107f6c:	80 
80107f6d:	8b 45 08             	mov    0x8(%ebp),%eax
80107f70:	89 04 24             	mov    %eax,(%esp)
80107f73:	e8 11 ff ff ff       	call   80107e89 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80107f78:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107f7f:	eb 3c                	jmp    80107fbd <freevm+0x78>
    if(pgdir[i] & PTE_P){
80107f81:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f84:	c1 e0 02             	shl    $0x2,%eax
80107f87:	03 45 08             	add    0x8(%ebp),%eax
80107f8a:	8b 00                	mov    (%eax),%eax
80107f8c:	83 e0 01             	and    $0x1,%eax
80107f8f:	84 c0                	test   %al,%al
80107f91:	74 26                	je     80107fb9 <freevm+0x74>
...
80107fc4:	76 bb                	jbe    80107f81 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80107fcc:	e8 8d aa ff ff       	call   80102a5e <kfree>
}
80107fd1:	c9                   	leave  
80107fd2:	c3                   	ret    
...
8010801c:	53                   	push   %ebx
8010801d:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80108020:	e8 b8 f9 ff ff       	call   801079dd <setupkvm>
80108025:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108028:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010802c:	75 0a                	jne    80108038 <copyuvm+0x1f>
    return 0;
8010802e:	b8 00 00 00 00       	mov    $0x0,%eax
80108033:	e9 fd 00 00 00       	jmp    80108135 <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
80108038:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010803f:	e9 cc 00 00 00       	jmp    80108110 <copyuvm+0xf7>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108044:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108047:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010804e:	00 
8010804f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108053:	8b 45 08             	mov    0x8(%ebp),%eax
80108056:	89 04 24             	mov    %eax,(%esp)
80108059:	e8 55 f8 ff ff       	call   801078b3 <walkpgdir>
8010805e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108061:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108065:	75 0c                	jne    80108073 <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
80108067:	c7 04 24 96 88 10 80 	movl   $0x80108896,(%esp)
8010806e:	e8 ca 84 ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
80108073:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108076:	8b 00                	mov    (%eax),%eax
80108078:	83 e0 01             	and    $0x1,%eax
8010807b:	85 c0                	test   %eax,%eax
8010807d:	75 0c                	jne    8010808b <copyuvm+0x72>
      panic("copyuvm: page not present");
8010807f:	c7 04 24 b0 88 10 80 	movl   $0x801088b0,(%esp)
...
8010809d:	25 ff 0f 00 00       	and    $0xfff,%eax
801080a2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801080a5:	e8 4d aa ff ff       	call   80102af7 <kalloc>
801080aa:	89 45 e0             	mov    %eax,-0x20(%ebp)
801080ad:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801080b1:	74 6e                	je     80108121 <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
801080b3:	8b 45 e8             	mov    -0x18(%ebp),%eax
801080b6:	89 04 24             	mov    %eax,(%esp)
801080b9:	e8 72 f3 ff ff       	call   80107430 <p2v>
...
80108100:	e8 44 f8 ff ff       	call   80107949 <mappages>
80108105:	85 c0                	test   %eax,%eax
80108107:	78 1b                	js     80108124 <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108109:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108110:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108113:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108116:	0f 82 28 ff ff ff    	jb     80108044 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
8010811f:	eb 14                	jmp    80108135 <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108121:	90                   	nop
80108122:	eb 01                	jmp    80108125 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
80108124:	90                   	nop
...
8010812b:	e8 15 fe ff ff       	call   80107f45 <freevm>
  return 0;
80108130:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108135:	83 c4 44             	add    $0x44,%esp
80108138:	5b                   	pop    %ebx
80108139:	5d                   	pop    %ebp
8010813a:	c3                   	ret    
...
8010813e:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
8010814c:	89 44 24 04          	mov    %eax,0x4(%esp)
80108150:	8b 45 08             	mov    0x8(%ebp),%eax
80108153:	89 04 24             	mov    %eax,(%esp)
80108156:	e8 58 f7 ff ff       	call   801078b3 <walkpgdir>
8010815b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
8010815e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108161:	8b 00                	mov    (%eax),%eax
80108163:	83 e0 01             	and    $0x1,%eax
80108166:	85 c0                	test   %eax,%eax
80108168:	75 07                	jne    80108171 <uva2ka+0x36>
    return 0;
8010816a:	b8 00 00 00 00       	mov    $0x0,%eax
8010816f:	eb 25                	jmp    80108196 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108171:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108174:	8b 00                	mov    (%eax),%eax
80108176:	83 e0 04             	and    $0x4,%eax
80108179:	85 c0                	test   %eax,%eax
8010817b:	75 07                	jne    80108184 <uva2ka+0x49>
    return 0;
8010817d:	b8 00 00 00 00       	mov    $0x0,%eax
80108182:	eb 12                	jmp    80108196 <uva2ka+0x5b>
...
80108191:	e8 9a f2 ff ff       	call   80107430 <p2v>
}
80108196:	c9                   	leave  
80108197:	c3                   	ret    
...
8010819b:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
801081a1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801081a4:	e9 8b 00 00 00       	jmp    80108234 <copyout+0x9c>
...
801081c1:	e8 75 ff ff ff       	call   8010813b <uva2ka>
801081c6:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801081c9:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801081cd:	75 07                	jne    801081d6 <copyout+0x3e>
      return -1;
801081cf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801081d4:	eb 6d                	jmp    80108243 <copyout+0xab>
    n = PGSIZE - (va - va0);
801081d6:	8b 45 0c             	mov    0xc(%ebp),%eax
801081d9:	8b 55 ec             	mov    -0x14(%ebp),%edx
801081dc:	89 d1                	mov    %edx,%ecx
801081de:	29 c1                	sub    %eax,%ecx
801081e0:	89 c8                	mov    %ecx,%eax
801081e2:	05 00 10 00 00       	add    $0x1000,%eax
801081e7:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801081ea:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081ed:	3b 45 14             	cmp    0x14(%ebp),%eax
801081f0:	76 06                	jbe    801081f8 <copyout+0x60>
      n = len;
801081f2:	8b 45 14             	mov    0x14(%ebp),%eax
801081f5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
801081f8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081fb:	8b 55 0c             	mov    0xc(%ebp),%edx
801081fe:	89 d1                	mov    %edx,%ecx
80108200:	29 c1                	sub    %eax,%ecx
80108202:	89 c8                	mov    %ecx,%eax
80108204:	03 45 e8             	add    -0x18(%ebp),%eax
80108207:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010820a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010820e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108211:	89 54 24 04          	mov    %edx,0x4(%esp)
80108215:	89 04 24             	mov    %eax,(%esp)
80108218:	e8 14 cc ff ff       	call   80104e31 <memmove>
    len -= n;
8010821d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108220:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108223:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108226:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108229:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010822c:	05 00 10 00 00       	add    $0x1000,%eax
80108231:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108234:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108238:	0f 85 6b ff ff ff    	jne    801081a9 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
